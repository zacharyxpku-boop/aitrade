...
- Input path: docs/LOCAL_COURSE_ABSORPTION_P0_REVIEW_INPUT_TEMPLATE.json
- Total entries: 22
- Ready entries: 0
- Blocked entries: 22
...
| --- | --- | ---: | --- | --- | --- |
| input_absorb_manual_transcription_01 | manual_transcription | 1 | blocked_missing_reviewer_input | reviewerName, reviewedAt, humanTranscription, humanSummary, manualChecklist |  |
| input_absorb_manual_transcription_02 | manual_transcription | 2 | blocked_missing_reviewer_input | reviewerName, reviewedAt, humanTranscription, humanSummary, manualChecklist |  |
