# Local Course 5 Module Distillation Review Batch 008 Input Copy Template

- Input copy status: course_5_module_distillation_review_batch_008_input_copy_ready_blank
- Rows: 40
- Ready rows: 0
- Blocked rows: 40
