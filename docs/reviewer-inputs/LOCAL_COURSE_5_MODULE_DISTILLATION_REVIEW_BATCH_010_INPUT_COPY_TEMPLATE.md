# Local Course 5 Module Distillation Review Batch 010 Input Copy Template

- Input copy status: course_5_module_distillation_review_batch_010_input_copy_ready_blank
- Rows: 26
- Ready rows: 0
- Blocked rows: 26
