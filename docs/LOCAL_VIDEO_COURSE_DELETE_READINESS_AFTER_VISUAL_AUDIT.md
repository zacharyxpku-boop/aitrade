...
- Readiness status: local_video_course_original_videos_may_be_removed_after_visual_audit_verified_manual_only
- Recommendation: may_delete_if_user_accepts_ocr_unavailable_limitation_otherwise_retain_for_future_ocr
- Transcript complete: true
- Semantic complete: true
- Visual complete: true
- Visual indexed videos: 62/62
- OCR engine available: false
- Delete executed now: false
- Manual deletion only: true
