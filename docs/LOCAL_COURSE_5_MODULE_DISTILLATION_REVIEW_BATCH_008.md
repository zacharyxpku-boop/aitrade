# Local Course 5 Module Distillation Review Batch 008

- Batch status: course_5_module_distillation_review_batch_008_ready_blocked_missing_real_input
- Selected rows: 40
- Cumulative selected rows: 320/386
- Remaining rows after batch: 66
- Modules covered: 3
- P0 rows: 2
- Non-P0 rows: 38
