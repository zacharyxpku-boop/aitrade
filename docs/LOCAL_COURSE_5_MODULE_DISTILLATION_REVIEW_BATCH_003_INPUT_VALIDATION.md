# Course 5 Module Distillation Batch 003 Input Validation

- Validation status: course_5_module_distillation_batch_003_input_blocked_missing_or_invalid_real_input
- Input rows: 40
- Ready rows: 0
- Blocked rows: 40
