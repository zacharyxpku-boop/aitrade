...
- Input path: docs\LOCAL_COURSE_P0_HUMAN_FILL_PACK_05_POSITIVE_LINT_FIXTURE.json
- Total entries: 4
- Ready entries: 4
- Blocked entries: 0
...
| --- | --- | ---: | --- | --- | --- |
| input_copy_absorb_manual_transcription_05 | manual_transcription | 5 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_06 | manual_transcription | 6 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_07 | manual_transcription | 7 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_08 | manual_transcription | 8 | ready_for_overlay_apply |  |  |
