...
- Validation status: ready_for_overlay_apply
- Input path: docs\LOCAL_COURSE_P0_HUMAN_FILL_PACK_04_POSITIVE_LINT_FIXTURE.json
- Total entries: 4
- Ready entries: 4
- Blocked entries: 0
...
| --- | --- | ---: | --- | --- | --- |
| input_copy_absorb_manual_transcription_01 | manual_transcription | 1 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_02 | manual_transcription | 2 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_03 | manual_transcription | 3 | ready_for_overlay_apply |  |  |
| input_copy_absorb_manual_transcription_04 | manual_transcription | 4 | ready_for_overlay_apply |  |  |
