const state = {
  ...
  knowledgeBrowser: {
    overview: null,
    knowledgeBaseReadinessGate: null,
    knowledgeModuleReviewCockpit: null,
    knowledgeReviewerActionQueue: null,
    knowledgeFirstReviewerActionHandoff: null,
    knowledgeFirstReviewerFieldMap: null,
    knowledgeFirstReviewerCompletionGate: null,
    knowledgeFirstReviewerExecutionChecklist: null,
    knowledgeFirstReviewerWorkbench: null,
    knowledgeFirstReviewerCardStatusMatrix: null,
    knowledgeFirstReviewerPostInputRouteMap: null,
    knowledgeFirstReviewerInputQueue: null,
    knowledgeReleaseBlockerAudit: null,
    knowledgeCoursePathReadinessAudit: null,
    knowledgeModuleReviewSprintPlan: null,
    masterKnowledgeDatabase: null,
    modules: [],
    ...
    curriculum: null,
    selectedPath: null,
    selectedSourceFitPacketId: null,
    localCourseCoverage: null,
    localCourseAbsorptionReadiness: null,
    localCourseModuleAbsorptionSelfAudit: null,
    localCourseModuleReviewDossier: null,
    localCourseReviewGateDashboard: null,
    localCourseAbsorptionQueue: null,
    localCourseAbsorptionP0Workbench: null,
    localCourseAbsorptionP0ReviewOverlay: null,
    localCourseP0ReviewOperatorIndex: null,
    localCourseP0WriteAuthorizationPreview: null,
    localCourseP0ReviewInputNegativeCases: null,
    localCourseSourceReplacementDecisions: null,
    localCourseSourceQuality: null,
    localCourseSourceSyncAudit: null,
    localCourseDocumentAbsorptionMap: null,
    localCourseFolderAbsorptionLedger: null,
    publicSourceGap: null,
    wikipediaGroundingAudit: null,
    publicSourceAbsorptionMap: null,
    publicSourceCoverageLedger: null,
    knowledgeNodeSourceTriangulationAudit: null,
    knowledgeNodePublicSourceFitCandidatePack: null,
    knowledgeNodePublicSourceFitReviewInputStarter: null,
    knowledgeNodePublicSourceFitReviewInputValidation: null,
    knowledgeNodePublicSourceFitReviewExecutionQueue: null,
    knowledgeNodePublicSourceFitReviewBatchPackets: null,
    knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate: null,
    knowledgeNodePublicSourceFitReviewPacketMergePreview: null,
    knowledgeNodePublicSourceFitReviewPacketMergeApplyReport: null,
    knowledgeNodePublicSourceFitReviewPacket001Handoff: null,
    knowledgeNodePublicSourceFitReviewPacketHandoffIndex: null,
    knowledgeNodePublicSourceFitRealReviewerLaunchDashboard: null,
    knowledgeNodePublicSourceFitPacket001ReviewerWorkbench: null,
    knowledgeNodePublicSourceFitReviewerWorkbenchIndex: null,
    knowledgeNodePublicSourceFitReviewerRowBrowser: null,
    selectedReviewerRowDetail: null,
    selectedFirstReviewerInputDetail: null,
    reviewerRowQuery: "limit=80",
    inputQueueQuery: "limit=80",
    knowledgeNodePublicSourceFitReviewProgressMatrix: null,
    lowExtractionVisualReview: null,
    lowExtractionHighResReview: null,
    localCourseHighResTranscriptionCandidates: null,
    localCourseP0CandidateReviewAssistMap: null,
    localCourseP0ReviewInputDryRunSample: null,
    localCourseP0HumanReviewNoteTemplate: null,
    localCourseP0HumanFillPack01: null,
    localCourseP0HumanFillPack01InputCopy: null,
    localCourseP0HumanReviewBundle: null,
    localCourseP0HumanReviewBundleInputCopy: null,
    localCourseP0HumanReviewBundlePositiveFixture: null,
    localCourseP0HumanReviewRealReviewerHandoff: null,
    localCourseP0RealReviewerInputStarter: null,
    localCourseP0RealReviewerTaskBoard: null,
    localCourseP0RealReviewerEvidencePacket: null,
    localCourseP0RealReviewerSourceFitWorksheet: null,
    localCourseP0RealReviewerSourceFitInputGuide: null,
    localCourseP0RealReviewerSourceFitInputValidation: null,
    localCourseP0RealReviewerSourceFitHandoff: null,
    lowExtractionTranscriptionOverlay: null,
    lowExtractionTranscriptIntake: null,
    lowExtractionManualTranscriptionPack: null,
    lowExtractionSourceReplacementPack: null,
    localCourseRewriteIntake: [],
    localCourseRewriteBatch: null,
    localCourseRewriteBatches: null,
    localCourseRewriteReview: null,
    localCourseRefinementPacket: null,
    localCourseHighRiskSelfReviewOverlay: null,
    localCourseHighRiskPublicGroundingMatrix: null,
    localCourseHighRiskRealReviewerOverlayStarter: null,
    localCourseHighRiskRealReviewerOverlayInputValidation: null,
    localCourseHighRiskReviewCockpit: null,
    localCourseError: "",
  },
};
...
const nodes = {
  ...
  refreshKnowledgeBrowser: document.querySelector("#refreshKnowledgeBrowser"),
  knowledgeBrowserStatus: document.querySelector("#knowledgeBrowserStatus"),
  knowledgeBrowserModuleList: document.querySelector("#knowledgeBrowserModuleList"),
  knowledgeBrowserNodeList: document.querySelector("#knowledgeBrowserNodeList"),
  knowledgeBrowserDetail: document.querySelector("#knowledgeBrowserDetail"),
  knowledgeBrowserEvidence: document.querySelector("#knowledgeBrowserEvidence"),
  knowledgeBrowserLocalCourse: document.querySelector("#knowledgeBrowserLocalCourse"),
  knowledgeBrowserMasterDelivery: document.querySelector("#knowledgeBrowserMasterDelivery"),
  knowledgeBrowserCurriculum: document.querySelector("#knowledgeBrowserCurriculum"),
};

const viewMeta = {
  dashboard: ["学习入口", "先看学习流程，不看收益"],
  curriculum: ["课程路径", "交易学习框架"],
  trainer: ["第一步", "K 线训练"],
  replay: ["第二步", "历史回放和回测误区"],
  coach: ["第三步", "AI 复盘和学习反馈"],
  community: ["最后一步", "反馈和教育支持"],
  knowledgeBrowser: ["内部知识库", "课程源证据浏览器"],
  billing: ["本地演示", "订阅包装预览"],
  ops: ["管理员", "试用检查台"],
};
  ...
  if (!state.trialAccessPromise) {
    ...
    state.trialAccessPromise = (async () => {
      ...
      if (nodes.habitStatus) {
        nodes.habitStatus.textContent = "已进入学习体验。按训练、回放、AI复盘、回测误区、反馈走完即可。";
      }
      return state.data.session;
    })().finally(() => {
...
function setTrialEntryPending(isPending) {
  [nodes.loginDemo, nodes.friendStartLogin].forEach((button) => {
    ...
    button.textContent = isPending ? "正在进入..." : "开始学习";
  });
}
...
function renderCoachCompactMode() {
  ...
  toggle.innerHTML = `
    <div>
      ...
      <span>${state.coachDetailsExpanded ? "下面是完整学习记录、报告和支持入口。" : "体验时先看错因和下一步；学习记录、报告和支持入口先折叠，避免信息过载。"}</span>
    </div>
    ...
    panel.innerHTML = `
      <div class="section-head">
        <div>
          ...
          <h3>AI 教练只盯过程，不判断涨跌。</h3>
        </div>
        <span class="tag warn">教育反馈</span>
      </div>
      <div class="coach-empty-grid">
        <article><b>1</b><strong>看结构</strong><span>你有没有先写前高、区间、跌回和失效观察区。</span></article>
        <article><b>2</b><strong>抓错因</strong><span>检查理由空泛、偷看未来、没有认错点、把情绪当理由。</span></article>
        <article><b>3</b><strong>给下一题</strong><span>只推荐下一次学习训练，不输出买卖建议或实盘信号。</span></article>
      </div>
      <p class="muted-note">完成第一题后，这里会显示具体错因画像和下一步练习。这里不会评价策略收益。</p>
    `;
    return;
  }
  const lastTraining = state.lastCompletedTraining || {};
  panel.innerHTML = `
    <article class="coach-review-sheet coach-review-sheet-compact" aria-label="最近一次AI教练批改单">
      <span class="coach-review-stamp">过程批改</span>
      <div>
        <p class="eyebrow">AI 教练批改单</p>
        <h3>刚才这题，先看你哪里容易误判。</h3>
      </div>
      <dl>
        <div><dt>本题</dt><dd>${escapeHtml(lastTraining.title || currentScenario().title)} / ${escapeHtml(lastTraining.symbol || currentScenario().symbol)} / ${escapeHtml(lastTraining.timeframe || currentScenario().timeframe)}</dd></div>
        <div><dt>最大问题</dt><dd>${escapeHtml(lastTraining.biggestIssue || diagnosis.problem)}</dd></div>
        <div><dt>下一次只改一件事</dt><dd>${escapeHtml(lastTraining.nextPractice || diagnosis.check)}</dd></div>
      </dl>
    </article>
    ${sharpDiagnosisHtml(diagnosis, "AI 复盘重点")}
  `;
}
...
function displayLearningStatus(value = "") {
  ...
  const map = {
    blocked_pre_metric: "样本太少，先不要读指标",
    too_small_for_any_conclusion: "样本太少，不能下结论",
    practice_sample_only: "仅用于课堂练习",
    pre_metric_practice: "先积累课堂记录",
    metric_literacy_only: "只用于指标识读",
    practice_sample_reviewable_not_predictive: "可用于复盘讨论，不能预测未来",
    unreviewed: "未复核",
    needs_context_evidence: "需要补充环境证据",
    sufficient_for_learning_review: "足够用于学习复盘",
    too_small_for_strategy_claims: "样本太少，不能做策略结论",
    boundary_gap: "背景边界不足",
    sample_too_small_for_strategy_claims: "样本太少，不能做策略结论",
  };
  return map[raw] || map[normalized] || raw.replace(/_/g, " ");
}

function displayLearningText(text = "") {
  const raw = String(text || "");
  const exact = {
    "Backtest and paper-trade sample evidence": "回测和课堂记录样本证据",
    "News and sentiment boundary evidence": "新闻和情绪边界证据",
    "Save at least five paper trades with thesis, invalidation, and context boundary.": "至少保存 5 条包含判断理由、失效条件和背景边界的课堂记录。",
    "Save paper trades with thesis and invalidation to build discipline evidence.": "保存带有判断理由和失效条件的课堂记录，用来积累纪律证据。",
    "Win rate, expectancy, and drawdown are learning diagnostics and cannot prove future profitability.": "做对比例、平均结果和最大回落只用于学习诊断，不能证明未来收益。",
    "Expectancy and drawdown are learning diagnostics until fees, slippage, spread, execution assumptions, and source provenance are reviewed.": "在手续费、滑点、点差、执行假设和数据来源复核前，平均结果和回落都只能当学习诊断。",
    "Add news/sentiment context notes before interpreting why a replay outcome felt convincing.": "解释回放结果为什么看起来有说服力前，先补新闻和情绪背景边界。",
    "Ask for one news/sentiment boundary note before discussing the metric panel.": "讨论指标面板前，先要求写一条新闻/情绪边界说明。",
    "Win rate, expectancy, drawdown, and setup diagnostics are not strategy proof or future performance evidence.": "做对比例、平均结果、回落和形态诊断都不是策略证明或未来表现证据。",
    "Review repeated mistake tags before adding harder scenarios.": "加更难题目前，先复盘反复出现的错因标签。",
    "Collect more examples across setup types before comparing metrics.": "比较指标前，先积累更多不同结构的练习样本。",
    "Reliability audit is for education evidence quality only.": "可信度检查只看学习证据质量。",
    "Reliability is education evidence quality only, not a signal or strategy score.": "可信度只表示学习证据质量，不是信号或策略评分。",
    "Metrics are learning diagnostics, not future performance proof.": "指标只用于学习诊断，不是未来表现证明。",
    "Metrics are education diagnostics, not strategy proof.": "指标只用于教育诊断，不是策略证明。",
    "News and sentiment are context boundaries, not trade permission.": "新闻和情绪只用于判断背景边界，不是交易许可。",
    "Risk metrics are classroom discipline checks, not real-money readiness.": "风险指标只检查课堂纪律，不代表真实资金准备度。",
    "No dominant context-risk pattern yet; keep collecting education evidence.": "暂未发现主要环境风险模式，继续积累学习证据。",
    "Not sentiment scoring, market prediction, signal, or recommendation.": "不是情绪打分、市场预测、信号或推荐。",
  };
  if (exact[raw]) return exact[raw];
  const winRate = raw.match(/^Win rate ([\d.]+)% is a classroom description of (\d+) saved paper-trade record\(s\), not strategy evidence\.$/);
  if (winRate) return `做对比例 ${winRate[1]}% 只描述 ${winRate[2]} 条课堂记录，不能证明策略有效。`;
  const learnerWinRate = raw.match(/^Your win rate is a description of (\d+) saved classroom journal record\(s\), not proof that a setup works\.$/);
  if (learnerWinRate) return `你的做对比例只描述 ${learnerWinRate[1]} 条课堂记录，不能证明某个形态有效。`;
  const expectancy = raw.match(/^Expectancy ([\d.-]+)R and max drawdown ([\d.-]+)R are practice-review numbers, not expected future results\.$/);
  if (expectancy) return `平均结果 ${expectancy[1]}R、最大回落 ${expectancy[2]}R 只是练习复盘数字，不是未来预期。`;
  const paperSamples = raw.match(/^(\d+) paper trade sample\(s\)$/);
  if (paperSamples) return `${paperSamples[1]} 条课堂记录样本`;
  const reliability = raw.match(/^Reliability\s+(.+)$/i);
  if (reliability) return `可信度：${displayLearningStatus(reliability[1])}`;
  const sampleQuality = raw.match(/^Sample quality\s+(.+)$/i);
  if (sampleQuality) return `样本质量：${displayLearningStatus(sampleQuality[1])}`;
  const contextAttempts = raw.match(/^(\d+) context-reviewed attempt\(s\)$/);
  if (contextAttempts) return `${contextAttempts[1]} 次已检查背景边界的练习`;
  const weakBoundary = raw.match(/^(\d+) weak boundary attempt\(s\)$/);
  if (weakBoundary) return `${weakBoundary[1]} 次背景边界薄弱练习`;
  const wrongContext = raw.match(/^(\d+) wrong context misconception attempt\(s\)$/);
  if (wrongContext) return `${wrongContext[1]} 次消息/情绪误区错误`;
  const winRateOnly = raw.match(/^Win rate ([\d.]+)% only describes (\d+) saved classroom paper trade\(s\)\.$/);
  if (winRateOnly) return `做对比例 ${winRateOnly[1]}% 只描述 ${winRateOnly[2]} 条课堂记录。`;
  if (/^sample too small for strategy claims$/i.test(raw)) return "样本太少，不能做策略结论。";
  if (/^close-to-close classroom replay$/i.test(raw)) return "课堂收盘到收盘回放";
  if (/^saved demo or historical scenario candles$/i.test(raw)) return "已保存的演示或历史场景K线";
  const observed = raw.match(/^(\d+) observed item\(s\)$/);
  if (observed) return `${observed[1]} 条观察记录`;
  return displayLearningStatus(raw);
}
...
async function refreshCourseCatalog() {
  ...
  try {
      ...
      ? result.packages.map((item) => `
        <div class="attempt-row">
          <div>
            ...
            <span>${courseAccessLabel(item)} / 当前方案：${escapeHtml(item.learnerPlan || "体验")}${item.requiredPlan ? ` / 解锁要求：${escapeHtml(item.requiredPlan)}` : ""}</span>
            <span>${courseAssignmentText(item)}</span>
            <span>${courseProgressText(item)}</span>
            <span>${courseCompletionText(item)}</span>
            <span>${courseScopeText(item)}</span>
            <span>${item.knowledgePoints.map((kp) => kp.title).join(" / ") || "先看课程导入，再进入第一道训练题。"}</span>
            <span>${escapeHtml(item.constraints?.[1] || "只做教育训练，不输出交易建议。")}</span>
          </div>
    ...
    nodes.courseCatalogList.innerHTML = `<p>学习包需要先进入学习体验：${error.message}</p>`;
  }
}
...
function knowledgeBrowserState() {
  return state.knowledgeBrowser || {};
}

function knowledgeBrowserBoundaryText(payload = {}) {
  return payload.boundary || "Education-only internal knowledge review. No stock recommendation, live signal, broker workflow, automation, performance promise, or real-money guidance.";
}

function renderKnowledgeBrowser() {
  if (!nodes.knowledgeBrowserStatus) return;
  const kb = knowledgeBrowserState();
  const overview = kb.overview;
  if (!overview) {
    nodes.knowledgeBrowserStatus.textContent = "点击刷新，加载内部知识库索引、课程路径和来源证据。";
    if (nodes.knowledgeBrowserModuleList) nodes.knowledgeBrowserModuleList.innerHTML = "<p>等待知识库 overview。</p>";
    if (nodes.knowledgeBrowserNodeList) nodes.knowledgeBrowserNodeList.innerHTML = "<p>选择模块后显示节点。</p>";
    if (nodes.knowledgeBrowserDetail) nodes.knowledgeBrowserDetail.innerHTML = "<p>选择一个学习节点，查看定义、误区、rubric 和审查状态。</p>";
    if (nodes.knowledgeBrowserEvidence) nodes.knowledgeBrowserEvidence.innerHTML = "<p>节点证据会显示绿色来源和引用边界。</p>";
    if (nodes.knowledgeBrowserLocalCourse) nodes.knowledgeBrowserLocalCourse.innerHTML = "<p>本地课程覆盖会显示私有 PDF 吸收进度和 rewrite intake。</p>";
    if (nodes.knowledgeBrowserMasterDelivery) nodes.knowledgeBrowserMasterDelivery.innerHTML = "<p>master database 会显示内部课程交付面板。</p>";
    if (nodes.knowledgeBrowserCurriculum) nodes.knowledgeBrowserCurriculum.innerHTML = "<p>课程路径会显示 unit、checkpoint 和非发布边界。</p>";
    return;
  }
  const quality = overview.qualitySummary || {};
  const sourceSummary = overview.sourceSummary || {};
  nodes.knowledgeBrowserStatus.textContent =
    `模块 ${overview.modules?.length || 0}，候选节点 ${quality.learnerFacingNodes || 0}，绿色来源审查仍为内部草稿；productionReady:${overview.productionReady}.`;
  renderKnowledgeBrowserModules();
  renderKnowledgeBrowserNodes();
  renderKnowledgeBrowserDetail();
  renderKnowledgeBrowserEvidence();
  renderKnowledgeBrowserLocalCourse();
  renderKnowledgeBrowserMasterDelivery();
  renderKnowledgeBrowserCurriculum();
  const sourceCount = sourceSummary.totalRealUrls || sourceSummary.totalSources || sourceSummary.reviewedSources || "";
  if (sourceCount) {
    nodes.knowledgeBrowserStatus.textContent += ` 来源池 ${sourceCount} 条，界面仅做审查入口。`;
  }
}

function renderKnowledgeBrowserModules() {
  if (!nodes.knowledgeBrowserModuleList) return;
  const kb = knowledgeBrowserState();
  const modules = kb.modules || kb.overview?.modules || [];
  nodes.knowledgeBrowserModuleList.innerHTML = modules.length
    ? modules.map((module) => `
      <button type="button" class="knowledge-module-button ${module.id === kb.selectedModuleId ? "is-active" : ""}" data-knowledge-module="${escapeHtml(module.id)}">
        <strong>${escapeHtml(module.title)}</strong>
        <span>${module.learnerFacingNodes || 0} 个候选节点 / ${module.draftNodes || 0} 个草稿</span>
        <small>${(module.topics || []).slice(0, 4).map(escapeHtml).join(" / ") || "等待主题标签"}</small>
      </button>
    `).join("")
    : "<p>还没有模块索引。</p>";
}

function renderKnowledgeBrowserNodes() {
  if (!nodes.knowledgeBrowserNodeList) return;
  const kb = knowledgeBrowserState();
  const rows = kb.nodes || [];
  nodes.knowledgeBrowserNodeList.innerHTML = rows.length
    ? rows.map((node) => `
      <button type="button" class="knowledge-node-button ${node.id === kb.selectedNodeId ? "is-active" : ""}" data-knowledge-node="${escapeHtml(node.id)}">
        <strong>${escapeHtml(node.title || node.id)}</strong>
        <span>${escapeHtml(node.module || "")} / ${escapeHtml(node.topic || "")} / ${escapeHtml(node.difficulty || node.difficultyStage || "draft")}</span>
        <small>${escapeHtml(node.reviewStatus || "review_pending")} · reviewed refs ${node.reviewedSourceRefCount ?? 0}</small>
      </button>
    `).join("")
    : "<p>选择左侧模块后，这里显示前 20 个候选节点。</p>";
}

function renderKnowledgeBrowserDetail() {
  if (!nodes.knowledgeBrowserDetail) return;
  const detail = knowledgeBrowserState().selectedNodeDetail;
  if (!detail?.node) {
    nodes.knowledgeBrowserDetail.innerHTML = "<p>选择节点后查看课程草稿和审查边界。</p>";
    return;
  }
  const node = detail.node;
  const lesson = detail.lesson || {};
  const mistakes = node.commonMistakes || lesson.commonMistakes || [];
  const antiExamples = node.antiExamples || lesson.antiExamples || [];
  nodes.knowledgeBrowserDetail.innerHTML = `
    <div class="knowledge-detail-head">
      <div>
        <p class="eyebrow">${escapeHtml(node.module || "知识模块")} / ${escapeHtml(node.topic || "主题")}</p>
        <h3>${escapeHtml(node.title || node.id)}</h3>
        <span>${escapeHtml(node.reviewStatus || "curriculum_draft")} / ${escapeHtml(node.sourceGroundingStatus || "source_review_required")}</span>
      </div>
      <span class="tag warn">${detail.productionReady ? "production" : "non-production"}</span>
    </div>
    <div class="knowledge-review-strip">
      <span><b>定义</b>${escapeHtml(node.definition || lesson.learningGoal || "等待重写")}</span>
      <span><b>原则</b>${escapeHtml(node.principle || lesson.principleExplanation || "只保留教育解释，不做行动建议。")}</span>
      <span><b>学习边界</b>${escapeHtml(lesson.learnerBoundary || node.educationBoundaryNote || knowledgeBrowserBoundaryText(detail))}</span>
    </div>
    <div class="knowledge-two-column">
      <article>
        <strong>常见误区</strong>
        <ol>${mistakes.slice(0, 5).map((item) => `<li>${escapeHtml(item)}</li>`).join("") || "<li>等待 reviewer 补充误区。</li>"}</ol>
      </article>
      <article>
        <strong>反例/不要这样用</strong>
        <ol>${antiExamples.slice(0, 5).map((item) => `<li>${escapeHtml(item)}</li>`).join("") || "<li>不得转成买卖建议、信号或收益承诺。</li>"}</ol>
      </article>
    </div>
    <article class="knowledge-rubric-card">
      <strong>练习 prompt / rubric 草稿</strong>
      <span>${escapeHtml(node.practicePrompt || lesson.practicePrompt || "写出观察证据、失效条件、背景边界和不做条件。")}</span>
      <small>${escapeHtml(node.rubricDraft || lesson.rubricDraft || "评分只看学习过程证据，不看结果收益。")}</small>
    </article>
    <p class="muted-note">${escapeHtml(node.sourceBoundary || node.licenseBoundary || knowledgeBrowserBoundaryText(detail))}</p>
  `;
}

function renderKnowledgeBrowserEvidence() {
  if (!nodes.knowledgeBrowserEvidence) return;
  const kb = knowledgeBrowserState();
  const detail = kb.selectedNodeDetail;
  const evidence = kb.selectedNodeEvidence;
  const evidenceLoading = Boolean(kb.evidenceLoading);
  const evidenceError = kb.evidenceError || "";
  const refs = detail?.node?.reviewedSourceRefs || [];
  const chunks = evidence?.evidence || [];
  const selectedNodeId = kb.selectedNodeId || detail?.node?.id || "";
  nodes.knowledgeBrowserEvidence.innerHTML = `
    <div class="knowledge-evidence-summary">
      <span><b>reviewed refs</b>${refs.length}</span>
      <span><b>retrieved chunks</b>${chunks.length}</span>
      <span><b>release</b>${detail?.learnerFacingRelease ? "blocked drift" : "false"}</span>
    </div>
    <div class="knowledge-source-list">
      ${refs.slice(0, 8).map((ref) => `
        <article>
          <strong>${escapeHtml(ref.name || ref.sourceId || "green source")}</strong>
          <span>${escapeHtml(ref.sourceUseTier || ref.tier || "green/reference")} / ${escapeHtml(ref.relevanceSignal || ref.boundary || "boundary checked")}</span>
          ${ref.url ? `<a href="${escapeHtml(ref.url)}" target="_blank" rel="noreferrer">查看来源</a>` : ""}
        </article>
      `).join("") || "<p>该节点没有可展示 reviewed source refs。</p>"}
    </div>
    <div class="knowledge-evidence-actions">
      <button type="button" class="secondary" data-load-knowledge-evidence="${escapeHtml(selectedNodeId)}" ${!selectedNodeId || evidenceLoading ? "disabled" : ""}>
        ${evidenceLoading ? "正在检索语料片段" : "加载附加语料片段"}
      </button>
      ${evidenceError ? `<small>${escapeHtml(evidenceError)}</small>` : "<small>reviewed refs 是主证据；语料片段仅做 reviewer 定位和改写参考。</small>"}
    </div>
    <div class="knowledge-source-list">
      ${evidenceLoading ? "<p>正在检索 corpus evidence...</p>" : chunks.slice(0, 5).map((item) => `
        <article>
          <strong>${escapeHtml(item.title || item.sourceName || item.sourceId || "evidence chunk")}</strong>
          <span>${escapeHtml(item.tier || item.sourceUseTier || "pointer")} / ${escapeHtml(item.boundary || "cite and paraphrase only")}</span>
          ${item.excerpt ? `<small>${escapeHtml(item.excerpt)}</small>` : "<small>pointer-only：只用于定位和改写，不复制来源正文。</small>"}
        </article>
      `).join("") || (evidenceError ? "<p>附加语料片段暂不可用；请先使用 reviewed refs 审查。</p>" : "<p>附加语料片段尚未加载。</p>")}
    </div>
  `;
}

function renderKnowledgeReviewCockpit(kb, selectedModuleTitle) {
  const knowledgeBaseReadinessGate = kb.knowledgeBaseReadinessGate;
  const coverage = kb.localCourseCoverage;
  const absorptionReadiness = kb.localCourseAbsorptionReadiness;
  const moduleAbsorptionSelfAudit = kb.localCourseModuleAbsorptionSelfAudit;
  const moduleReviewDossier = kb.localCourseModuleReviewDossier;
  const reviewGateDashboard = kb.localCourseReviewGateDashboard;
  const absorptionQueue = kb.localCourseAbsorptionQueue;
  const p0ReviewOverlay = kb.localCourseAbsorptionP0ReviewOverlay;
  const p0ReviewOperatorIndex = kb.localCourseP0ReviewOperatorIndex;
  const p0WriteAuthorizationPreview = kb.localCourseP0WriteAuthorizationPreview;
  const p0HumanReviewBundle = kb.localCourseP0HumanReviewBundle;
  const p0HumanReviewBundleInputCopy = kb.localCourseP0HumanReviewBundleInputCopy;
  const p0HumanReviewBundlePositiveFixture = kb.localCourseP0HumanReviewBundlePositiveFixture;
  const p0HumanReviewRealReviewerHandoff = kb.localCourseP0HumanReviewRealReviewerHandoff;
  const p0RealReviewerInputStarter = kb.localCourseP0RealReviewerInputStarter;
  const p0RealReviewerTaskBoard = kb.localCourseP0RealReviewerTaskBoard;
  const p0RealReviewerEvidencePacket = kb.localCourseP0RealReviewerEvidencePacket;
  const p0RealReviewerSourceFitWorksheet = kb.localCourseP0RealReviewerSourceFitWorksheet;
  const p0RealReviewerSourceFitInputGuide = kb.localCourseP0RealReviewerSourceFitInputGuide;
  const p0RealReviewerSourceFitInputValidation = kb.localCourseP0RealReviewerSourceFitInputValidation;
  const p0RealReviewerSourceFitHandoff = kb.localCourseP0RealReviewerSourceFitHandoff;
  const highRiskSelfReviewOverlay = kb.localCourseHighRiskSelfReviewOverlay;
  const highRiskPublicGroundingMatrix = kb.localCourseHighRiskPublicGroundingMatrix;
  const highRiskReviewCockpit = kb.localCourseHighRiskReviewCockpit;
  const rewriteReview = kb.localCourseRewriteReview;
  const lessonRows = highRiskReviewCockpit?.lessonRows || highRiskPublicGroundingMatrix?.lessonRows || [];
  const visibleLessonRows = selectedModuleTitle
    ? lessonRows.filter((row) => row.module === selectedModuleTitle)
    : lessonRows;
  const directSourceRows = highRiskReviewCockpit?.directSourceRows || highRiskPublicGroundingMatrix?.directSourceRows || [];
  const cockpitLessons = visibleLessonRows.length ? visibleLessonRows : lessonRows;
  const gateRows = [
    {
      label: "Knowledge base gate",
      value: knowledgeBaseReadinessGate?.knowledgeBaseUsefulnessStatus || "not loaded",
      note: `${knowledgeBaseReadinessGate?.internalReadyGates || 0} internal gates / ${knowledgeBaseReadinessGate?.learnerFacingBlockedGates || 0} learner blockers / source-fit ${knowledgeBaseReadinessGate?.readySourceFitReviewRows || 0}/${knowledgeBaseReadinessGate?.sourceFitReviewRows || 0}`,
      status: knowledgeBaseReadinessGate?.readinessStatus || "knowledge_base_readiness_gate_missing",
    },
    {
      label: "Local absorption",
      value: `${absorptionReadiness?.importedUniquePdfFiles || coverage?.documents || 0}/${absorptionReadiness?.uniquePdfFiles || coverage?.documents || 0} PDFs`,
      note: `${absorptionReadiness?.openBlockers || 0} blockers / ${absorptionReadiness?.manualTranscriptionPages || 0} manual pages / ${absorptionReadiness?.sourceReplacementCandidates || 0} replacement pages`,
      status: absorptionReadiness?.readinessStatus || "blocked_for_learner_facing_absorption",
    },
    {
      label: "Module audit",
      value: `${moduleAbsorptionSelfAudit?.researchLayerReadyModules || 0}/${moduleAbsorptionSelfAudit?.modules || 0} modules`,
      note: `public ${moduleAbsorptionSelfAudit?.publicReferenceReadyModules || 0} / rewrite ${moduleAbsorptionSelfAudit?.rewriteDraftReadyModules || 0} / release blockers ${moduleAbsorptionSelfAudit?.highRiskReleaseBlockingLessons || 0}`,
      status: moduleAbsorptionSelfAudit?.auditStatus || "module_absorption_self_audit_missing",
    },
    {
      label: "Module dossier",
      value: `${moduleReviewDossier?.rowsWithCoursePath || 0}/${moduleReviewDossier?.modules || 0} paths`,
      note: `samples ${moduleReviewDossier?.rowsWithPublicEvidenceSamples || 0} / entry nodes ${moduleReviewDossier?.rowsWithEntryNodes || 0} / learner-ready ${moduleReviewDossier?.learnerReleaseReadyModules || 0}`,
      status: moduleReviewDossier?.dossierStatus || "module_review_dossier_missing",
    },
    {
      label: "P0 human review",
      value: `${p0HumanReviewBundle?.totalReviewEntries || p0ReviewOverlay?.totalP0Tasks || 0} entries`,
      note: `${p0HumanReviewBundle?.manualPackCount || p0ReviewOperatorIndex?.manualPackCount || 0} manual packs + ${p0HumanReviewBundle?.sourceReplacementPackCount || 0} source pack / blocked ${p0HumanReviewBundle?.validationBlockedEntries || p0ReviewOperatorIndex?.blankInputBlockedEntries || 0}`,
      status: p0HumanReviewBundle?.bundleStatus || p0ReviewOverlay?.overlayStatus || "p0_review_not_started",
    },
    {
      label: "High-risk lessons",
      value: `${highRiskSelfReviewOverlay?.reviewerNotesReviewed || 0}/${highRiskSelfReviewOverlay?.expectedReviewerNotes || 0} notes`,
      note: `${highRiskSelfReviewOverlay?.releaseBlockingNotes || 0} blocking notes / ${highRiskSelfReviewOverlay?.releaseReadyNotes || 0} release-ready notes`,
      status: highRiskSelfReviewOverlay?.overlayStatus || "codex_self_review_missing",
    },
    {
      label: "High-risk cockpit",
      value: `${highRiskReviewCockpit?.readyReviewerNotes || 0}/${highRiskReviewCockpit?.expectedReviewerNotes || 0} real notes`,
      note: `${highRiskReviewCockpit?.directSourceDecisionCount || 0} direct-source decisions / human ${highRiskReviewCockpit?.realHumanInputEntries || 0} / blocked lessons ${highRiskReviewCockpit?.blockedLessons || 0}`,
      status: highRiskReviewCockpit?.cockpitStatus || "high_risk_review_cockpit_missing",
    },
    {
      label: "Public grounding",
      value: `${highRiskPublicGroundingMatrix?.lessonsWithPublicGrounding || 0}/${highRiskPublicGroundingMatrix?.lessonCount || 0} lessons`,
      note: `${highRiskPublicGroundingMatrix?.totalWikipediaRefs || 0} Wikipedia refs / ${highRiskPublicGroundingMatrix?.totalPublicContextRefs || 0} public refs`,
      status: highRiskPublicGroundingMatrix?.matrixStatus || "public_grounding_missing",
    },
    {
      label: "Write gate",
      value: p0WriteAuthorizationPreview?.writeAllowedNow === true ? "allowed" : "blocked",
      note: `manual authorization:${p0WriteAuthorizationPreview?.manualAuthorizationRequired === true} / approval:${highRiskPublicGroundingMatrix?.approvalStatus || "not_approved"}`,
      status: p0WriteAuthorizationPreview?.previewStatus || "write_authorization_preview_missing",
    },
    {
      label: "Originality screen",
      value: `${rewriteReview?.readyForSeparateReviewCandidates || 0} ready`,
      note: `copy ${rewriteReview?.copyRiskIssues || 0} / safety ${rewriteReview?.safetyIssues || 0} / max overlap ${rewriteReview?.maxSourceOverlap ?? 0}`,
      status: rewriteReview?.approvalStatus || "not_approved",
    },
  ];

  return `
    <section class="knowledge-review-cockpit" aria-label="Knowledge review cockpit">
      <div class="knowledge-section-head">
        <div>
          <p class="eyebrow">Review Cockpit</p>
          <strong>Internal reviewer map</strong>
        </div>
        <span>learnerFacingRelease:${highRiskPublicGroundingMatrix?.learnerFacingRelease === true} / writeAllowed:${p0WriteAuthorizationPreview?.writeAllowedNow === true}</span>
      </div>
      <div class="knowledge-cockpit-metrics">
        ${gateRows.map((row) => `
          <article>
      ...
      <div class="knowledge-cockpit-columns">
        <article>
          <div class="knowledge-section-head">
            <strong>High-risk lesson queue</strong>
            <span>${cockpitLessons.length}/${lessonRows.length} shown</span>
          </div>
          <div class="knowledge-cockpit-list">
            ${cockpitLessons.slice(0, 8).map((lesson) => `
              <div>
                <strong>${escapeHtml(lesson.lessonId || lesson.nodeId || lesson.candidateId)}</strong>
                <span>${escapeHtml(lesson.module || "")} / ${escapeHtml(lesson.topic || "")} / ${escapeHtml(lesson.publicGroundingStatus || "not_mapped")}</span>
                <small>wiki ${lesson.wikipediaRefCount || (lesson.wikipediaRefs || []).length} / public ${lesson.publicContextRefCount || (lesson.publicContextRefs || []).length} / real notes ${lesson.realReviewerNotesReady || 0}/${lesson.realReviewerNotesRequired || 0}</small>
                <small>next: ${escapeHtml(lesson.nextGate || "human_public_grounding_review_then_originality_and_release_gate")}</small>
              </div>
            `).join("") || "<p>No high-risk lessons mapped for this module yet.</p>"}
          </div>
        </article>
        ${p0HumanReviewBundle ? `
          <article>
            <div class="knowledge-section-head">
              <strong>P0 human review bundle</strong>
              <span>${p0HumanReviewBundle.totalReviewEntries || 0} entries</span>
            </div>
            <div class="knowledge-cockpit-list">
              ${(p0HumanReviewBundle.packRows || []).map((row) => `
                <div>
                  <strong>${escapeHtml(row.packNumber || row.packId)}</strong>
                  <span>${escapeHtml(row.category || "")} / ${escapeHtml(row.packStatus || "")}</span>
                  <small>entries ${row.totalInputEntries || 0} / blocked ${row.validation?.blockedEntries || 0} / ready ${row.validation?.readyEntries || 0}</small>
                  <small>fixture ${row.positiveFixture?.readyForValidationEntries || 0} / written ${p0HumanReviewBundle.fixtureWrittenEntries || 0} / real human ${p0HumanReviewBundle.realHumanInputEntries || 0}</small>
                </div>
              `).join("")}
              ${p0HumanReviewBundleInputCopy ? `
                <div>
                  <strong>unified input copy</strong>
                  <span>${escapeHtml(p0HumanReviewBundleInputCopy.templateStatus || "")} / ${escapeHtml(p0HumanReviewBundleInputCopy.validationStatus || "")}</span>
                  <small>entries ${p0HumanReviewBundleInputCopy.totalEntries || 0} / blocked ${p0HumanReviewBundleInputCopy.validationBlockedEntries || 0} / ready ${p0HumanReviewBundleInputCopy.validationReadyEntries || 0}</small>
                  <small>filled ${p0HumanReviewBundleInputCopy.filledEntries || 0} / forbidden ${p0HumanReviewBundleInputCopy.forbiddenHitEntries || 0}</small>
                </div>
              ` : ""}
              ${p0HumanReviewBundlePositiveFixture ? `
                <div>
                  <strong>positive fixture control</strong>
                  <span>${escapeHtml(p0HumanReviewBundlePositiveFixture.templateStatus || "")} / ${escapeHtml(p0HumanReviewBundlePositiveFixture.validationStatus || "")}</span>
                  <small>entries ${p0HumanReviewBundlePositiveFixture.totalEntries || 0} / ready ${p0HumanReviewBundlePositiveFixture.validationReadyEntries || 0} / blocked ${p0HumanReviewBundlePositiveFixture.validationBlockedEntries || 0}</small>
                  <small>fixtureOnly:${p0HumanReviewBundlePositiveFixture.fixtureOnly === true} / approval ${escapeHtml(p0HumanReviewBundlePositiveFixture.approvalStatus || "not_approved")}</small>
                </div>
              ` : ""}
              ${p0HumanReviewRealReviewerHandoff ? `
                <div>
                  <strong>real reviewer handoff</strong>
                  <span>${escapeHtml(p0HumanReviewRealReviewerHandoff.handoffStatus || "")} / ${escapeHtml(p0HumanReviewRealReviewerHandoff.handoffMode || "")}</span>
                  <small>entries ${p0HumanReviewRealReviewerHandoff.totalReviewEntries || 0} / blank blocked ${p0HumanReviewRealReviewerHandoff.blankInputBlockedEntries || 0} / fixture ready ${p0HumanReviewRealReviewerHandoff.positiveFixtureReadyEntries || 0}</small>
                  <small>real human ${p0HumanReviewRealReviewerHandoff.realHumanInputEntries || 0} / write allowed:${p0HumanReviewRealReviewerHandoff.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerInputStarter ? `
                <div>
                  <strong>real input starter</strong>
                  <span>${escapeHtml(p0RealReviewerInputStarter.starterStatus || "")}</span>
                  <small>draft ${escapeHtml(p0RealReviewerInputStarter.draftInputPath || "")}</small>
                  <small>ready ${p0RealReviewerInputStarter.validationReadyEntries || 0} / blocked ${p0RealReviewerInputStarter.validationBlockedEntries || 0} / write allowed:${p0RealReviewerInputStarter.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerTaskBoard ? `
                <div>
                  <strong>real reviewer task board</strong>
                  <span>${escapeHtml(p0RealReviewerTaskBoard.boardStatus || "")}</span>
                  <small>tasks ${p0RealReviewerTaskBoard.totalTasks || 0} / ready ${p0RealReviewerTaskBoard.readyTasks || 0} / blocked ${p0RealReviewerTaskBoard.blockedTasks || 0}</small>
                  <small>missing reviewer identity ${p0RealReviewerTaskBoard.rowsMissingReviewerIdentity || 0} / write allowed:${p0RealReviewerTaskBoard.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerEvidencePacket ? `
                <div>
                  <strong>real reviewer evidence packet</strong>
                  <span>${escapeHtml(p0RealReviewerEvidencePacket.packetStatus || "")}</span>
                  <small>tasks ${p0RealReviewerEvidencePacket.tasksWithSuggestedRefs || 0}/${p0RealReviewerEvidencePacket.totalTasks || 0} / wiki ${p0RealReviewerEvidencePacket.tasksWithWikipediaRefs || 0} / public context ${p0RealReviewerEvidencePacket.tasksWithPublicContextRefs || 0}</small>
                  <small>learner citations ${p0RealReviewerEvidencePacket.learnerCitationApprovedTasks || 0} / write allowed:${p0RealReviewerEvidencePacket.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerSourceFitWorksheet ? `
                <div>
                  <strong>source-fit worksheet</strong>
                  <span>${escapeHtml(p0RealReviewerSourceFitWorksheet.worksheetStatus || "")}</span>
                  <small>cards ${p0RealReviewerSourceFitWorksheet.totalCards || 0} / blank fields ${p0RealReviewerSourceFitWorksheet.totalBlankFields || 0} / refs ${p0RealReviewerSourceFitWorksheet.cardsWithSuggestedRefs || 0}</small>
                  <small>filled ${p0RealReviewerSourceFitWorksheet.reviewerFilledCards || 0} / decisions ${p0RealReviewerSourceFitWorksheet.generatedDecisions || 0} / write allowed:${p0RealReviewerSourceFitWorksheet.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerSourceFitInputGuide ? `
                <div>
                  <strong>source-fit input guide</strong>
                  <span>${escapeHtml(p0RealReviewerSourceFitInputGuide.guideStatus || "")}</span>
                  <small>rows ${p0RealReviewerSourceFitInputGuide.totalGuideRows || 0} / source-fit paths ${p0RealReviewerSourceFitInputGuide.rowsWithSourceFitFieldPath || 0} / public refs paths ${p0RealReviewerSourceFitInputGuide.rowsWithPublicReferenceNotesFieldPath || 0}</small>
                  <small>filled ${p0RealReviewerSourceFitInputGuide.reviewerFilledRows || 0} / decisions ${p0RealReviewerSourceFitInputGuide.generatedDecisions || 0} / write allowed:${p0RealReviewerSourceFitInputGuide.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerSourceFitInputValidation ? `
                <div>
                  <strong>source-fit validation</strong>
                  <span>${escapeHtml(p0RealReviewerSourceFitInputValidation.validationStatus || "")}</span>
                  <small>ready ${p0RealReviewerSourceFitInputValidation.readyRows || 0} / blocked ${p0RealReviewerSourceFitInputValidation.blockedRows || 0} / missing ${p0RealReviewerSourceFitInputValidation.missingFieldRows || 0}</small>
                  <small>forbidden ${p0RealReviewerSourceFitInputValidation.forbiddenHitRows || 0} / fixture ready ${p0RealReviewerSourceFitInputValidation.fixtureReadyRows || 0} / real human ${p0RealReviewerSourceFitInputValidation.realHumanInputEntries || 0} / write allowed:${p0RealReviewerSourceFitInputValidation.writeAllowedNow === true}</small>
                </div>
              ` : ""}
              ${p0RealReviewerSourceFitHandoff ? `
                <div>
                  <strong>source-fit handoff</strong>
                  <span>${escapeHtml(p0RealReviewerSourceFitHandoff.handoffStatus || "")}</span>
                  <small>phases ${(p0RealReviewerSourceFitHandoff.phaseRows || []).length} / real ready ${p0RealReviewerSourceFitHandoff.sourceFitRealReadyRows || 0} / blocked ${p0RealReviewerSourceFitHandoff.sourceFitRealBlockedRows || 0}</small>
                  <small>fixture ${p0RealReviewerSourceFitHandoff.sourceFitFixtureReadyRows || 0} / real human ${p0RealReviewerSourceFitHandoff.realHumanInputEntries || 0} / write allowed:${p0RealReviewerSourceFitHandoff.writeAllowedNow === true}</small>
                </div>
              ` : ""}
            </div>
          </article>
        ...
        <article>
          <div class="knowledge-section-head">
            <strong>Direct-source boundary</strong>
            <span>${directSourceRows.length} candidates</span>
          </div>
          <div class="knowledge-cockpit-list">
            ${directSourceRows.slice(0, 5).map((row) => `
              <div>
                <strong>${escapeHtml(row.sourceResolutionId || row.id || row.candidateId)}</strong>
                <span>${escapeHtml(row.module || "")} / ${escapeHtml(row.topic || "")} / ${escapeHtml(row.codexSelfReviewDecision || row.selfReviewDecision || "reviewer_only")}</span>
                <small>public replacements ${row.publicReplacementRefCount || (row.publicReplacementRefs || []).length || 0} / learner citation:${row.learnerCitationApproved === true}</small>
                <small>${escapeHtml(row.nextReviewerAction || row.action || "Keep private/direct source as reviewer-only background.")}</small>
              </div>
            `).join("") || "<p>No direct-source candidates loaded.</p>"}
          </div>
        </article>
      </div>
      <p class="muted-note">Review cockpit is an internal course QA surface only. It maps evidence and blockers; it does not approve learner-facing release or permit real-money guidance.</p>
    </section>
  `;
}

function renderKnowledgeBrowserMasterDelivery() {
  if (!nodes.knowledgeBrowserMasterDelivery) return;
  const kb = knowledgeBrowserState();
  const database = kb.masterKnowledgeDatabase || kb.overview?.masterKnowledgeDatabase || null;
  if (!database) {
    nodes.knowledgeBrowserMasterDelivery.innerHTML = "<p>等待 master knowledge database。</p>";
    return;
  }
  const selectedModuleTitle = (kb.modules || []).find((module) => module.id === kb.selectedModuleId)?.title;
  const selectedModule = database.selectedModule
    || (database.masterModules || []).find((row) => row.module === selectedModuleTitle)
    || (database.masterModules || [])[0];
  const masterModules = database.masterModules || [];
  const totals = database.totals || {};
  const quality = database.qualityDashboard || {};
  const graphNodes = database.ontologyMap?.knowledge_tree || [];
  const moduleCards = database.moduleCards || [];
  const lessonCards = moduleCards.filter((card) => card.type === "lesson_outline");
  const practiceCards = moduleCards.filter((card) => /quiz|practice|lesson/.test(`${card.type} ${card.tags?.join(" ")}`)).slice(0, 8);
  const sourceFitCounts = selectedModule?.quality?.sourceFitCounts || {};
  const highRiskModules = masterModules.filter((row) => row.quality?.releaseRisk === "high_release_risk");
  const currentRiskClass = selectedModule?.quality?.releaseRisk === "high_release_risk" ? "danger" : "warn";
  nodes.knowledgeBrowserMasterDelivery.innerHTML = `
    <section class="knowledge-master-delivery" aria-label="Internal course delivery panel">
      <div class="knowledge-master-hero">
        <div>
          <p class="eyebrow">Internal Course Delivery</p>
          <h3>Master database delivery panel</h3>
          <span>${escapeHtml(database.databaseStatus || "ai_only_master_knowledge_database_ready_internal_release_blocked")} · learnerFacingRelease:${database.learnerFacingRelease === true} · approval:${escapeHtml(database.approvalStatus || "not_approved")}</span>
        </div>
        <div class="knowledge-master-kpis">
          <span><b>${totals.masterModules || 0}</b>modules</span>
          <span><b>${totals.retrievalCards || 0}</b>cards</span>
          <span><b>${totals.relationshipEdges || 0}</b>edges</span>
          <span><b>${totals.quizAndPracticeItems || 0}</b>quiz/practice</span>
        </div>
      </div>
      <div class="knowledge-master-grid">
        <article class="knowledge-master-card">
          <div class="knowledge-section-head">
            <strong>Module overview</strong>
            <span>${quality.aiOnlyUsableModules || 0}/${masterModules.length || 0} internal usable · high risk ${quality.highReleaseRiskModules || 0}</span>
          </div>
          <div class="knowledge-module-score-list">
            ${masterModules.map((row) => `
              <div class="${row.module === selectedModule?.module ? "is-active" : ""}">
                <strong>${escapeHtml(row.module)}</strong>
                <span>AI-only ${row.quality?.aiOnlyScore || 0} · ${escapeHtml(row.quality?.releaseRisk || "review_required")}</span>
                <small>${escapeHtml(row.quality?.aiOnlyUse || "internal_only")} · source-fit ${row.quality?.coverageSignals?.sourceFitRows || 0}</small>
              </div>
            `).join("")}
          </div>
        </article>
        <article class="knowledge-master-card">
          <div class="knowledge-section-head">
            <strong>${escapeHtml(selectedModule?.module || "Selected module")}</strong>
            <span class="tag ${currentRiskClass}">${escapeHtml(selectedModule?.quality?.releaseRisk || "review_required")}</span>
          </div>
          <div class="knowledge-master-metrics">
            <span><b>${selectedModule?.quality?.aiOnlyScore || 0}</b>AI-only score</span>
            <span><b>${selectedModule?.quality?.coverageSignals?.lessonOutlines || 0}</b>lessons</span>
            <span><b>${selectedModule?.quality?.coverageSignals?.quizItems || 0}</b>quiz</span>
            <span><b>${selectedModule?.quality?.coverageSignals?.practiceItems || 0}</b>practice</span>
          </div>
          <div class="knowledge-source-fit-row">
            ${Object.entries(sourceFitCounts).map(([key, value]) => `<span>${escapeHtml(key)} <b>${value}</b></span>`).join("") || "<span>source-fit counts pending</span>"}
          </div>
          <p>${escapeHtml(selectedModule?.boundary || "AI-only internal module record. Not learner-facing approved.")}</p>
        </article>
      </div>
      <div class="knowledge-master-grid">
        <article class="knowledge-master-card">
          <div class="knowledge-section-head">
            ...
            <span>${totals.lessonOutlines || 0} lesson outlines / ${totals.internalTeachingPackages || 0} packages</span>
          </div>
          <ol class="knowledge-course-sequence">
            ${(graphNodes.length ? graphNodes : masterModules).slice(0, 12).map((row, index) => `
              <li>
                <b>${index + 1}. ${escapeHtml(row.module)}</b>
                <span>${row.lessons?.length || row.lessons || 3} lessons · source-fit ${row.sourceFitNodes || row.quality?.coverageSignals?.sourceFitRows || 0}</span>
              </li>
            `).join("")}
          </ol>
        </article>
        <article class="knowledge-master-card">
          <div class="knowledge-section-head">
            <strong>Lessons / practice / quiz</strong>
            <span>${lessonCards.length || selectedModule?.lessons?.length || 0} scoped lesson cards</span>
          </div>
          <div class="knowledge-delivery-card-list">
            ${(practiceCards.length ? practiceCards : moduleCards.slice(0, 8)).map((card) => `
              <div>
                <strong>${escapeHtml(card.title || card.id)}</strong>
                <span>${escapeHtml(card.type || "retrieval_card")} · ${escapeHtml(card.releaseStatus || "internal_only_not_approved")}</span>
                <small>${escapeHtml(card.summary || "Internal course-design card.")}</small>
              </div>
            `).join("") || "<p>该模块暂无可展示 lesson/practice/quiz card。</p>"}
          </div>
        </article>
      </div>
      <article class="knowledge-master-card">
        <div class="knowledge-section-head">
          ...
          <span>${escapeHtml(quality.releaseReadiness || "learner_release_blocked_no_human_review_claimed")}</span>
        </div>
        <div class="knowledge-blocker-strip">
          <span><b>${highRiskModules.length}</b> high-risk modules</span>
          <span><b>0</b> real human approvals</span>
          <span><b>${quality.sourceFitPrecheckCounts?.high_risk || 0}</b> high-risk source-fit rows</span>
          <span><b>false</b> writeAllowedNow</span>
        </div>
        <div class="knowledge-delivery-card-list compact">
          ${highRiskModules.map((row) => `
            <div>
              <strong>${escapeHtml(row.module)}</strong>
              <span>${escapeHtml(row.quality?.nextAiOnlyUpgrade || "Generate safer internal examples and keep release blocked.")}</span>
            </div>
          `).join("")}
        </div>
        <p class="muted-note">${escapeHtml(database.boundary || "Internal course delivery panel only; no learner-facing release approval.")}</p>
      </article>
    </section>
  `;
}

function renderKnowledgeBrowserLocalCourse() {
  if (!nodes.knowledgeBrowserLocalCourse) return;
  const kb = knowledgeBrowserState();
  const knowledgeBaseReadinessGate = kb.knowledgeBaseReadinessGate;
  const knowledgeModuleReviewCockpit = kb.knowledgeModuleReviewCockpit;
  const knowledgeReviewerActionQueue = kb.knowledgeReviewerActionQueue;
  const knowledgeFirstReviewerActionHandoff = kb.knowledgeFirstReviewerActionHandoff;
  const knowledgeFirstReviewerFieldMap = kb.knowledgeFirstReviewerFieldMap;
  const knowledgeFirstReviewerCompletionGate = kb.knowledgeFirstReviewerCompletionGate;
  const knowledgeFirstReviewerExecutionChecklist = kb.knowledgeFirstReviewerExecutionChecklist;
  const knowledgeFirstReviewerWorkbench = kb.knowledgeFirstReviewerWorkbench;
  const knowledgeFirstReviewerCardStatusMatrix = kb.knowledgeFirstReviewerCardStatusMatrix;
  const knowledgeFirstReviewerPostInputRouteMap = kb.knowledgeFirstReviewerPostInputRouteMap;
  const knowledgeFirstReviewerInputQueue = kb.knowledgeFirstReviewerInputQueue;
  const knowledgeReleaseBlockerAudit = kb.knowledgeReleaseBlockerAudit;
  const knowledgeCoursePathReadinessAudit = kb.knowledgeCoursePathReadinessAudit;
  const knowledgeModuleReviewSprintPlan = kb.knowledgeModuleReviewSprintPlan;
  const coverage = kb.localCourseCoverage;
  const absorptionReadiness = kb.localCourseAbsorptionReadiness;
  const moduleAbsorptionSelfAudit = kb.localCourseModuleAbsorptionSelfAudit;
  const moduleReviewDossier = kb.localCourseModuleReviewDossier;
  const absorptionQueue = kb.localCourseAbsorptionQueue;
  const p0Workbench = kb.localCourseAbsorptionP0Workbench;
  const p0ReviewOverlay = kb.localCourseAbsorptionP0ReviewOverlay;
  const p0ReviewOperatorIndex = kb.localCourseP0ReviewOperatorIndex;
  const p0WriteAuthorizationPreview = kb.localCourseP0WriteAuthorizationPreview;
  const p0ReviewInputNegativeCases = kb.localCourseP0ReviewInputNegativeCases;
  const sourceReplacementDecisions = kb.localCourseSourceReplacementDecisions;
  const sourceQuality = kb.localCourseSourceQuality;
  const sourceSyncAudit = kb.localCourseSourceSyncAudit;
  const documentAbsorptionMap = kb.localCourseDocumentAbsorptionMap;
  const folderAbsorptionLedger = kb.localCourseFolderAbsorptionLedger;
  const publicSourceGap = kb.publicSourceGap;
  const wikipediaGroundingAudit = kb.wikipediaGroundingAudit;
  const publicSourceAbsorptionMap = kb.publicSourceAbsorptionMap;
  const publicSourceCoverageLedger = kb.publicSourceCoverageLedger;
  const knowledgeNodeSourceTriangulationAudit = kb.knowledgeNodeSourceTriangulationAudit;
  const knowledgeNodePublicSourceFitCandidatePack = kb.knowledgeNodePublicSourceFitCandidatePack;
  const knowledgeNodePublicSourceFitReviewInputStarter = kb.knowledgeNodePublicSourceFitReviewInputStarter;
  const knowledgeNodePublicSourceFitReviewInputValidation = kb.knowledgeNodePublicSourceFitReviewInputValidation;
  const knowledgeNodePublicSourceFitReviewExecutionQueue = kb.knowledgeNodePublicSourceFitReviewExecutionQueue;
  const knowledgeNodePublicSourceFitReviewBatchPackets = kb.knowledgeNodePublicSourceFitReviewBatchPackets;
  const knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate = kb.knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate;
  const knowledgeNodePublicSourceFitReviewPacketMergePreview = kb.knowledgeNodePublicSourceFitReviewPacketMergePreview;
  const knowledgeNodePublicSourceFitReviewPacketMergeApplyReport = kb.knowledgeNodePublicSourceFitReviewPacketMergeApplyReport;
  const knowledgeNodePublicSourceFitReviewPacket001Handoff = kb.knowledgeNodePublicSourceFitReviewPacket001Handoff;
  const knowledgeNodePublicSourceFitReviewPacketHandoffIndex = kb.knowledgeNodePublicSourceFitReviewPacketHandoffIndex;
  const knowledgeNodePublicSourceFitRealReviewerLaunchDashboard = kb.knowledgeNodePublicSourceFitRealReviewerLaunchDashboard;
  const knowledgeNodePublicSourceFitPacket001ReviewerWorkbench = kb.knowledgeNodePublicSourceFitPacket001ReviewerWorkbench;
  const knowledgeNodePublicSourceFitReviewerWorkbenchIndex = kb.knowledgeNodePublicSourceFitReviewerWorkbenchIndex;
  const knowledgeNodePublicSourceFitReviewerRowBrowser = kb.knowledgeNodePublicSourceFitReviewerRowBrowser;
  const selectedReviewerRowDetail = kb.selectedReviewerRowDetail;
  const selectedFirstReviewerInputDetail = kb.selectedFirstReviewerInputDetail;
  const reviewerRowQuery = kb.reviewerRowQuery || "limit=80";
  const inputQueueQuery = kb.inputQueueQuery || "limit=80";
  const knowledgeNodePublicSourceFitReviewProgressMatrix = kb.knowledgeNodePublicSourceFitReviewProgressMatrix;
  const lowExtractionVisualReview = kb.lowExtractionVisualReview;
  const lowExtractionHighResReview = kb.lowExtractionHighResReview;
  const highResTranscriptionCandidates = kb.localCourseHighResTranscriptionCandidates;
  const p0CandidateReviewAssistMap = kb.localCourseP0CandidateReviewAssistMap;
  const p0ReviewInputDryRunSample = kb.localCourseP0ReviewInputDryRunSample;
  const p0HumanReviewNoteTemplate = kb.localCourseP0HumanReviewNoteTemplate;
  const p0HumanFillPack01 = kb.localCourseP0HumanFillPack01;
  const p0HumanFillPack01InputCopy = kb.localCourseP0HumanFillPack01InputCopy;
  const p0HumanReviewBundle = kb.localCourseP0HumanReviewBundle;
  const p0HumanReviewBundleInputCopy = kb.localCourseP0HumanReviewBundleInputCopy;
  const p0HumanReviewBundlePositiveFixture = kb.localCourseP0HumanReviewBundlePositiveFixture;
  const p0HumanReviewRealReviewerHandoff = kb.localCourseP0HumanReviewRealReviewerHandoff;
  ...
  const p0RealReviewerSourceFitInputValidation = kb.localCourseP0RealReviewerSourceFitInputValidation;
  const p0RealReviewerSourceFitHandoff = kb.localCourseP0RealReviewerSourceFitHandoff;
  const lowExtractionTranscriptionOverlay = kb.lowExtractionTranscriptionOverlay;
  const lowExtractionTranscriptIntake = kb.lowExtractionTranscriptIntake;
  const lowExtractionManualTranscriptionPack = kb.lowExtractionManualTranscriptionPack;
  const lowExtractionSourceReplacementPack = kb.lowExtractionSourceReplacementPack;
  const rewriteIntake = kb.localCourseRewriteIntake || [];
  const rewriteBatch = kb.localCourseRewriteBatch;
  const rewriteBatches = kb.localCourseRewriteBatches;
  const rewriteReview = kb.localCourseRewriteReview;
  const refinementPacket = kb.localCourseRefinementPacket;
  const highRiskSelfReviewOverlay = kb.localCourseHighRiskSelfReviewOverlay;
  const highRiskPublicGroundingMatrix = kb.localCourseHighRiskPublicGroundingMatrix;
  const highRiskRealReviewerOverlayStarter = kb.localCourseHighRiskRealReviewerOverlayStarter;
  const highRiskRealReviewerOverlayInputValidation = kb.localCourseHighRiskRealReviewerOverlayInputValidation;
  const highRiskReviewCockpit = kb.localCourseHighRiskReviewCockpit;
  if (!coverage) {
    nodes.knowledgeBrowserLocalCourse.innerHTML = kb.localCourseError
      ? `<p>${escapeHtml(kb.localCourseError)}</p>`
      : "<p>等待本地课程覆盖报告。</p>";
    return;
  }
  const selectedModuleTitle = (kb.modules || []).find((module) => module.id === kb.selectedModuleId)?.title;
  const selectedDossierModule = selectedModuleTitle
    ? (moduleReviewDossier?.moduleRows || []).find((module) => module.module === selectedModuleTitle)
    : (moduleReviewDossier?.moduleRows || [])[0];
  const selectedReviewGateModule = selectedModuleTitle
    ? (reviewGateDashboard?.moduleGateRows || []).find((module) => module.module === selectedModuleTitle)
    : (reviewGateDashboard?.moduleGateRows || [])[0];
  const moduleRows = selectedModuleTitle
    ? (coverage.moduleCoverage || []).filter((module) => module.module === selectedModuleTitle)
    : (coverage.moduleCoverage || []).slice(0, 4);
  const selectedModuleIntake = selectedModuleTitle
    ? rewriteIntake.filter((item) => item.module === selectedModuleTitle).slice(0, 4)
    : rewriteIntake.slice(0, 4);
  const selectedIntake = selectedModuleIntake.length ? selectedModuleIntake : rewriteIntake.slice(0, 4);
  nodes.knowledgeBrowserLocalCourse.innerHTML = `
    <div class="knowledge-evidence-summary">
      <span><b>local PDFs</b>${coverage.documents || 0}</span>
      <span><b>local chunks</b>${coverage.chunks || 0}</span>
      <span><b>rewrite ready</b>${coverage.readyForRewriteReviewNodes || 0}/${coverage.matchedNodes || 0}</span>
    </div>
    ${renderKnowledgeReviewCockpit(kb, selectedModuleTitle)}
    <div class="knowledge-local-grid">
      ${knowledgeReleaseBlockerAudit ? `
        <article>
          <strong>release blocker audit</strong>
          <span>${escapeHtml(knowledgeReleaseBlockerAudit.internalUseStatus || "")} · ${escapeHtml(knowledgeReleaseBlockerAudit.learnerUseStatus || "")}</span>
          <small>${escapeHtml(knowledgeReleaseBlockerAudit.auditStatus || "knowledge_release_blocker_audit_attention_required")} · local absorbed:${knowledgeReleaseBlockerAudit.localCourseAbsorbed === true} · public absorbed:${knowledgeReleaseBlockerAudit.publicSourcesAbsorbed === true} · workbench ready:${knowledgeReleaseBlockerAudit.internalWorkbenchReady === true} · learner blocked:${knowledgeReleaseBlockerAudit.learnerReleaseBlocked === true}</small>
          <small>reviewer blocked ${knowledgeReleaseBlockerAudit.reviewerBlockedWorkItems || 0} · first handoff blocked ${knowledgeReleaseBlockerAudit.firstHandoffBlockedWorkItems || 0} · source-fit blocked ${knowledgeReleaseBlockerAudit.blockedSourceFitReviewRows || 0} · real human ${knowledgeReleaseBlockerAudit.realHumanInputEntries || 0} · write allowed:${knowledgeReleaseBlockerAudit.writeAllowedNow === true}</small>
          ${(knowledgeReleaseBlockerAudit.releaseBlockerRows || []).slice(0, 3).map((row) => `
            <small>${escapeHtml(row.blockerId || "")}: blocked ${row.blockedItems || 0} · ${escapeHtml(row.nextGate || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeCoursePathReadinessAudit ? `
        <article>
          <strong>course path readiness</strong>
          <span>${knowledgeCoursePathReadinessAudit.internalReadyPaths || 0}/${knowledgeCoursePathReadinessAudit.coursePaths || 0} internal paths · learner-ready ${knowledgeCoursePathReadinessAudit.learnerReleaseReadyPaths || 0}/${knowledgeCoursePathReadinessAudit.coursePaths || 0}</span>
          <small>${escapeHtml(knowledgeCoursePathReadinessAudit.auditStatus || "course_path_readiness_attention_required")} · lessons ${knowledgeCoursePathReadinessAudit.totalLessons || 0} · units ${knowledgeCoursePathReadinessAudit.totalUnits || 0} · minutes ${knowledgeCoursePathReadinessAudit.totalEstimatedMinutes || 0} · source-fit ${knowledgeCoursePathReadinessAudit.readySourceFitReviewRows || 0}/${knowledgeCoursePathReadinessAudit.sourceFitReviewRows || 0} · real human ${knowledgeCoursePathReadinessAudit.realHumanInputEntries || 0}</small>
          ${(knowledgeCoursePathReadinessAudit.pathRows || []).slice(0, 3).map((row) => `
            <small>${escapeHtml(row.pathId || "")} ${escapeHtml(row.module || "")}: ${row.lessonCount || 0} lessons · source-fit ${row.readySourceFitRows || 0}/${row.sourceFitRows || 0} · ${escapeHtml(row.reviewStatus || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeModuleReviewSprintPlan ? `
        <article>
          <strong>module review sprint plan</strong>
          <span>${knowledgeModuleReviewSprintPlan.highRiskSprintModules || 0} high-risk modules first · ${knowledgeModuleReviewSprintPlan.sprintRows || 0} module rows</span>
          <small>${escapeHtml(knowledgeModuleReviewSprintPlan.sprintPlanStatus || "module_review_sprint_plan_attention_required")} · blocked ${knowledgeModuleReviewSprintPlan.totalBlockedWorkItems || 0} · first sprint ${knowledgeModuleReviewSprintPlan.firstSprintBlockedWorkItems || 0} · source-fit ${knowledgeModuleReviewSprintPlan.readySourceFitReviewRows || 0}/${knowledgeModuleReviewSprintPlan.sourceFitReviewRows || 0} · real human ${knowledgeModuleReviewSprintPlan.realHumanInputEntries || 0} · write allowed:${knowledgeModuleReviewSprintPlan.writeAllowedNow === true}</small>
          ${(knowledgeModuleReviewSprintPlan.moduleSprintRows || []).slice(0, 3).map((row) => `
            <small>#${row.sprintRank || ""} ${escapeHtml(row.module || "")}: ${escapeHtml(row.sprintPhase || "")} · blocked ${row.blockedWorkItems || 0} · first ${escapeHtml(row.firstActionId || row.firstBlockedPacketId || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeBaseReadinessGate ? `
        <article>
          <strong>knowledge base readiness gate</strong>
          <span>${escapeHtml(knowledgeBaseReadinessGate.knowledgeBaseUsefulnessStatus || "")} · gates ${knowledgeBaseReadinessGate.internalReadyGates || 0}/${(knowledgeBaseReadinessGate.gateRows || []).length || 0} · learner blockers ${knowledgeBaseReadinessGate.learnerFacingBlockedGates || 0}</span>
          <small>${escapeHtml(knowledgeBaseReadinessGate.readinessStatus || "knowledge_base_readiness_attention_required")} · local PDFs ${knowledgeBaseReadinessGate.localMappedUniquePdfFiles || 0}/${knowledgeBaseReadinessGate.localUniquePdfHashes || 0} · public docs ${knowledgeBaseReadinessGate.publicMappedDocuments || 0}/${knowledgeBaseReadinessGate.publicCorpusDocuments || 0} · source-fit ${knowledgeBaseReadinessGate.readySourceFitReviewRows || 0}/${knowledgeBaseReadinessGate.sourceFitReviewRows || 0} · write allowed:${knowledgeBaseReadinessGate.writeAllowedNow === true}</small>
          ${(knowledgeBaseReadinessGate.nextActionQueue || []).slice(0, 3).map((row) => `
            <small>${row.order || ""}. ${escapeHtml(row.gateId || "")}: ${escapeHtml(row.nextGate || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeModuleReviewCockpit ? `
        <article>
          <strong>module review cockpit</strong>
          <span>${knowledgeModuleReviewCockpit.internalNavigationReadyModules || 0}/${knowledgeModuleReviewCockpit.modules || 0} modules navigable · release-ready ${knowledgeModuleReviewCockpit.learnerReleaseReadyModules || 0}/${knowledgeModuleReviewCockpit.modules || 0}</span>
          <small>${escapeHtml(knowledgeModuleReviewCockpit.cockpitStatus || "module_review_cockpit_attention_required")} · source-fit ${knowledgeModuleReviewCockpit.readySourceFitReviewRows || 0}/${knowledgeModuleReviewCockpit.sourceFitReviewRows || 0} · high-risk notes ${knowledgeModuleReviewCockpit.highRiskReadyReviewerNotes || 0}/${(knowledgeModuleReviewCockpit.highRiskReadyReviewerNotes || 0) + (knowledgeModuleReviewCockpit.highRiskBlockedReviewerNotes || 0)} · real human ${knowledgeModuleReviewCockpit.realHumanInputEntries || 0} · write allowed:${knowledgeModuleReviewCockpit.writeAllowedNow === true}</small>
          ${(knowledgeModuleReviewCockpit.priorityModuleRows || []).slice(0, 3).map((row) => `
            <small>${escapeHtml(row.module || "")}: blocked source-fit ${row.blockedSourceFitRows || 0}${row.highRiskBlockedLessons ? ` · high-risk ${row.highRiskBlockedLessons}` : ""} · ${escapeHtml(row.firstBlockedPacketId || "module packet queue")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeReviewerActionQueue ? `
        <article>
          <strong>reviewer action queue</strong>
          <span>${knowledgeReviewerActionQueue.totalActionRows || 0} actions · blocked work ${knowledgeReviewerActionQueue.blockedWorkItems || 0} · ready ${knowledgeReviewerActionQueue.readyWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeReviewerActionQueue.queueStatus || "knowledge_reviewer_action_queue_attention_required")} · high-risk ${knowledgeReviewerActionQueue.highRiskLessonActions || 0} · direct-source ${knowledgeReviewerActionQueue.directSourceDecisionActions || 0} · source-fit packets ${knowledgeReviewerActionQueue.sourceFitPacketActions || 0} · real human ${knowledgeReviewerActionQueue.realHumanInputEntries || 0} · write allowed:${knowledgeReviewerActionQueue.writeAllowedNow === true}</small>
          ${(knowledgeReviewerActionQueue.firstActionRows || []).slice(0, 3).map((row) => `
            <small>#${row.queueRank || ""} ${escapeHtml(row.actionType || "")}: ${escapeHtml(row.module || "")} · ${escapeHtml(row.targetId || "")} · blocked ${row.blockedItems || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerActionHandoff ? `
        <article>
          <strong>first reviewer handoff</strong>
          <span>${knowledgeFirstReviewerActionHandoff.handoffActionRows || 0}/${knowledgeFirstReviewerActionHandoff.totalQueueActions || 0} actions · blocked work ${knowledgeFirstReviewerActionHandoff.blockedWorkItems || 0} · ready ${knowledgeFirstReviewerActionHandoff.readyWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerActionHandoff.handoffStatus || "first_reviewer_action_handoff_attention_required")} · high-risk ${knowledgeFirstReviewerActionHandoff.highRiskLessonActions || 0} · direct-source ${knowledgeFirstReviewerActionHandoff.directSourceDecisionActions || 0} · source-fit packets ${knowledgeFirstReviewerActionHandoff.sourceFitPacketActions || 0} · real human ${knowledgeFirstReviewerActionHandoff.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerActionHandoff.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerActionHandoff.firstActionRows || []).slice(0, 3).map((row) => `
            <small>#${row.handoffRank || ""}/q${row.queueRank || ""} ${escapeHtml(row.actionType || "")}: ${escapeHtml(row.module || "")} · ${escapeHtml(row.targetId || "")} · blocked ${row.blockedItems || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerFieldMap ? `
        <article>
          <strong>first reviewer field map</strong>
          <span>${knowledgeFirstReviewerFieldMap.mappedActionRows || 0}/${knowledgeFirstReviewerFieldMap.handoffActionRows || 0} actions mapped · blocked work ${knowledgeFirstReviewerFieldMap.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerFieldMap.fieldMapStatus || "first_reviewer_field_map_attention_required")} · note fields ${knowledgeFirstReviewerFieldMap.highRiskReviewerNoteFields || 0} · direct fields ${knowledgeFirstReviewerFieldMap.directSourceDecisionFields || 0} · source-fit rows ${knowledgeFirstReviewerFieldMap.sourceFitReviewRows || 0} · real human ${knowledgeFirstReviewerFieldMap.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerFieldMap.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerFieldMap.fieldRows || []).slice(0, 3).map((row) => `
            <small>#${row.handoffRank || ""} ${escapeHtml(row.fieldKind || row.actionType || "")}: ${escapeHtml(row.jsonPath || "")} · fields ${row.mappedFieldCount || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerCompletionGate ? `
        <article>
          <strong>first reviewer completion gate</strong>
          <span>${knowledgeFirstReviewerCompletionGate.readyWorkItems || 0}/${knowledgeFirstReviewerCompletionGate.requiredWorkItems || 0} ready · blocked ${knowledgeFirstReviewerCompletionGate.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerCompletionGate.completionGateStatus || "first_reviewer_completion_gate_attention_required")} · notes ${knowledgeFirstReviewerCompletionGate.highRiskReadyReviewerNotes || 0}/${knowledgeFirstReviewerCompletionGate.highRiskReviewerNoteFields || 0} · direct ${knowledgeFirstReviewerCompletionGate.readyDirectSourceDecisions || 0}/${knowledgeFirstReviewerCompletionGate.directSourceDecisionFields || 0} · source-fit ${knowledgeFirstReviewerCompletionGate.readySourceFitReviewRows || 0}/${knowledgeFirstReviewerCompletionGate.sourceFitReviewRows || 0} · real human ${knowledgeFirstReviewerCompletionGate.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerCompletionGate.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerCompletionGate.gateRows || []).map((row) => `
            <small>${escapeHtml(row.gateId || "")}: ${row.readyItems || 0}/${row.requiredItems || 0} · ${escapeHtml(row.validationStatus || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerExecutionChecklist ? `
        <article>
          <strong>first reviewer execution checklist</strong>
          <span>${knowledgeFirstReviewerExecutionChecklist.executionRowCount || 0} actions sequenced · ${knowledgeFirstReviewerExecutionChecklist.readyWorkItems || 0}/${knowledgeFirstReviewerExecutionChecklist.requiredWorkItems || 0} ready · blocked ${knowledgeFirstReviewerExecutionChecklist.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerExecutionChecklist.executionChecklistStatus || "first_reviewer_execution_checklist_attention_required")} · notes ${knowledgeFirstReviewerExecutionChecklist.highRiskReadyReviewerNotes || 0}/${knowledgeFirstReviewerExecutionChecklist.highRiskReviewerNoteFields || 0} · direct ${knowledgeFirstReviewerExecutionChecklist.readyDirectSourceDecisions || 0}/${knowledgeFirstReviewerExecutionChecklist.directSourceDecisionFields || 0} · source-fit ${knowledgeFirstReviewerExecutionChecklist.readySourceFitReviewRows || 0}/${knowledgeFirstReviewerExecutionChecklist.sourceFitReviewRows || 0} · real human ${knowledgeFirstReviewerExecutionChecklist.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerExecutionChecklist.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerExecutionChecklist.stageRows || []).slice(0, 3).map((row) => `
            <small>${row.stageRank || ""}. ${escapeHtml(row.stageId || "")}: ${row.readyItems || 0}/${row.requiredItems || 0} · ${escapeHtml(row.reviewStatus || "")}</small>
          `).join("")}
          ${(knowledgeFirstReviewerExecutionChecklist.firstExecutionRows || []).slice(0, 2).map((row) => `
            <small>#${row.executionRank || ""} ${escapeHtml(row.executionPhase || "")}: ${escapeHtml(row.module || "")} · ${escapeHtml(row.targetId || "")} · fields ${row.mappedFieldCount || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerWorkbench ? `
        <article>
          <strong>first reviewer workbench</strong>
          <span>${knowledgeFirstReviewerWorkbench.actionCards || 0} action cards · ${knowledgeFirstReviewerWorkbench.readyWorkItems || 0}/${knowledgeFirstReviewerWorkbench.requiredWorkItems || 0} ready · blocked ${knowledgeFirstReviewerWorkbench.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerWorkbench.workbenchStatus || "first_reviewer_workbench_attention_required")} · notes ${knowledgeFirstReviewerWorkbench.highRiskReadyReviewerNotes || 0}/${knowledgeFirstReviewerWorkbench.highRiskReviewerNoteFields || 0} · direct ${knowledgeFirstReviewerWorkbench.readyDirectSourceDecisions || 0}/${knowledgeFirstReviewerWorkbench.directSourceDecisionFields || 0} · source-fit ${knowledgeFirstReviewerWorkbench.readySourceFitReviewRows || 0}/${knowledgeFirstReviewerWorkbench.sourceFitReviewRows || 0} · real human ${knowledgeFirstReviewerWorkbench.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerWorkbench.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerWorkbench.phaseRows || []).map((row) => `
            <small>${escapeHtml(row.phaseId || "")}: actions ${row.actionRows || 0} · blocked ${row.blockedItems || 0} · gate ${escapeHtml(row.nextGate || "")}</small>
          `).join("")}
          ${(knowledgeFirstReviewerWorkbench.actionCardRows || []).slice(0, 3).map((row) => `
            <small>#${row.cardRank || ""} ${escapeHtml(row.actionType || "")}: ${escapeHtml(row.module || "")} · ${escapeHtml(row.jsonPath || "")} · evidence ${(row.evidenceSamples || []).length}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerCardStatusMatrix ? `
        <article>
          <strong>first reviewer card status matrix</strong>
          <span>${knowledgeFirstReviewerCardStatusMatrix.cardStatusRows || 0} cards · ${knowledgeFirstReviewerCardStatusMatrix.readyWorkItems || 0}/${knowledgeFirstReviewerCardStatusMatrix.requiredWorkItems || 0} ready · blocked ${knowledgeFirstReviewerCardStatusMatrix.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerCardStatusMatrix.matrixStatus || "first_reviewer_card_status_matrix_attention_required")} · validations ${knowledgeFirstReviewerCardStatusMatrix.validationStatusRows || 0} · notes ${knowledgeFirstReviewerCardStatusMatrix.highRiskReadyReviewerNotes || 0}/${knowledgeFirstReviewerCardStatusMatrix.highRiskReviewerNoteFields || 0} · direct ${knowledgeFirstReviewerCardStatusMatrix.readyDirectSourceDecisions || 0}/${knowledgeFirstReviewerCardStatusMatrix.directSourceDecisionFields || 0} · source-fit ${knowledgeFirstReviewerCardStatusMatrix.readySourceFitReviewRows || 0}/${knowledgeFirstReviewerCardStatusMatrix.sourceFitReviewRows || 0} · write allowed:${knowledgeFirstReviewerCardStatusMatrix.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerCardStatusMatrix.phaseStatusRowsData || []).map((row) => `
            <small>${escapeHtml(row.phaseId || "")}: ${row.readyItems || 0}/${row.requiredItems || 0} · ${escapeHtml(row.phaseStatus || "")}</small>
          `).join("")}
          ${(knowledgeFirstReviewerCardStatusMatrix.cardRows || []).slice(0, 3).map((row) => `
            <small>#${row.cardRank || ""} ${escapeHtml(row.humanInputStatus || "")}: ${escapeHtml(row.module || "")} · missing ${row.missingRequiredFieldGroups || 0} · ${escapeHtml(row.jsonPath || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerPostInputRouteMap ? `
        <article>
          <strong>first reviewer post-input route map</strong>
          <span>${knowledgeFirstReviewerPostInputRouteMap.routeRows || 0} routes · ${knowledgeFirstReviewerPostInputRouteMap.readyWorkItems || 0}/${knowledgeFirstReviewerPostInputRouteMap.requiredWorkItems || 0} ready · blocked ${knowledgeFirstReviewerPostInputRouteMap.blockedWorkItems || 0}</span>
          <small>${escapeHtml(knowledgeFirstReviewerPostInputRouteMap.routeMapStatus || "first_reviewer_post_input_route_map_attention_required")} · validation routes ${knowledgeFirstReviewerPostInputRouteMap.validationRoutes || 0} · source-fit merge routes ${knowledgeFirstReviewerPostInputRouteMap.sourceFitMergeRoutes || 0} · merge allowed:${knowledgeFirstReviewerPostInputRouteMap.mergeAllowedNow === true} · write allowed:${knowledgeFirstReviewerPostInputRouteMap.writeAllowedNow === true}</small>
          ${(knowledgeFirstReviewerPostInputRouteMap.routeRowsData || []).slice(0, 4).map((row) => `
            <small>${row.routeRank || ""}. ${escapeHtml(row.routeId || "")}: ${row.readyItems || 0}/${row.requiredItems || 0} · ${escapeHtml(row.routeStatus || "")}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeFirstReviewerInputQueue ? `
        <article>
          <strong>first reviewer input queue</strong>
          <span>${knowledgeFirstReviewerInputQueue.queueRows || 0} human-owned rows · ${knowledgeFirstReviewerInputQueue.readyRows || 0}/${knowledgeFirstReviewerInputQueue.queueRows || 0} ready · blocked ${knowledgeFirstReviewerInputQueue.blockedRows || 0}</span>
          <div class="knowledge-filter-row">
            ${[
              ["limit=80", "first 80"],
              ["itemType=high_risk_reviewer_note&limit=24", "high-risk notes"],
              ["itemType=direct_source_decision&limit=10", "direct-source"],
              ["route=source_fit_packet_001&limit=20", "packet 001"],
              ["q=Candlestick&limit=20", "Candlestick"],
              [`offset=${(knowledgeFirstReviewerInputQueue.rowQuery?.offset || 0) + (knowledgeFirstReviewerInputQueue.rowQuery?.limit || 80)}&limit=${knowledgeFirstReviewerInputQueue.rowQuery?.limit || 80}`, "next"],
            ].map(([query, label]) => `
              <button type="button" class="${inputQueueQuery === query ? "is-active" : ""}" data-input-queue-query="${escapeHtml(query)}">${escapeHtml(label)}</button>
            `).join("")}
          </div>
          <form class="knowledge-filter-form" data-input-queue-form>
            <label>
              itemType
              <input name="itemType" value="${escapeHtml(knowledgeFirstReviewerInputQueue.rowQuery?.itemType || "")}" placeholder="source_fit_packet_row" />
            </label>
            <label>
              route
              <input name="route" value="${escapeHtml(knowledgeFirstReviewerInputQueue.rowQuery?.route || "")}" placeholder="source_fit_packet_001" />
            </label>
            <label>
              q
              <input name="q" value="${escapeHtml(knowledgeFirstReviewerInputQueue.rowQuery?.q || "")}" placeholder="Candlestick" />
            </label>
            <label>
              limit
              <input name="limit" value="${escapeHtml(String(knowledgeFirstReviewerInputQueue.rowQuery?.limit || 80))}" inputmode="numeric" />
            </label>
            <button type="submit">apply</button>
          </form>
          <small>${escapeHtml(knowledgeFirstReviewerInputQueue.queueStatus || "first_reviewer_input_queue_attention_required")} · notes ${knowledgeFirstReviewerInputQueue.highRiskNoteRows || 0} · direct ${knowledgeFirstReviewerInputQueue.directSourceDecisionRows || 0} · source-fit ${knowledgeFirstReviewerInputQueue.sourceFitReviewRows || 0} · real human ${knowledgeFirstReviewerInputQueue.realHumanInputEntries || 0} · write allowed:${knowledgeFirstReviewerInputQueue.writeAllowedNow === true}</small>
          <small>showing ${knowledgeFirstReviewerInputQueue.rowQuery?.returnedRows || 0}/${knowledgeFirstReviewerInputQueue.rowQuery?.totalFilteredRows || knowledgeFirstReviewerInputQueue.queueRows || 0} · query ${escapeHtml(inputQueueQuery)}</small>
          ${(knowledgeFirstReviewerInputQueue.routeBreakdownRows || []).slice(0, 4).map((row) => `
            <small>${escapeHtml(row.routeId || "")}: ${row.readyRows || 0}/${row.itemRows || 0} ready · blocked ${row.blockedRows || 0}</small>
          `).join("")}
          ${(knowledgeFirstReviewerInputQueue.queueRowsData || []).slice(0, 3).map((row) => `
            <small>#${row.itemRank || ""} ${escapeHtml(row.itemType || "")}: ${escapeHtml(row.module || "")} · ${escapeHtml(row.topic || "")} · ${escapeHtml(row.jsonPath || "")} <button type="button" data-input-queue-detail="${row.itemRank || ""}">detail</button></small>
          `).join("")}
          ${selectedFirstReviewerInputDetail ? `
            <div class="knowledge-mini-detail">
              <strong>${escapeHtml(selectedFirstReviewerInputDetail.detailStatus || "")}</strong>
              <span>#${selectedFirstReviewerInputDetail.itemRank || ""} ${escapeHtml(selectedFirstReviewerInputDetail.row?.itemType || "")} · ${escapeHtml(selectedFirstReviewerInputDetail.row?.module || "")} · ${escapeHtml(selectedFirstReviewerInputDetail.row?.topic || "")}</span>
              <small>${escapeHtml(selectedFirstReviewerInputDetail.row?.inputPath || "")}#${escapeHtml(selectedFirstReviewerInputDetail.row?.jsonPath || "")}</small>
              <small>required ${(selectedFirstReviewerInputDetail.requiredFields || []).join(", ")} · evidence ${(selectedFirstReviewerInputDetail.evidenceSamples || []).length} · write allowed:${selectedFirstReviewerInputDetail.writeAllowedNow === true}</small>
              ${(selectedFirstReviewerInputDetail.nearbyRows || []).slice(0, 4).map((nearby) => `
                <small>near #${nearby.itemRank || ""} ${escapeHtml(nearby.itemType || "")}: ${escapeHtml(nearby.module || "")} · ${escapeHtml(nearby.jsonPath || "")}</small>
              `).join("")}
            </div>
          ` : ""}
        </article>
      ...
      ${absorptionReadiness ? `
        <article>
          <strong>absorption readiness audit</strong>
          <span>${absorptionReadiness.importedUniquePdfFiles || 0}/${absorptionReadiness.uniquePdfFiles || 0} PDFs imported / ${absorptionReadiness.publicReferenceReadyModules || 0}/${absorptionReadiness.modules || 0} modules public-ready / ${absorptionReadiness.openBlockers || 0} blockers</span>
          <small>${escapeHtml(absorptionReadiness.readinessStatus || "blocked_for_learner_facing_absorption")} · manual ${absorptionReadiness.manualTranscriptionPages || 0} pages · replacement ${absorptionReadiness.sourceReplacementCandidates || 0} pages · ${escapeHtml(absorptionReadiness.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${moduleAbsorptionSelfAudit ? `
        <article>
          <strong>module absorption self-audit</strong>
          <span>${moduleAbsorptionSelfAudit.researchLayerReadyModules || 0}/${moduleAbsorptionSelfAudit.modules || 0} modules research-layer ready / real human ${moduleAbsorptionSelfAudit.realHumanInputEntries || 0}</span>
          <small>${escapeHtml(moduleAbsorptionSelfAudit.auditStatus || "module_research_layer_absorbed_release_blocked")} · high-risk blockers ${moduleAbsorptionSelfAudit.highRiskReleaseBlockingLessons || 0} · write allowed:${moduleAbsorptionSelfAudit.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${documentAbsorptionMap ? `
        <article>
          <strong>document absorption map</strong>
          <span>${documentAbsorptionMap.mappedUniquePdfFiles || 0}/${documentAbsorptionMap.uniquePdfFiles || 0} unique PDFs mapped / node links ${documentAbsorptionMap.totalDocumentNodeMatches || 0}</span>
          <small>${escapeHtml(documentAbsorptionMap.auditStatus || "document_absorption_attention_required")} · reverse ${documentAbsorptionMap.reverseScoredMatchedPdfFiles || 0} · coverage-top ${documentAbsorptionMap.coverageTopMatchedPdfFiles || 0} · low/thin ${documentAbsorptionMap.lowOrThinExtractionMappedDocs || 0} · write allowed:${documentAbsorptionMap.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${folderAbsorptionLedger ? `
        <article>
          <strong>folder absorption ledger</strong>
          <span>${folderAbsorptionLedger.physicalPdfFiles || 0}/${folderAbsorptionLedger.physicalFiles || 0} PDFs · unique ${folderAbsorptionLedger.mappedUniquePdfFiles || 0}/${folderAbsorptionLedger.uniquePdfHashes || 0} mapped · dirs ${folderAbsorptionLedger.directories || 0}</span>
          <small>${escapeHtml(folderAbsorptionLedger.ledgerStatus || "folder_absorption_ledger_attention_required")} · non-PDF ${folderAbsorptionLedger.nonPdfFiles || 0} · duplicates ${folderAbsorptionLedger.duplicatePdfFiles || 0} · node links ${folderAbsorptionLedger.totalDocumentNodeMatches || 0} · write allowed:${folderAbsorptionLedger.writeAllowedNow === true}</small>
          ${(folderAbsorptionLedger.directoryRows || []).slice(0, 4).map((row) => `
            <small>${escapeHtml(row.directory || "")}: files ${row.physicalFiles || 0} · unique ${row.uniqueHashes || 0} · mapped ${row.mappedUniqueFiles || 0} · low/thin ${row.lowOrThinExtractionFiles || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${publicSourceAbsorptionMap ? `
        <article>
          <strong>public source absorption map</strong>
          <span>${publicSourceAbsorptionMap.mappedPublicDocuments || 0}/${publicSourceAbsorptionMap.publicCorpusDocuments || 0} public docs mapped / wiki ${publicSourceAbsorptionMap.mappedWikipediaDocuments || 0}/${publicSourceAbsorptionMap.wikipediaDocuments || 0} / official ${publicSourceAbsorptionMap.mappedOfficialLikeDocuments || 0}/${publicSourceAbsorptionMap.officialLikeDocuments || 0}</span>
          <small>${escapeHtml(publicSourceAbsorptionMap.auditStatus || "public_source_absorption_attention_required")} · node links ${publicSourceAbsorptionMap.totalPublicDocumentNodeMatches || 0} · learner citations ${publicSourceAbsorptionMap.learnerCitationApprovedDocuments || 0} · write allowed:${publicSourceAbsorptionMap.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${publicSourceCoverageLedger ? `
        <article>
          <strong>public source coverage ledger</strong>
          <span>${publicSourceCoverageLedger.mappedPublicDocuments || 0}/${publicSourceCoverageLedger.publicCorpusDocuments || 0} public docs · wiki ${publicSourceCoverageLedger.wikipediaDocuments || 0} · official ${publicSourceCoverageLedger.officialLikeDocuments || 0} · node links ${publicSourceCoverageLedger.totalPublicDocumentNodeMatches || 0}</span>
          <small>${escapeHtml(publicSourceCoverageLedger.ledgerStatus || "public_source_coverage_ledger_ready_release_blocked")} · module grounded ${publicSourceCoverageLedger.moduleGroundedNodes || 0}/${publicSourceCoverageLedger.nodes || 0} · direct triangulated ${publicSourceCoverageLedger.directTriangulatedNodes || 0} · source-fit ${publicSourceCoverageLedger.readySourceFitReviewRows || 0}/${publicSourceCoverageLedger.sourceFitReviewRows || 0} · human ${publicSourceCoverageLedger.realHumanInputEntries || 0} · write allowed:${publicSourceCoverageLedger.writeAllowedNow === true}</small>
          ${(publicSourceCoverageLedger.moduleRows || []).slice(0, 4).map((row) => `
            <small>${escapeHtml(row.module || "")}: public ${row.topPublicEvidenceDocs || 0} · wiki ${row.wikipediaEvidenceDocs || 0} · official ${row.officialLikeEvidenceDocs || 0} · candidates ${row.sourceFitCandidateRows || 0}</small>
          `).join("")}
        </article>
      ` : ""}
      ${knowledgeNodeSourceTriangulationAudit ? `
        <article>
          <strong>node source triangulation</strong>
          <span>local ${knowledgeNodeSourceTriangulationAudit.localReadyNodes || 0}/${knowledgeNodeSourceTriangulationAudit.nodes || 0} / direct public ${knowledgeNodeSourceTriangulationAudit.directPublicReadyNodes || 0} / wiki ${knowledgeNodeSourceTriangulationAudit.directWikipediaReadyNodes || 0} / official ${knowledgeNodeSourceTriangulationAudit.directOfficialReadyNodes || 0}</span>
          <small>${escapeHtml(knowledgeNodeSourceTriangulationAudit.auditStatus || "node_source_triangulation_ready_for_reviewer_release_blocked")} · direct triangulated ${knowledgeNodeSourceTriangulationAudit.directTriangulatedNodes || 0}/${knowledgeNodeSourceTriangulationAudit.nodes || 0} · module grounded ${knowledgeNodeSourceTriangulationAudit.moduleGroundedNodes || 0}/${knowledgeNodeSourceTriangulationAudit.nodes || 0} · learner citations ${knowledgeNodeSourceTriangulationAudit.learnerCitationApprovedNodes || 0} · write allowed:${knowledgeNodeSourceTriangulationAudit.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitCandidatePack ? `
        <article>
          <strong>node public source-fit candidates</strong>
          <span>${knowledgeNodePublicSourceFitCandidatePack.readyCandidateRows || 0}/${knowledgeNodePublicSourceFitCandidatePack.candidateTargetNodes || 0} target nodes ready / candidates ${knowledgeNodePublicSourceFitCandidatePack.totalCandidates || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitCandidatePack.packStatus || "node_public_source_fit_candidate_pack_ready_for_reviewer_release_blocked")} · wiki ${knowledgeNodePublicSourceFitCandidatePack.wikipediaCandidates || 0} · official ${knowledgeNodePublicSourceFitCandidatePack.officialCandidates || 0} · accepted ${knowledgeNodePublicSourceFitCandidatePack.reviewerAcceptedCandidates || 0} · learner citations ${knowledgeNodePublicSourceFitCandidatePack.learnerCitationApprovedCandidates || 0} · write allowed:${knowledgeNodePublicSourceFitCandidatePack.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewInputStarter ? `
        <article>
          <strong>source-fit review input starter</strong>
          <span>${knowledgeNodePublicSourceFitReviewInputStarter.reviewRows || 0} rows / target nodes ${knowledgeNodePublicSourceFitReviewInputStarter.candidateTargetNodes || 0} / real human ${knowledgeNodePublicSourceFitReviewInputStarter.realHumanInputEntries || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewInputStarter.starterStatus || "node_public_source_fit_review_input_starter_ready_blank")} · blocked ${knowledgeNodePublicSourceFitReviewInputStarter.blockedReviewRows || 0} · draft ${escapeHtml(knowledgeNodePublicSourceFitReviewInputStarter.draftInputPath || "")} · write allowed:${knowledgeNodePublicSourceFitReviewInputStarter.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewInputValidation ? `
        <article>
          <strong>source-fit review input validation</strong>
          <span>ready ${knowledgeNodePublicSourceFitReviewInputValidation.readyRows || 0}/${knowledgeNodePublicSourceFitReviewInputValidation.inputRows || 0} / blocked ${knowledgeNodePublicSourceFitReviewInputValidation.blockedRows || 0} / missing ${knowledgeNodePublicSourceFitReviewInputValidation.missingFieldRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewInputValidation.validationStatus || "blocked_missing_real_reviewer_source_fit_input")} · forbidden ${knowledgeNodePublicSourceFitReviewInputValidation.forbiddenHitRows || 0} · real human ${knowledgeNodePublicSourceFitReviewInputValidation.realHumanInputEntries || 0} · learner citations ${knowledgeNodePublicSourceFitReviewInputValidation.learnerCitationApprovedRows || 0} · write allowed:${knowledgeNodePublicSourceFitReviewInputValidation.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewExecutionQueue ? `
        <article>
          <strong>source-fit review execution queue</strong>
          <span>${knowledgeNodePublicSourceFitReviewExecutionQueue.readyBatches || 0}/${knowledgeNodePublicSourceFitReviewExecutionQueue.totalBatches || 0} batches ready / rows ${knowledgeNodePublicSourceFitReviewExecutionQueue.readyRows || 0}/${knowledgeNodePublicSourceFitReviewExecutionQueue.blockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewExecutionQueue.queueStatus || "node_public_source_fit_review_execution_queue_ready_release_blocked")} · modules ${knowledgeNodePublicSourceFitReviewExecutionQueue.modules || 0} · first queue ${(knowledgeNodePublicSourceFitReviewExecutionQueue.firstPriorityBatches || []).map((batch) => escapeHtml(batch.batchId || "")).slice(0, 3).join(", ")} · write allowed:${knowledgeNodePublicSourceFitReviewExecutionQueue.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewBatchPackets ? `
        <article>
          <strong>source-fit review batch packets</strong>
          <span>${knowledgeNodePublicSourceFitReviewBatchPackets.totalPackets || 0} packets / rows ${knowledgeNodePublicSourceFitReviewBatchPackets.readyRows || 0}/${knowledgeNodePublicSourceFitReviewBatchPackets.blockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.packetStatus || "node_public_source_fit_review_batch_packets_ready_release_blocked")} · first packet ${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.firstPriorityPackets?.[0]?.packetId || "")} · real human ${knowledgeNodePublicSourceFitReviewBatchPackets.realHumanInputEntries || 0} · write allowed:${knowledgeNodePublicSourceFitReviewBatchPackets.writeAllowedNow === true}</small>
          <small>selected ${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.packetId || "")} · displayed rows ${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.displayedRows || 0}/${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.reviewRows || 0}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate ? `
        <article>
          <strong>packet input copy template</strong>
          <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.packetId || "")} · ready ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationReadyRows || 0}/${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationInputRows || 0} · blocked ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationBlockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.templateStatus || "node_public_source_fit_packet_input_copy_template_ready_blank")} · missing ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationMissingFieldRows || 0} · real human ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.realHumanInputEntries || 0} · write allowed:${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.writeAllowedNow === true}</small>
          <small>copy ${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.inputCopyPath || "")}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewPacketMergePreview ? `
        <article>
          <strong>packet merge preview</strong>
          <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergePreview.packetId || "")} · mapped ${knowledgeNodePublicSourceFitReviewPacketMergePreview.mappedRows || 0}/${knowledgeNodePublicSourceFitReviewPacketMergePreview.packetRows || 0} · ready ${knowledgeNodePublicSourceFitReviewPacketMergePreview.readyRows || 0}/${knowledgeNodePublicSourceFitReviewPacketMergePreview.blockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergePreview.mergePreviewStatus || "packet_merge_preview_blocked_missing_ready_packet_input")} · merge allowed:${knowledgeNodePublicSourceFitReviewPacketMergePreview.mergeAllowedNow === true} · write allowed:${knowledgeNodePublicSourceFitReviewPacketMergePreview.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport ? `
        <article>
          <strong>packet merge apply report</strong>
          <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.applyMode || "dry_run")} · ready ${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.readyToMergeRows || 0}/${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.totalRows || 0} · written ${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.writtenRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.applyStatus || "blocked_no_ready_merge_rows")} · merge allowed:${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.mergeAllowedNow === true} · write allowed:${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewPacket001Handoff ? `
        <article>
          <strong>packet 001 reviewer handoff</strong>
          <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacket001Handoff.packetId || "")} · phases ${(knowledgeNodePublicSourceFitReviewPacket001Handoff.phaseRows || []).length} · ready ${knowledgeNodePublicSourceFitReviewPacket001Handoff.packetReadyRows || 0}/${knowledgeNodePublicSourceFitReviewPacket001Handoff.packetBlockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacket001Handoff.handoffStatus || "node_public_source_fit_packet_001_handoff_ready_blocked_on_real_input")} · written ${knowledgeNodePublicSourceFitReviewPacket001Handoff.mergeDryRunWrittenRows || 0} · write allowed:${knowledgeNodePublicSourceFitReviewPacket001Handoff.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex ? `
        <article>
          <strong>packet handoff index</strong>
          <span>${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.packetsWithHandoff || 0}/${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.totalPackets || 0} handoffs · templates ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.packetsWithInputCopyTemplate || 0}/${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.totalPackets || 0} · ready ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.readyPackets || 0}/${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.blockedPackets || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketHandoffIndex.indexStatus || "node_public_source_fit_packet_handoff_index_ready_release_blocked")} · first ${escapeHtml(knowledgeNodePublicSourceFitReviewPacketHandoffIndex.firstBlockedPacketId || "")} · write allowed:${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard ? `
        <article>
          <strong>real reviewer launch</strong>
          <span>${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.packetHandoffCoverage || "0/0")} handoffs · start ${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.startPacket?.packetId || "")} · rows ${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.startPacketReadyRows || 0}/${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.startPacketReviewRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.launchStatus || "source_fit_real_reviewer_launch_ready_blocked_on_real_input")} · global ready ${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.readyRows || 0}/${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.totalReviewRows || 0} · real human ${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.realHumanInputEntries || 0} · write allowed:${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench ? `
        <article>
          <strong>packet 001 workbench</strong>
          <span>${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.nodeCount || 0} nodes · rows ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.readyRows || 0}/${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.reviewRows || 0} · blocked ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.blockedRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.workbenchStatus || "packet_001_reviewer_workbench_ready_blocked_on_real_input")} · real human ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.realHumanInputEntries || 0} · dry-run written ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.dryRunWrittenRows || 0} · write allowed:${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex ? `
        <article>
          <strong>all-packet reviewer map</strong>
          <span>${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.totalPackets || 0} packets · ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.modules || 0} modules · rows ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.readyRows || 0}/${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.totalReviewRows || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewerWorkbenchIndex.workbenchIndexStatus || "source_fit_reviewer_workbench_index_ready_all_packets_blocked_on_real_input")} · validation ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.packetsWithValidation || 0}/${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.totalPackets || 0} · detailed browsers ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.packetsWithDetailedRowBrowser || 0} · write allowed:${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewerRowBrowser ? `
        <article>
          <strong>all-row reviewer browser</strong>
          <span>${knowledgeNodePublicSourceFitReviewerRowBrowser.totalReviewRows || 0} rows · urls ${knowledgeNodePublicSourceFitReviewerRowBrowser.rowsWithUrl || 0} · ready ${knowledgeNodePublicSourceFitReviewerRowBrowser.readyRows || 0}/${knowledgeNodePublicSourceFitReviewerRowBrowser.blockedRows || 0}</span>
          <div class="knowledge-filter-row">
            ${[
              ["limit=80", "first 80"],
              ["packet=001&limit=80", "packet 001"],
              ["family=Wikipedia&limit=80", "Wikipedia"],
              ["q=official&limit=80", "official"],
              ["q=Candlestick&limit=80", "Candlestick"],
              [`offset=${(knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.offset || 0) + (knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.limit || 80)}&limit=${knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.limit || 80}`, "next"],
            ].map(([query, label]) => `
              <button type="button" class="${reviewerRowQuery === query ? "is-active" : ""}" data-reviewer-row-query="${escapeHtml(query)}">${escapeHtml(label)}</button>
            `).join("")}
          </div>
          <form class="knowledge-filter-form" data-reviewer-row-form>
            <label>
              packet
              <input name="packet" value="${escapeHtml(knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.packet || "")}" placeholder="001" />
            </label>
            <label>
              family
              <input name="family" value="${escapeHtml(knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.family || "")}" placeholder="Wikipedia" />
            </label>
            <label>
              q
              <input name="q" value="${escapeHtml(knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.q || "")}" placeholder="Candlestick" />
            </label>
            <label>
              limit
              <input name="limit" value="${escapeHtml(String(knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.limit || 80))}" inputmode="numeric" />
            </label>
            <button type="submit">apply</button>
          </form>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewerRowBrowser.rowBrowserStatus || "source_fit_reviewer_row_browser_ready_all_rows_blocked_on_real_input")} · showing ${knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.returnedRows || 0}/${knowledgeNodePublicSourceFitReviewerRowBrowser.rowQuery?.totalFilteredRows || knowledgeNodePublicSourceFitReviewerRowBrowser.totalReviewRows || 0} · wiki ${knowledgeNodePublicSourceFitReviewerRowBrowser.wikipediaRows || 0} · official ${knowledgeNodePublicSourceFitReviewerRowBrowser.officialRows || 0} · open research ${knowledgeNodePublicSourceFitReviewerRowBrowser.openResearchRows || 0} · write allowed:${knowledgeNodePublicSourceFitReviewerRowBrowser.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${knowledgeNodePublicSourceFitReviewProgressMatrix ? `
        <article>
          <strong>source-fit review progress matrix</strong>
          <span>${knowledgeNodePublicSourceFitReviewProgressMatrix.overallProgressPercent || 0}% complete / packets ${knowledgeNodePublicSourceFitReviewProgressMatrix.readyPackets || 0}/${knowledgeNodePublicSourceFitReviewProgressMatrix.blockedPackets || 0}</span>
          <small>${escapeHtml(knowledgeNodePublicSourceFitReviewProgressMatrix.matrixStatus || "node_public_source_fit_review_progress_matrix_ready_release_blocked")} · rows ${knowledgeNodePublicSourceFitReviewProgressMatrix.readyRows || 0}/${knowledgeNodePublicSourceFitReviewProgressMatrix.blockedRows || 0} · first blocked ${escapeHtml(knowledgeNodePublicSourceFitReviewProgressMatrix.firstBlockedPacketId || "")} · write allowed:${knowledgeNodePublicSourceFitReviewProgressMatrix.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${moduleReviewDossier ? `
        <article>
          <strong>module review dossier</strong>
          <span>${moduleReviewDossier.rowsWithCoursePath || 0}/${moduleReviewDossier.modules || 0} paths / samples ${moduleReviewDossier.rowsWithPublicEvidenceSamples || 0} / learner-ready ${moduleReviewDossier.learnerReleaseReadyModules || 0}</span>
          <small>${escapeHtml(moduleReviewDossier.dossierStatus || "module_review_dossier_ready_for_internal_navigation_release_blocked")} · entry nodes ${moduleReviewDossier.rowsWithEntryNodes || 0} · source-fit real ${moduleReviewDossier.p0SourceFitRealReadyRows || 0}/${moduleReviewDossier.p0SourceFitRealBlockedRows || 0} · write allowed:${moduleReviewDossier.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${reviewGateDashboard ? `
        <article>
          <strong>review gate dashboard</strong>
          <span>${reviewGateDashboard.researchLayerReadyModules || 0}/${reviewGateDashboard.modules || 0} modules internal-ready / high-risk ${reviewGateDashboard.highRiskLessonsWithPublicGrounding || 0}/${reviewGateDashboard.highRiskLessons || 0} grounded / real human ${reviewGateDashboard.realHumanInputEntries || 0}</span>
          <small>${escapeHtml(reviewGateDashboard.dashboardStatus || "local_course_review_gate_dashboard_ready_release_blocked")} · high-risk notes ${reviewGateDashboard.highRiskRealReviewerNotesReady || 0}/${reviewGateDashboard.highRiskRealReviewerNotesBlocked || 0} · direct ${reviewGateDashboard.highRiskDirectSourceDecisionsReady || 0}/${reviewGateDashboard.highRiskDirectSourceDecisionsBlocked || 0} · P0 ${reviewGateDashboard.p0ReadyTasks || 0}/${reviewGateDashboard.p0BlockedTasks || 0} · source-fit ${reviewGateDashboard.sourceFitReadyRows || 0}/${reviewGateDashboard.sourceFitBlockedRows || 0} · node source-fit ${reviewGateDashboard.nodePublicSourceFitReadyRows || 0}/${reviewGateDashboard.nodePublicSourceFitBlockedRows || 0} · packets ${reviewGateDashboard.nodePublicSourceFitReadyPackets || 0}/${reviewGateDashboard.nodePublicSourceFitBlockedPackets || 0} · write allowed:${reviewGateDashboard.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${absorptionQueue ? `
        <article>
          <strong>absorption operator queue</strong>
          <span>${absorptionQueue.openTasks || 0}/${absorptionQueue.totalTasks || 0} open tasks / P0 ${absorptionQueue.byPriority?.P0 || 0} / P1 ${absorptionQueue.byPriority?.P1 || 0} / P2 ${absorptionQueue.byPriority?.P2 || 0}</span>
          <small>manual ${absorptionQueue.byCategory?.manual_transcription || 0} · replacement ${absorptionQueue.byCategory?.source_replacement || 0} · risky ${absorptionQueue.byCategory?.risky_language_review || 0} · refinement ${absorptionQueue.byCategory?.reviewer_refinement || 0} · ${escapeHtml(absorptionQueue.queueStatus || "open_absorption_blocker_queue")}</small>
        </article>
      ` : ""}
      ${p0Workbench ? `
        <article>
          <strong>P0 execution workbench</strong>
          <span>${p0Workbench.openTasks || 0}/${p0Workbench.totalP0Tasks || 0} P0 open / manual ${p0Workbench.manualTranscriptionTasks || 0} / replacement ${p0Workbench.sourceReplacementTasks || 0}</span>
          <small>${escapeHtml(p0Workbench.workbenchStatus || "p0_execution_ready")} · completed ${p0Workbench.completedTasks || 0} · ${escapeHtml(p0Workbench.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${p0ReviewOverlay ? `
        <article>
          <strong>P0 review overlay</strong>
          <span>${p0ReviewOverlay.notStartedTasks || 0}/${p0ReviewOverlay.totalP0Tasks || 0} not started / ${p0ReviewOverlay.readyForValidationTasks || 0} ready / ${p0ReviewOverlay.acceptedForNextGateTasks || 0} accepted</span>
          <small>${escapeHtml(p0ReviewOverlay.overlayStatus || "p0_review_not_started")} · blocked ${p0ReviewOverlay.blockedTasks || 0} · ${escapeHtml(p0ReviewOverlay.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${p0ReviewOperatorIndex ? `
        <article>
          <strong>P0 review operator index</strong>
          <span>${p0ReviewOperatorIndex.totalReviewPackEntries || 0}/${p0ReviewOperatorIndex.totalP0Tasks || 0} review entries covered / blank blocked ${p0ReviewOperatorIndex.blankInputBlockedEntries || 0} / fixture written ${p0ReviewOperatorIndex.positiveFixtureWrittenEntries || 0}</span>
          <small>${escapeHtml(p0ReviewOperatorIndex.indexStatus || "p0_review_operator_index_ready_not_applied")} · manual packs ${p0ReviewOperatorIndex.manualPackCount || 0} · replacement ${p0ReviewOperatorIndex.sourceReplacementPackEntries || 0} · overlay accepted ${p0ReviewOperatorIndex.overlayAcceptedForNextGateTasks || 0}</small>
        </article>
      ` : ""}
      ${p0WriteAuthorizationPreview ? `
        <article>
          <strong>P0 write authorization preview</strong>
          <span>write allowed ${p0WriteAuthorizationPreview.writeAllowedNow === true ? "yes" : "no"} / fixture ready ${p0WriteAuthorizationPreview.fixtureOnlyReadyEntries || 0} / source-fit real ${p0WriteAuthorizationPreview.sourceFitReadyRows || 0}/${p0WriteAuthorizationPreview.sourceFitBlockedRows || 0} / node source-fit ${p0WriteAuthorizationPreview.nodePublicSourceFitReadyRows || 0}/${p0WriteAuthorizationPreview.nodePublicSourceFitBlockedRows || 0} / packets ${p0WriteAuthorizationPreview.nodePublicSourceFitReadyPackets || 0}/${p0WriteAuthorizationPreview.nodePublicSourceFitBlockedPackets || 0}</span>
          <small>${escapeHtml(p0WriteAuthorizationPreview.previewStatus || "write_authorization_preview_ready_manual_required")} · high-risk notes ${p0WriteAuthorizationPreview.highRiskReadyReviewerNotes || 0}/${p0WriteAuthorizationPreview.highRiskBlockedReviewerNotes || 0} · direct ${p0WriteAuthorizationPreview.highRiskReadyDirectSourceDecisions || 0}/${p0WriteAuthorizationPreview.highRiskBlockedDirectSourceDecisions || 0} · first packet ${escapeHtml(p0WriteAuthorizationPreview.nodePublicSourceFitFirstBlockedPacketId || "")} · source-fit fixture ${p0WriteAuthorizationPreview.sourceFitFixtureReadyRows || 0} · manual required:${p0WriteAuthorizationPreview.manualAuthorizationRequired === true} · gates ${p0WriteAuthorizationPreview.machineCheckedGatesPassed === true ? "checked" : "blocked"}</small>
        </article>
      ` : ""}
      ${p0ReviewInputNegativeCases ? `
        <article>
          <strong>P0 review input negative cases</strong>
          <span>${p0ReviewInputNegativeCases.totalNegativeCases || 0} cases / manual copy ${p0ReviewInputNegativeCases.manualBadCandidateCopyIssueEntries || 0} / forbidden ${p0ReviewInputNegativeCases.manualBadForbiddenHitEntries || 0} / source misuse ${p0ReviewInputNegativeCases.sourceBadDirectCandidateMisuseEntries || 0}</span>
          <small>${escapeHtml(p0ReviewInputNegativeCases.reportStatus || "p0_review_input_negative_cases_ready")} · write allowed:${p0ReviewInputNegativeCases.writeAllowedNow === true} · overlay ${escapeHtml(p0ReviewInputNegativeCases.overlayStatus || "p0_review_not_started")}</small>
        </article>
      ` : ""}
      ${highRiskSelfReviewOverlay ? `
        <article>
          <strong>high-risk Codex self-review overlay</strong>
          <span>${highRiskSelfReviewOverlay.reviewerNotesReviewed || 0}/${highRiskSelfReviewOverlay.expectedReviewerNotes || 0} notes reviewed / blockers ${highRiskSelfReviewOverlay.releaseBlockingNotes || 0} / release-ready ${highRiskSelfReviewOverlay.releaseReadyNotes || 0}</span>
          <small>${escapeHtml(highRiskSelfReviewOverlay.overlayStatus || "codex_self_review_complete_not_approved")} · direct sources ${highRiskSelfReviewOverlay.directSourceCandidateResolutionsReviewed || 0} reviewed · write allowed:${highRiskSelfReviewOverlay.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${highRiskRealReviewerOverlayStarter ? `
        <article>
          <strong>high-risk real reviewer overlay starter</strong>
          <span>${highRiskRealReviewerOverlayStarter.lessonCount || 0} lessons / notes ${highRiskRealReviewerOverlayStarter.readyReviewerNotes || 0}/${highRiskRealReviewerOverlayStarter.totalReviewerNotes || 0} ready / direct ${highRiskRealReviewerOverlayStarter.readyDirectSourceDecisions || 0}/${highRiskRealReviewerOverlayStarter.directSourceDecisionCount || 0}</span>
          <small>${escapeHtml(highRiskRealReviewerOverlayStarter.starterStatus || "high_risk_real_reviewer_overlay_starter_ready_blank")} · draft ${escapeHtml(highRiskRealReviewerOverlayStarter.draftInputPath || "")} · real human ${highRiskRealReviewerOverlayStarter.realHumanInputEntries || 0} · write allowed:${highRiskRealReviewerOverlayStarter.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${highRiskRealReviewerOverlayInputValidation ? `
        <article>
          <strong>high-risk real reviewer validation</strong>
          <span>lessons ${highRiskRealReviewerOverlayInputValidation.readyLessons || 0}/${highRiskRealReviewerOverlayInputValidation.blockedLessons || 0} ready/blocked · notes ${highRiskRealReviewerOverlayInputValidation.readyReviewerNotes || 0}/${highRiskRealReviewerOverlayInputValidation.blockedReviewerNotes || 0} · direct ${highRiskRealReviewerOverlayInputValidation.readyDirectSourceDecisions || 0}/${highRiskRealReviewerOverlayInputValidation.blockedDirectSourceDecisions || 0}</span>
          <small>${escapeHtml(highRiskRealReviewerOverlayInputValidation.validationStatus || "blocked_missing_real_reviewer_overlay_input")} · missing ${highRiskRealReviewerOverlayInputValidation.missingFieldRows || 0} · forbidden ${highRiskRealReviewerOverlayInputValidation.forbiddenHitRows || 0} · real human ${highRiskRealReviewerOverlayInputValidation.realHumanInputEntries || 0} · write allowed:${highRiskRealReviewerOverlayInputValidation.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${highRiskReviewCockpit ? `
        <article>
          <strong>high-risk review cockpit</strong>
          <span>${highRiskReviewCockpit.lessonCount || 0} lessons / modules ${highRiskReviewCockpit.modules || 0} / real notes ${highRiskReviewCockpit.readyReviewerNotes || 0}/${highRiskReviewCockpit.expectedReviewerNotes || 0} / direct ${highRiskReviewCockpit.readyDirectSourceDecisions || 0}/${highRiskReviewCockpit.directSourceDecisionCount || 0}</span>
          <small>${escapeHtml(highRiskReviewCockpit.cockpitStatus || "high_risk_review_cockpit_ready_blocked_on_real_input")} · public grounded ${highRiskReviewCockpit.lessonsWithPublicGrounding || 0}/${highRiskReviewCockpit.lessonCount || 0} · human ${highRiskReviewCockpit.realHumanInputEntries || 0} · write allowed:${highRiskReviewCockpit.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${highRiskPublicGroundingMatrix ? `
        <article>
          <strong>high-risk public grounding matrix</strong>
          <span>${highRiskPublicGroundingMatrix.lessonsWithPublicGrounding || 0}/${highRiskPublicGroundingMatrix.lessonCount || 0} lessons grounded / wiki refs ${highRiskPublicGroundingMatrix.totalWikipediaRefs || 0} / public refs ${highRiskPublicGroundingMatrix.totalPublicContextRefs || 0}</span>
          <small>${escapeHtml(highRiskPublicGroundingMatrix.matrixStatus || "high_risk_public_grounding_mapped_not_approved")} · release-ready ${highRiskPublicGroundingMatrix.releaseReadyLessons || 0} · write allowed:${highRiskPublicGroundingMatrix.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${sourceReplacementDecisions ? `
        <article>
          <strong>source replacement decisions</strong>
          <span>${sourceReplacementDecisions.replacementTargets || 0} targets / ${sourceReplacementDecisions.targetsWithDirectReplacementCandidates || 0} direct / ${sourceReplacementDecisions.notStartedDecisions || 0} not started</span>
          <small>${escapeHtml(sourceReplacementDecisions.worksheetStatus || "source_replacement_decision_not_started")} · ${sourceReplacementDecisions.approvedReplacements || 0} approved · ${sourceReplacementDecisions.totalCandidateRows || 0} candidate rows</small>
        </article>
      ` : ""}
      ${sourceQuality ? `
        <article>
          <strong>source quality audit</strong>
          <span>${sourceQuality.importedUniquePdfFiles || 0}/${sourceQuality.uniquePdfFiles || 0} unique PDFs imported / ${sourceQuality.missingUniquePdfFiles || 0} missing</span>
          <small>${sourceQuality.lowExtractionDocs || 0} low extraction · ${sourceQuality.forbiddenLanguageDocs || 0} risky-language docs · ${escapeHtml(sourceQuality.absorptionStatus || "quality_flags_pending")}</small>
        </article>
      ` : ""}
      ${sourceSyncAudit ? `
        <article>
          <strong>source folder sync audit</strong>
          <span>${sourceSyncAudit.currentPdfFiles || 0} PDFs / ${sourceSyncAudit.currentUniquePdfHashes || 0} unique / duplicates ${sourceSyncAudit.currentDuplicatePdfFiles || 0}</span>
          <small>${escapeHtml(sourceSyncAudit.syncStatus || "source_folder_sync_attention_required")} · corpus ${sourceSyncAudit.corpusDocsForCurrentUniqueHashes || 0}/${sourceSyncAudit.currentUniquePdfHashes || 0} · missing ${sourceSyncAudit.missingCurrentUniqueHashesFromCorpus || 0} · write allowed:${sourceSyncAudit.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${publicSourceGap ? `
        <article>
          <strong>public source gap</strong>
          <span>${publicSourceGap.publicReferenceReadyModules || 0}/${publicSourceGap.modules || 0} modules ready / ${publicSourceGap.wikipediaDocuments || 0} Wikipedia docs</span>
          <small>${publicSourceGap.publicCorpusDocuments || 0} public docs · ${publicSourceGap.modulesWithWikipediaEvidence || 0} modules with Wikipedia · ${publicSourceGap.officialLikeDocuments || 0} official-like docs</small>
        </article>
      ` : ""}
      ${wikipediaGroundingAudit ? `
        <article>
          <strong>Wikipedia grounding audit</strong>
          <span>${wikipediaGroundingAudit.wikipediaDocuments || 0} docs / modules ${wikipediaGroundingAudit.modulesWithWikipediaGrounding || 0}/${wikipediaGroundingAudit.modules || 0} / high-risk ${wikipediaGroundingAudit.highRiskLessonsWithAtLeastThreeWikipediaRefs || 0}</span>
          <small>${escapeHtml(wikipediaGroundingAudit.auditStatus || "wikipedia_grounding_ready_for_reviewer_not_release")} · learner citations ${wikipediaGroundingAudit.learnerCitationApprovedModules || 0} · high-risk refs ${wikipediaGroundingAudit.highRiskWikipediaRefCount || 0} · write allowed:${wikipediaGroundingAudit.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${lowExtractionVisualReview ? `
        <article>
          <strong>low-extraction visual review</strong>
          <span>${lowExtractionVisualReview.lowExtractionDocs || 0} docs / ${lowExtractionVisualReview.previewPages || 0}/${lowExtractionVisualReview.totalPages || 0} preview pages / ${escapeHtml(lowExtractionVisualReview.approvalStatus || "not_approved")}</span>
          <small>${escapeHtml(lowExtractionVisualReview.packetStatus || "visual_review_packet_ready")} · ${escapeHtml(lowExtractionVisualReview.cards?.[0]?.sourceRelativePath || "preview packet ready")}</small>
        </article>
      ` : ""}
      ${lowExtractionHighResReview ? `
        <article>
          <strong>high-res visual review</strong>
          <span>${lowExtractionHighResReview.highResPreviewPages || 0} pages / manual ${lowExtractionHighResReview.manualTranscriptionHighResPages || 0} / replacement ${lowExtractionHighResReview.sourceReplacementHighResPages || 0}</span>
          <small>${escapeHtml(lowExtractionHighResReview.packetStatus || "high_res_visual_review_packet_ready")} · scale ${lowExtractionHighResReview.screenshotScale || 0} · ${escapeHtml(lowExtractionHighResReview.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${highResTranscriptionCandidates ? `
        <article>
          <strong>machine-assisted transcription candidates</strong>
          <span>${highResTranscriptionCandidates.candidatePages || 0} pages / ${highResTranscriptionCandidates.acceptedForP0OverlayPages || 0} accepted / ${highResTranscriptionCandidates.blockedUntilHumanReviewedPages || 0} blocked</span>
          <small>${escapeHtml(highResTranscriptionCandidates.indexStatus || highResTranscriptionCandidates.batchStatus || "machine_assisted_candidate_index_ready_for_human_review")} · batches ${highResTranscriptionCandidates.batchCount || 1} · ${escapeHtml(highResTranscriptionCandidates.documentId || "corpus_1313")} · ${escapeHtml(highResTranscriptionCandidates.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${p0CandidateReviewAssistMap ? `
        <article>
          <strong>P0 candidate review assist map</strong>
          <span>${p0CandidateReviewAssistMap.manualTasksWithCandidate || 0}/${p0CandidateReviewAssistMap.manualTranscriptionTasks || 0} manual tasks mapped / ${p0CandidateReviewAssistMap.manualTasksMissingCandidate || 0} missing / ${p0CandidateReviewAssistMap.acceptedForP0OverlayTasks || 0} accepted</span>
          <small>${escapeHtml(p0CandidateReviewAssistMap.assistMapStatus || "review_assist_map_ready_not_applied")} · replacement ${p0CandidateReviewAssistMap.sourceReplacementTasks || 0} · blocked ${p0CandidateReviewAssistMap.blockedUntilHumanReviewedTasks || 0}</small>
        </article>
      ` : ""}
      ${p0ReviewInputDryRunSample ? `
        <article>
          <strong>P0 review input dry-run sample</strong>
          <span>${p0ReviewInputDryRunSample.validationReadyEntries || 0} ready / ${p0ReviewInputDryRunSample.validationBlockedEntries || 0} blocked / ${p0ReviewInputDryRunSample.writtenEntries || 0} written</span>
          <small>${escapeHtml(p0ReviewInputDryRunSample.templateStatus || "candidate_review_dry_run_fixture")} · fixtureOnly:${p0ReviewInputDryRunSample.fixtureOnly === true} · apply ${escapeHtml(p0ReviewInputDryRunSample.applyStatus || "ready_entries_not_written")}</small>
        </article>
      ` : ""}
      ${p0HumanReviewNoteTemplate ? `
        <article>
          <strong>P0 human review note template</strong>
          <span>${p0HumanReviewNoteTemplate.manualCardsWithCandidate || 0}/${p0HumanReviewNoteTemplate.manualReviewCards || 0} manual cards with candidates / ${p0HumanReviewNoteTemplate.sourceReplacementReviewCards || 0} replacement cards</span>
          <small>${escapeHtml(p0HumanReviewNoteTemplate.templateStatus || "blank_human_review_note_template_ready")} · filled ${p0HumanReviewNoteTemplate.filledNoteCards || 0} · accepted ${p0HumanReviewNoteTemplate.acceptedForOverlayCards || 0}</small>
        </article>
      ` : ""}
      ${p0HumanFillPack01 ? `
        <article>
          <strong>P0 human fill pack 01</strong>
          <span>${p0HumanFillPack01.totalPackCards || 0} cards / filled ${p0HumanFillPack01.filledCards || 0} / accepted ${p0HumanFillPack01.acceptedForOverlayCards || 0}</span>
          <small>${escapeHtml(p0HumanFillPack01.packStatus || "blank_human_fill_pack_ready")} · pages ${(p0HumanFillPack01.targetPageNumbers || []).join(", ")} · ${escapeHtml(p0HumanFillPack01.targetDocumentIds?.[0] || "")}</small>
        </article>
      ` : ""}
      ${p0HumanFillPack01InputCopy ? `
        <article>
          <strong>P0 fill pack 01 input copy</strong>
          <span>${p0HumanFillPack01InputCopy.totalEntries || 0} entries / ready ${p0HumanFillPack01InputCopy.validationReadyEntries || 0} / blocked ${p0HumanFillPack01InputCopy.validationBlockedEntries || 0}</span>
          <small>${escapeHtml(p0HumanFillPack01InputCopy.templateStatus || "pack_01_input_copy_blank")} · forbidden ${p0HumanFillPack01InputCopy.forbiddenHitEntries || 0} · fixtureOnly:${p0HumanFillPack01InputCopy.fixtureOnly === true}</small>
        </article>
      ` : ""}
      ${p0HumanReviewBundle ? `
        <article>
          <strong>P0 human review bundle</strong>
          <span>${p0HumanReviewBundle.totalReviewEntries || 0} entries / manual ${p0HumanReviewBundle.manualTranscriptionEntries || 0} / replacement ${p0HumanReviewBundle.sourceReplacementEntries || 0}</span>
          <small>${escapeHtml(p0HumanReviewBundle.bundleStatus || "p0_human_review_bundle_ready_not_applied")} · blocked ${p0HumanReviewBundle.validationBlockedEntries || 0} · real human ${p0HumanReviewBundle.realHumanInputEntries || 0} · write allowed:${p0HumanReviewBundle.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0HumanReviewBundleInputCopy ? `
        <article>
          <strong>P0 unified input copy</strong>
          <span>${p0HumanReviewBundleInputCopy.totalEntries || 0} entries / ready ${p0HumanReviewBundleInputCopy.validationReadyEntries || 0} / blocked ${p0HumanReviewBundleInputCopy.validationBlockedEntries || 0}</span>
          <small>${escapeHtml(p0HumanReviewBundleInputCopy.templateStatus || "p0_human_review_bundle_input_copy_blank")} · ${escapeHtml(p0HumanReviewBundleInputCopy.validationStatus || "blocked_missing_reviewer_input")} · filled ${p0HumanReviewBundleInputCopy.filledEntries || 0}</small>
        </article>
      ` : ""}
      ${p0HumanReviewBundlePositiveFixture ? `
        <article>
          <strong>P0 positive fixture control</strong>
          <span>${p0HumanReviewBundlePositiveFixture.totalEntries || 0} entries / ready ${p0HumanReviewBundlePositiveFixture.validationReadyEntries || 0} / blocked ${p0HumanReviewBundlePositiveFixture.validationBlockedEntries || 0}</span>
          <small>${escapeHtml(p0HumanReviewBundlePositiveFixture.templateStatus || "p0_human_review_bundle_positive_fixture_ready")} · fixtureOnly:${p0HumanReviewBundlePositiveFixture.fixtureOnly === true} · ${escapeHtml(p0HumanReviewBundlePositiveFixture.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${p0HumanReviewRealReviewerHandoff ? `
        <article>
          <strong>P0 real reviewer handoff</strong>
          <span>${p0HumanReviewRealReviewerHandoff.totalReviewEntries || 0} entries / real human ${p0HumanReviewRealReviewerHandoff.realHumanInputEntries || 0} / blank blocked ${p0HumanReviewRealReviewerHandoff.blankInputBlockedEntries || 0}</span>
          <small>${escapeHtml(p0HumanReviewRealReviewerHandoff.handoffStatus || "p0_real_reviewer_handoff_ready_write_blocked")} · fixtureOnly:${p0HumanReviewRealReviewerHandoff.positiveFixtureOnly === true} · write allowed:${p0HumanReviewRealReviewerHandoff.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerInputStarter ? `
        <article>
          <strong>P0 real reviewer input starter</strong>
          <span>${p0RealReviewerInputStarter.totalEntries || 0} entries / ready ${p0RealReviewerInputStarter.validationReadyEntries || 0} / blocked ${p0RealReviewerInputStarter.validationBlockedEntries || 0}</span>
          <small>${escapeHtml(p0RealReviewerInputStarter.starterStatus || "real_reviewer_input_starter_ready_waiting_for_human_fill")} · real human ${p0RealReviewerInputStarter.realHumanInputEntries || 0} · write allowed:${p0RealReviewerInputStarter.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerTaskBoard ? `
        <article>
          <strong>P0 real reviewer task board</strong>
          <span>${p0RealReviewerTaskBoard.totalTasks || 0} tasks / manual ${p0RealReviewerTaskBoard.manualTranscriptionTasks || 0} / replacement ${p0RealReviewerTaskBoard.sourceReplacementTasks || 0}</span>
          <small>${escapeHtml(p0RealReviewerTaskBoard.boardStatus || "p0_real_reviewer_task_board_ready_all_tasks_blocked")} · blocked ${p0RealReviewerTaskBoard.blockedTasks || 0} · missing identity ${p0RealReviewerTaskBoard.rowsMissingReviewerIdentity || 0}</small>
        </article>
      ` : ""}
      ${p0RealReviewerEvidencePacket ? `
        <article>
          <strong>P0 real reviewer evidence packet</strong>
          <span>${p0RealReviewerEvidencePacket.totalTasks || 0} tasks / refs ${p0RealReviewerEvidencePacket.totalSuggestedRefs || 0} / learner citation ${p0RealReviewerEvidencePacket.learnerCitationApprovedTasks || 0}</span>
          <small>${escapeHtml(p0RealReviewerEvidencePacket.packetStatus || "p0_real_reviewer_evidence_packet_ready_not_reviewed")} · wiki ${p0RealReviewerEvidencePacket.tasksWithWikipediaRefs || 0} · public context ${p0RealReviewerEvidencePacket.tasksWithPublicContextRefs || 0} · write allowed:${p0RealReviewerEvidencePacket.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerSourceFitWorksheet ? `
        <article>
          <strong>P0 source-fit worksheet</strong>
          <span>${p0RealReviewerSourceFitWorksheet.totalCards || 0} cards / blank fields ${p0RealReviewerSourceFitWorksheet.totalBlankFields || 0} / refs ${p0RealReviewerSourceFitWorksheet.cardsWithSuggestedRefs || 0}</span>
          <small>${escapeHtml(p0RealReviewerSourceFitWorksheet.worksheetStatus || "p0_real_reviewer_source_fit_worksheet_ready_blank")} · filled ${p0RealReviewerSourceFitWorksheet.reviewerFilledCards || 0} · decisions ${p0RealReviewerSourceFitWorksheet.generatedDecisions || 0} · write allowed:${p0RealReviewerSourceFitWorksheet.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerSourceFitInputGuide ? `
        <article>
          <strong>P0 source-fit input guide</strong>
          <span>${p0RealReviewerSourceFitInputGuide.totalGuideRows || 0} rows / source-fit paths ${p0RealReviewerSourceFitInputGuide.rowsWithSourceFitFieldPath || 0} / public-ref paths ${p0RealReviewerSourceFitInputGuide.rowsWithPublicReferenceNotesFieldPath || 0}</span>
          <small>${escapeHtml(p0RealReviewerSourceFitInputGuide.guideStatus || "p0_real_reviewer_source_fit_input_guide_ready_blank")} · draft ${escapeHtml(p0RealReviewerSourceFitInputGuide.sourceDraftInput || "")} · filled ${p0RealReviewerSourceFitInputGuide.reviewerFilledRows || 0} · write allowed:${p0RealReviewerSourceFitInputGuide.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerSourceFitInputValidation ? `
        <article>
          <strong>P0 source-fit input validation</strong>
          <span>${p0RealReviewerSourceFitInputValidation.totalRows || 0} rows / ready ${p0RealReviewerSourceFitInputValidation.readyRows || 0} / blocked ${p0RealReviewerSourceFitInputValidation.blockedRows || 0}</span>
          <small>${escapeHtml(p0RealReviewerSourceFitInputValidation.validationStatus || "blocked_missing_reviewer_input")} · missing ${p0RealReviewerSourceFitInputValidation.missingFieldRows || 0} · fixture ready ${p0RealReviewerSourceFitInputValidation.fixtureReadyRows || 0} · forbidden ${p0RealReviewerSourceFitInputValidation.forbiddenHitRows || 0} · write allowed:${p0RealReviewerSourceFitInputValidation.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0RealReviewerSourceFitHandoff ? `
        <article>
          <strong>P0 source-fit handoff</strong>
          <span>${(p0RealReviewerSourceFitHandoff.phaseRows || []).length} phases / real ${p0RealReviewerSourceFitHandoff.sourceFitRealReadyRows || 0}/${p0RealReviewerSourceFitHandoff.sourceFitRealBlockedRows || 0} / fixture ${p0RealReviewerSourceFitHandoff.sourceFitFixtureReadyRows || 0}</span>
          <small>${escapeHtml(p0RealReviewerSourceFitHandoff.handoffStatus || "p0_real_reviewer_source_fit_handoff_ready_blocked_on_real_input")} · hard stops ${(p0RealReviewerSourceFitHandoff.hardStops || []).length} · manual required:${p0RealReviewerSourceFitHandoff.manualAuthorizationRequired === true} · write allowed:${p0RealReviewerSourceFitHandoff.writeAllowedNow === true}</small>
        </article>
      ` : ""}
      ${p0ReviewOperatorIndex ? `
        <article>
          <strong>P0 packet coverage table</strong>
          <span>${(p0ReviewOperatorIndex.packRows || []).map((row) => `${escapeHtml(row.packNumber)}:${row.totalEntries || 0}`).join(" · ")}</span>
          <small>${(p0ReviewOperatorIndex.packRows || []).map((row) => `${escapeHtml(row.packNumber)} ${row.validationReadyEntries || 0}/${row.validationBlockedEntries || 0}`).join(" · ")} · dry-run ready ${p0ReviewOperatorIndex.positiveFixtureReadyToApplyEntries || 0}</small>
        </article>
      ` : ""}
      ${lowExtractionTranscriptionOverlay ? `
        <article>
          <strong>low-extraction transcription overlay</strong>
          <span>${lowExtractionTranscriptionOverlay.pagesNotStarted || 0}/${lowExtractionTranscriptionOverlay.transcriptionPages || 0} pages not started / ${lowExtractionTranscriptionOverlay.pagesTranscribed || 0} transcribed</span>
          <small>${escapeHtml(lowExtractionTranscriptionOverlay.overlayStatus || "manual_transcription_not_started")} · ${lowExtractionTranscriptionOverlay.publicSourceGroundingNeededPages || 0} pages need public-source grounding</small>
        </article>
      ` : ""}
      ${lowExtractionTranscriptIntake ? `
        <article>
          <strong>low-extraction transcript intake</strong>
          <span>${lowExtractionTranscriptIntake.manualTranscriptionCandidatePages || 0}/${lowExtractionTranscriptIntake.totalPages || 0} pages need transcription / ${lowExtractionTranscriptIntake.blankPreviewPages || 0} blank previews</span>
          <small>${lowExtractionTranscriptIntake.acceptedTranscriptPages || 0} accepted · ${lowExtractionTranscriptIntake.sourceReplacementCandidatePages || 0} source replacement candidates · ${escapeHtml(lowExtractionTranscriptIntake.intakeStatus || "waiting_for_human_transcription")}</small>
        </article>
      ` : ""}
      ${lowExtractionManualTranscriptionPack ? `
        <article>
          <strong>manual transcription pack</strong>
          <span>${lowExtractionManualTranscriptionPack.manualTranscriptionPages || 0} pages / ${lowExtractionManualTranscriptionPack.manualTranscriptionDocuments || 0} docs / ${escapeHtml(lowExtractionManualTranscriptionPack.approvalStatus || "not_approved")}</span>
          <small>${lowExtractionManualTranscriptionPack.acceptedTranscriptPages || 0} accepted · ${escapeHtml(lowExtractionManualTranscriptionPack.packStatus || "manual_transcription_ready")} · ${escapeHtml(lowExtractionManualTranscriptionPack.transcriptionCards?.[0]?.nextGate || "human review required")}</small>
        </article>
      ` : ""}
      ${lowExtractionSourceReplacementPack ? `
        <article>
          <strong>source replacement pack</strong>
          <span>${lowExtractionSourceReplacementPack.replacementCandidates || 0} pages / ${lowExtractionSourceReplacementPack.replacementDocuments || 0} docs / ${escapeHtml(lowExtractionSourceReplacementPack.packStatus || "source_replacement_required")}</span>
          <small>${lowExtractionSourceReplacementPack.blankPreviewPages || 0} blank previews · ${lowExtractionSourceReplacementPack.acceptedTranscriptPages || 0} accepted · ${escapeHtml(lowExtractionSourceReplacementPack.replacementCards?.[0]?.nextGate || "replace source first")}</small>
        </article>
      ` : ""}
      ${rewriteBatches ? `
        <article>
          <strong>all local rewrite batches</strong>
          <span>${rewriteBatches.totalDrafts || 0} drafts / ${(rewriteBatches.batches || []).length} batches / ${escapeHtml(rewriteBatches.approvalStatus || "not_approved")}</span>
          <small>${Object.entries(rewriteBatches.moduleCounts || {}).slice(0, 4).map(([module, count]) => `${escapeHtml(module)} ${count}`).join(" · ")}</small>
        </article>
      ` : ""}
      ${rewriteReview ? `
        <article>
          <strong>originality / source-fit screen</strong>
          <span>${rewriteReview.readyForSeparateReviewCandidates || 0} ready / copy ${rewriteReview.copyRiskIssues || 0} / safety ${rewriteReview.safetyIssues || 0}</span>
          <small>max overlap ${rewriteReview.maxSourceOverlap ?? 0} · ${escapeHtml(rewriteReview.approvalStatus || "not_approved")}</small>
        </article>
      ` : ""}
      ${refinementPacket ? `
        <article>
          <strong>reviewer refinement packet</strong>
          <span>${refinementPacket.candidateCards || 0} candidates / ${refinementPacket.highRiskOverlay?.lessonCount || 0} overlay lessons / ${escapeHtml(refinementPacket.approvalStatus || "not_approved")}</span>
          <small>${refinementPacket.highRiskOverlay?.reviewerNoteCount || 0} notes · ${refinementPacket.directSourceCandidateResolutions?.length || 0} direct-source resolutions · max overlap ${refinementPacket.maxSourceOverlap ?? 0}</small>
        </article>
      ` : ""}
      ${rewriteBatch ? `
        <article>
          <strong>${escapeHtml(rewriteBatch.batchId || "local rewrite batch")}</strong>
          <span>${rewriteBatch.drafts || 0} drafts / ${rewriteBatch.modules || 0} modules / ${escapeHtml(rewriteBatch.approvalStatus || "not_approved")}</span>
          <small>${(rewriteBatch.draftItems || []).slice(0, 2).map((item) => `${escapeHtml(item.module || "")} · ${escapeHtml(item.topic || item.nodeId || "")}`).join(" · ")}</small>
        </article>
      ` : ""}
      ${(moduleRows || []).map((module) => `
        <article>
          <strong>${escapeHtml(module.module || module.moduleId)}</strong>
          <span>${module.localCourseDocuments || 0} docs / ${module.readyForRewriteReview || 0} nodes ready / coverage ${Math.round((module.coverageRate || 0) * 100)}%</span>
          <small>${(module.sampleDocuments || []).slice(0, 2).map((doc) => escapeHtml(doc.sourceRelativePath || doc.name || doc.documentId)).join(" · ")}</small>
        </article>
      `).join("") || "<p>暂无模块覆盖。</p>"}
    </div>
    ${selectedDossierModule ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>module dossier drill-down</strong>
          <span>${escapeHtml(selectedDossierModule.module || "")} · learner-ready:${selectedDossierModule.learnerReleaseReady === true}</span>
        </div>
        <div class="knowledge-local-grid">
          <article>
            <strong>course path</strong>
            <span>${escapeHtml(selectedDossierModule.coursePath?.pathId || "")} · ${selectedDossierModule.coursePath?.lessonCount || 0} lessons · ${selectedDossierModule.coursePath?.unitCount || 0} units</span>
            <small>entry lesson ${escapeHtml(selectedDossierModule.coursePath?.entryLessonId || "")} · estimated ${selectedDossierModule.coursePath?.estimatedMinutes || 0} minutes</small>
            <small>entry nodes ${(selectedDossierModule.entryNodeIds || []).slice(0, 8).map(escapeHtml).join(" · ")}</small>
          </article>
          <article>
            <strong>public evidence samples</strong>
            <span>${selectedDossierModule.publicEvidenceDocs || 0} public docs · ${selectedDossierModule.wikipediaEvidenceDocs || 0} Wikipedia · ${selectedDossierModule.officialLikeEvidenceDocs || 0} official-like</span>
            <small>${(selectedDossierModule.publicEvidenceSamples || []).map((sample) => `${escapeHtml(sample.family || "")}: ${escapeHtml(sample.name || sample.sourceId || "")}`).join(" · ")}</small>
            <small>samples are grounding candidates, not learner-facing citation approval.</small>
          </article>
          <article>
            <strong>review gate</strong>
            <span>${escapeHtml(selectedDossierModule.reviewStatus || "")} · high-risk blockers ${selectedDossierModule.highRiskReleaseBlockers || 0}</span>
            <small>source-fit real ${moduleReviewDossier.p0SourceFitRealReadyRows || 0}/${moduleReviewDossier.p0SourceFitRealBlockedRows || 0} · write allowed:${moduleReviewDossier.writeAllowedNow === true}</small>
            ${(selectedDossierModule.highRiskLessonPreview || []).slice(0, 4).map((lesson) => `
              <small>${escapeHtml(lesson.lessonId || lesson.nodeId || "")} · ${escapeHtml(lesson.topic || "")} · wiki ${lesson.wikipediaRefCount || 0} / public ${lesson.publicContextRefCount || 0} · approved:${lesson.learnerCitationApproved === true}</small>
            `).join("")}
            <small>${escapeHtml(selectedDossierModule.nextReviewerAction || "reviewer action required")}</small>
          </article>
          <article>
            <strong>topics</strong>
            <span>${(selectedDossierModule.topics || []).slice(0, 8).map(escapeHtml).join(" · ")}</span>
            <small>${escapeHtml(selectedDossierModule.boundary || "Reviewer-facing module dossier only.")}</small>
          </article>
        </div>
      </div>
    ` : ""}
    ${reviewGateDashboard ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>review gate drill-down</strong>
          <span>${escapeHtml(selectedReviewGateModule?.module || "all modules")} · release:${reviewGateDashboard.learnerFacingRelease === true}</span>
        </div>
        <div class="knowledge-local-grid">
          <article>
            <strong>global gates</strong>
            <span>${reviewGateDashboard.rewriteReadyNodes || 0}/${reviewGateDashboard.matchedKnowledgeNodes || 0} rewrite-ready · ${reviewGateDashboard.modulesWithWikipediaGrounding || 0}/${reviewGateDashboard.modules || 0} Wikipedia-grounded</span>
            <small>Codex self-review ${reviewGateDashboard.codexSelfReviewNotes || 0}/${reviewGateDashboard.expectedSelfReviewNotes || 0} · real notes ${reviewGateDashboard.highRiskRealReviewerNotesReady || 0}/${reviewGateDashboard.highRiskRealReviewerNotesBlocked || 0} · direct ${reviewGateDashboard.highRiskDirectSourceDecisionsReady || 0}/${reviewGateDashboard.highRiskDirectSourceDecisionsBlocked || 0} · node source-fit ${reviewGateDashboard.nodePublicSourceFitReadyRows || 0}/${reviewGateDashboard.nodePublicSourceFitBlockedRows || 0} · packets ${reviewGateDashboard.nodePublicSourceFitReadyPackets || 0}/${reviewGateDashboard.nodePublicSourceFitBlockedPackets || 0} · real human ${reviewGateDashboard.realHumanInputEntries || 0}</small>
            <small>first blocked packet ${escapeHtml(reviewGateDashboard.nodePublicSourceFitFirstBlockedPacketId || "")} · progress ${reviewGateDashboard.nodePublicSourceFitOverallProgressPercent || 0}%</small>
            <small>write allowed:${reviewGateDashboard.writeAllowedNow === true} · manual required:${reviewGateDashboard.manualAuthorizationRequired === true}</small>
          </article>
          ${selectedReviewGateModule ? `
            <article>
              <strong>selected module gate</strong>
              <span>${escapeHtml(selectedReviewGateModule.coursePathId || "")} · local ${selectedReviewGateModule.readyForRewriteReview || 0}/${selectedReviewGateModule.learnerFacingNodes || 0} · public:${selectedReviewGateModule.publicReferenceReady === true} · wiki:${selectedReviewGateModule.wikipediaGroundingReady === true}</span>
              <small>high-risk blockers ${selectedReviewGateModule.highRiskReleaseBlockers || 0} · P0 ${selectedReviewGateModule.p0ReadyTasks || 0}/${selectedReviewGateModule.p0BlockedTasks || 0} · learner-ready:${selectedReviewGateModule.learnerReleaseReady === true}</small>
              <small>next: ${escapeHtml(selectedReviewGateModule.nextGate || "review gate")}</small>
            </article>
          ` : ""}
          <article>
            <strong>blocked next actions</strong>
            <span>${(reviewGateDashboard.nextActionRows || []).filter((row) => /^blocked/.test(row.status || "")).length}/${(reviewGateDashboard.nextActionRows || []).length} blocked</span>
            ${(reviewGateDashboard.nextActionRows || []).slice(0, 5).map((row) => `
              <small>${row.order || ""}. ${escapeHtml(row.id || "")} · ${escapeHtml(row.owner || "")} · ${escapeHtml(row.status || "")}</small>
            `).join("")}
          </article>
          <article>
            <strong>summary gate evidence</strong>
            ${(reviewGateDashboard.summaryGates || []).slice(0, 6).map((gate) => `
              <small>${escapeHtml(gate.id || "")}: ${escapeHtml(gate.evidence || "")}</small>
            `).join("")}
          </article>
        </div>
      </div>
    ...
    ${knowledgeNodePublicSourceFitReviewExecutionQueue ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>node source-fit review queue</strong>
          <span>${knowledgeNodePublicSourceFitReviewExecutionQueue.totalBatches || 0} batches · ${knowledgeNodePublicSourceFitReviewExecutionQueue.reviewRows || 0} rows · release:${knowledgeNodePublicSourceFitReviewExecutionQueue.learnerFacingRelease === true}</span>
        </div>
        <div class="knowledge-local-grid">
          <article>
            <strong>queue lock</strong>
            <span>ready ${knowledgeNodePublicSourceFitReviewExecutionQueue.readyRows || 0}/${knowledgeNodePublicSourceFitReviewExecutionQueue.blockedRows || 0} · batches ${knowledgeNodePublicSourceFitReviewExecutionQueue.readyBatches || 0}/${knowledgeNodePublicSourceFitReviewExecutionQueue.blockedBatches || 0}</span>
            <small>${escapeHtml(knowledgeNodePublicSourceFitReviewExecutionQueue.validationStatus || "blocked_missing_real_reviewer_source_fit_input")} · missing ${knowledgeNodePublicSourceFitReviewExecutionQueue.missingFieldRows || 0} · real human ${knowledgeNodePublicSourceFitReviewExecutionQueue.realHumanInputEntries || 0} · learner citations ${knowledgeNodePublicSourceFitReviewExecutionQueue.learnerCitationApprovedRows || 0}</small>
            <small>write allowed:${knowledgeNodePublicSourceFitReviewExecutionQueue.writeAllowedNow === true} · manual required:${knowledgeNodePublicSourceFitReviewExecutionQueue.manualAuthorizationRequired === true}</small>
          </article>
          <article>
            <strong>first priority batches</strong>
            ${(knowledgeNodePublicSourceFitReviewExecutionQueue.firstPriorityBatches || []).slice(0, 6).map((batch) => `
              <small>${escapeHtml(batch.batchId || "")}: ${escapeHtml(batch.module || "")} · rows ${batch.reviewRows || 0} · nodes ${batch.targetNodes || 0} · ${escapeHtml(batch.status || "")}</small>
            `).join("")}
          </article>
          ${knowledgeNodePublicSourceFitReviewBatchPackets ? `
            <article>
              <strong>fillable packets</strong>
              ${(knowledgeNodePublicSourceFitReviewBatchPackets.firstPriorityPackets || []).slice(0, 6).map((packet) => `
                <button type="button" class="${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.packetId === packet.packetId ? "is-active" : ""}" data-source-fit-packet="${escapeHtml(packet.packetId || "")}">
                  ${escapeHtml(packet.packetId || "")}
                </button>
                <small>${escapeHtml(packet.module || "")} · rows ${packet.reviewRows || 0} · input ${escapeHtml(packet.inputPath || "")}</small>
              `).join("")}
            </article>
            <article>
              <strong>selected packet rows</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.packetId || "")} · ${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.displayedRows || 0}/${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.reviewRows || 0} shown</span>
              ${(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacket?.packetRows || []).slice(0, 6).map((row) => `
                <small>${row.inputRowIndex ?? ""}. ${escapeHtml(row.reviewId || "")} · ${escapeHtml(row.name || "")} · decision ${escapeHtml(row.fillableFields?.reviewerDecision || "")}</small>
              `).join("")}
            </article>
            <article>
              <strong>selected packet workbench</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.workbenchStatus || "selected_packet_review_workbench_ready_release_blocked")} · nodes ${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.targetNodes || 0} · rows ${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.displayedRows || 0}/${knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.reviewRows || 0}</span>
              <small>input ${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.inputPath || "")}</small>
              ${(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.fillableFieldPointers || []).slice(0, 4).map((row) => `
                <small>${row.inputRowIndex ?? ""}. ${escapeHtml(row.reviewId || "")} · decision ${escapeHtml(row.reviewerDecision || "")} · notes ${escapeHtml(row.sourceFitNotes || "")}</small>
              `).join("")}
            </article>
            <article>
              <strong>packet evidence preview</strong>
              ${(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.rowEvidencePreview || []).slice(0, 4).map((row) => `
                <small>${row.inputRowIndex ?? ""}. ${escapeHtml(row.sourceName || "")} · ${escapeHtml(row.family || "")} · score ${row.fitScore ?? ""}</small>
              `).join("")}
              <small>next: ${escapeHtml(knowledgeNodePublicSourceFitReviewBatchPackets.selectedPacketWorkbench?.nextGate || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate ? `
            <article>
              <strong>packet input copy</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationStatus || "blocked_missing_real_reviewer_source_fit_input")} · ${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationReadyRows || 0}/${knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validationInputRows || 0} ready</span>
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.inputCopyPath || "")}</small>
              ${(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.fillableFieldRows || []).slice(0, 4).map((row) => `
                <small>${row.order || ""}. ${escapeHtml(row.reviewId || "")} · decision ${escapeHtml(row.reviewerDecision || "")} · notes ${escapeHtml(row.sourceFitNotes || "")}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.commands?.[1] || knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.validatorCommand || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewPacketMergePreview ? `
            <article>
              <strong>packet merge preview</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergePreview.mergePreviewStatus || "packet_merge_preview_blocked_missing_ready_packet_input")} · mapped ${knowledgeNodePublicSourceFitReviewPacketMergePreview.mappedRows || 0}/${knowledgeNodePublicSourceFitReviewPacketMergePreview.packetRows || 0}</span>
              ${(knowledgeNodePublicSourceFitReviewPacketMergePreview.sampleMergeRows || []).slice(0, 4).map((row) => `
                <small>${escapeHtml(row.reviewId || "")}: ${row.packetRowIndex ?? ""} -> ${row.targetFullDraftRowIndex ?? ""} · ${escapeHtml(row.mergeBlockedReason || "ready")}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergePreview.commands?.[1] || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport ? `
            <article>
              <strong>packet merge apply dry-run</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.applyStatus || "blocked_no_ready_merge_rows")} · written ${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.writtenRows || 0}/${knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.totalRows || 0}</span>
              ${(knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.applyRows || []).slice(0, 4).map((row) => `
                <small>${escapeHtml(row.reviewId || "")}: ${escapeHtml(row.applyStatus || "")} · will write ${row.willWrite === true}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.nextStep || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewPacket001Handoff ? `
            <article>
              <strong>packet 001 handoff</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitReviewPacket001Handoff.handoffStatus || "node_public_source_fit_packet_001_handoff_ready_blocked_on_real_input")} · hard stops ${(knowledgeNodePublicSourceFitReviewPacket001Handoff.hardStops || []).length}</span>
              ${(knowledgeNodePublicSourceFitReviewPacket001Handoff.phaseRows || []).slice(0, 4).map((row) => `
                <small>${row.order || ""}. ${escapeHtml(row.id || "")} · ${escapeHtml(row.status || "")}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacket001Handoff.commands?.[0] || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex ? `
            <article>
              <strong>packet handoff index</strong>
              <span>${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.packetsWithHandoff || 0}/${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.totalPackets || 0} generated · templates ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.packetsWithInputCopyTemplate || 0}/${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.totalPackets || 0} · missing ${knowledgeNodePublicSourceFitReviewPacketHandoffIndex.packetsWithoutHandoff || 0}</span>
              ${(knowledgeNodePublicSourceFitReviewPacketHandoffIndex.firstPriorityRows || []).slice(0, 5).map((row) => `
                <small>${row.order || ""}. ${escapeHtml(row.packetId || "")} · template ${escapeHtml(row.inputCopyTemplateStatus || "")} · handoff ${escapeHtml(row.handoffStatus || "")} · ${escapeHtml(row.nextAction || "")}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitReviewPacketHandoffIndex.commands?.[0] || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitRealReviewerLaunchDashboard ? `
            <article>
              <strong>real reviewer launch</strong>
              <span>${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.launchMode || "first_packet_real_reviewer_execution_start")} · packet ${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.startPacket?.packetId || "")}</span>
              ${(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.dayOneChecklist || []).slice(0, 4).map((item, index) => `
                <small>${index + 1}. ${escapeHtml(item || "")}</small>
              `).join("")}
              <small>${escapeHtml(knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.commands?.[0] || "")}</small>
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench ? `
            <article>
              <strong>packet 001 row browser</strong>
              <span>${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.nodeCount || 0} nodes · ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.reviewRows || 0} source rows · mapped ${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.mergeMappedRows || 0}/${knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.reviewRows || 0}</span>
              ${(knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.nodeRows || []).slice(0, 4).map((row) => `
                <small>${escapeHtml(row.nodeId || "")}: candidates ${row.candidateRows || 0} · ready ${row.readyRows || 0} · blocked ${row.blockedRows || 0} · topFit ${row.topFitScore || 0}</small>
              `).join("")}
              ${(knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.rows || []).slice(0, 6).map((row) => `
                <small>${row.rowIndex + 1}. ${escapeHtml(row.sourceName || "")} · ${escapeHtml(row.family || "")} · ${escapeHtml(row.validationStatus || "")}</small>
              `).join("")}
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex ? `
            <article>
              <strong>all-packet workbench index</strong>
              <span>${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.totalPackets || 0} packets · ${knowledgeNodePublicSourceFitReviewerWorkbenchIndex.totalReviewRows || 0} rows · first ${escapeHtml(knowledgeNodePublicSourceFitReviewerWorkbenchIndex.firstBlockedPacketId || "")}</span>
              ${(knowledgeNodePublicSourceFitReviewerWorkbenchIndex.moduleRows || []).slice(0, 5).map((row) => `
                <small>${escapeHtml(row.module || "")}: packets ${row.packets || 0} · rows ${row.readyRows || 0}/${row.reviewRows || 0} · blocked ${row.blockedRows || 0}</small>
              `).join("")}
              ${(knowledgeNodePublicSourceFitReviewerWorkbenchIndex.packetRows || []).slice(0, 6).map((row) => `
                <small>${escapeHtml(row.packetNumber || "")}. ${escapeHtml(row.packetId || "")} · rows ${row.readyRows || 0}/${row.reviewRows || 0} · ${escapeHtml(row.nextAction || "")}</small>
              `).join("")}
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewerRowBrowser ? `
            <article>
              <strong>all-row source browser</strong>
              <span>${knowledgeNodePublicSourceFitReviewerRowBrowser.totalReviewRows || 0} node/source rows · ${knowledgeNodePublicSourceFitReviewerRowBrowser.rowsWithUrl || 0} URLs · human ${knowledgeNodePublicSourceFitReviewerRowBrowser.realHumanInputEntries || 0}</span>
              ${(knowledgeNodePublicSourceFitReviewerRowBrowser.familyRows || []).slice(0, 5).map((row) => `
                <small>${escapeHtml(row.family || "")}: rows ${row.rows || 0} · ready ${row.readyRows || 0} · blocked ${row.blockedRows || 0}</small>
              `).join("")}
              ${selectedReviewerRowDetail ? `
                <div class="knowledge-row-detail">
                  <div>
                    <strong>${escapeHtml(selectedReviewerRowDetail.row?.reviewId || selectedReviewerRowDetail.reviewId || "")}</strong>
                    <span>P${escapeHtml(selectedReviewerRowDetail.row?.packetNumber || "")} · ${escapeHtml(selectedReviewerRowDetail.row?.nodeId || "")} · ${escapeHtml(selectedReviewerRowDetail.row?.title || "")}</span>
                    <a href="${escapeHtml(selectedReviewerRowDetail.row?.url || "#")}" target="_blank" rel="noreferrer">${escapeHtml(selectedReviewerRowDetail.row?.sourceName || "")}</a>
                    <small>${escapeHtml(selectedReviewerRowDetail.detailStatus || "")} · write allowed:${selectedReviewerRowDetail.writeAllowedNow === true}</small>
                  </div>
                  <div class="knowledge-row-detail-grid">
                    <div>
                      <strong>missing fields</strong>
                      ${(selectedReviewerRowDetail.missingFields || []).map((field) => `
                        <small>${escapeHtml(field || "")}</small>
                      `).join("")}
                    </div>
                    <div>
                      <strong>editable paths</strong>
                      ${Object.entries(selectedReviewerRowDetail.editableFieldPaths || {}).map(([field, path]) => `
                        <small>${escapeHtml(field)}: ${escapeHtml(path || "")}</small>
                      `).join("")}
                    </div>
                  </div>
                  <div class="knowledge-row-detail-grid">
                    <div>
                      <strong>same node sources</strong>
                      ${(selectedReviewerRowDetail.sameNodeRows || []).slice(0, 6).map((row) => `
                        <small>${escapeHtml(row.family || "")} · ${escapeHtml(row.documentId || "")} · ${escapeHtml(row.sourceName || "")}</small>
                      `).join("")}
                    </div>
                    <div>
                      <strong>nearby packet rows</strong>
                      ${(selectedReviewerRowDetail.nearbyPacketRows || []).slice(0, 6).map((row) => `
                        <small>${row.globalRowIndex + 1}. ${escapeHtml(row.nodeId || "")} · ${escapeHtml(row.family || "")} · ${escapeHtml(row.validationStatus || "")}</small>
                      `).join("")}
                    </div>
                  </div>
                  <small>${escapeHtml(selectedReviewerRowDetail.completionRule || "")}</small>
                </div>
              ` : ""}
              ${(knowledgeNodePublicSourceFitReviewerRowBrowser.rows || []).slice(0, 8).map((row) => `
                <div class="knowledge-row-source">
                  <strong>${row.globalRowIndex + 1}. P${escapeHtml(row.packetNumber || "")} · ${escapeHtml(row.nodeId || "")}</strong>
                  <a href="${escapeHtml(row.url || "#")}" target="_blank" rel="noreferrer">${escapeHtml(row.sourceName || "")}</a>
                  <small>${escapeHtml(row.family || "")} · ${escapeHtml(row.documentId || "")} · ${escapeHtml(row.validationStatus || "")}</small>
                  <small>missing ${(row.missingFields || []).map(escapeHtml).join(", ")} · reviewerDecision ${escapeHtml(row.editableFieldPaths?.reviewerDecision || "")}</small>
                  <button type="button" data-reviewer-row-detail="${escapeHtml(row.reviewId || "")}">details</button>
                </div>
              `).join("")}
            </article>
          ` : ""}
          ${knowledgeNodePublicSourceFitReviewProgressMatrix ? `
            <article>
              <strong>progress matrix</strong>
              <span>${knowledgeNodePublicSourceFitReviewProgressMatrix.overallProgressPercent || 0}% · packets ${knowledgeNodePublicSourceFitReviewProgressMatrix.readyPackets || 0}/${knowledgeNodePublicSourceFitReviewProgressMatrix.blockedPackets || 0} · modules ${knowledgeNodePublicSourceFitReviewProgressMatrix.readyModules || 0}/${knowledgeNodePublicSourceFitReviewProgressMatrix.blockedModules || 0}</span>
              ${(knowledgeNodePublicSourceFitReviewProgressMatrix.firstPriorityBlockedPackets || []).slice(0, 4).map((row) => `
                <small>${escapeHtml(row.packetId || "")}: ready ${row.readyRows || 0} · blocked ${row.blockedRows || 0} · missing ${row.missingFieldRows || 0}</small>
              `).join("")}
            </article>
          ` : ""}
          <article>
            <strong>module queue</strong>
            ${((knowledgeNodePublicSourceFitReviewProgressMatrix?.moduleRows || knowledgeNodePublicSourceFitReviewExecutionQueue.moduleRows || [])).slice(0, 6).map((row) => `
              <small>${escapeHtml(row.module || "")}: ready ${row.readyRows || 0} · blocked ${row.blockedRows || row.reviewRows || 0} · next ${escapeHtml(row.firstBlockedPacketId || row.nextBatchId || "")}</small>
            `).join("")}
          </article>
          <article>
            <strong>reviewer checklist</strong>
            ${(knowledgeNodePublicSourceFitReviewExecutionQueue.reviewerChecklist || []).slice(0, 5).map((item) => `
    ...
    ${p0Workbench ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 workbench preview</strong>
          <span>${p0Workbench.workbenchTasks?.length || 0} shown / ${p0Workbench.totalP0Tasks || 0} total · overlay ${p0ReviewOverlay?.overlayStatus || "not_loaded"}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0Workbench.workbenchTasks || []).slice(0, 6).map((task) => `
            <article>
              ${task.previewUrl ? `<img src="${escapeHtml(task.previewUrl)}" alt="${escapeHtml(task.id)} preview" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(task.title || task.id)}</strong>
                <span>${escapeHtml(task.category || "")} · ${escapeHtml(task.workbenchMode || "")} · page ${task.pageNumber || ""}</span>
                <small>${escapeHtml(task.sourceRelativePath || "")}</small>
                <small>${escapeHtml(task.acceptanceCriteria?.[0] || "Reviewer input required before absorption.")}</small>
                <small>next: ${escapeHtml(task.nextCommandHints?.[0] || task.nextGate || "review gate")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${lowExtractionHighResReview ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>high-res low-extraction previews</strong>
          <span>${lowExtractionHighResReview.manualTranscriptionHighResPages || 0} manual pages · ${lowExtractionHighResReview.sourceReplacementHighResPages || 0} replacement pages</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(lowExtractionHighResReview.pageRows || []).slice(0, 6).map((row) => `
            <article>
              ${row.highResPreviewUrl ? `<img src="${escapeHtml(row.highResPreviewUrl)}" alt="${escapeHtml(row.id)} high-res preview" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(row.documentId || row.id)} page ${row.pageNumber || ""}</strong>
                <span>${escapeHtml(row.visualEvidenceStatus || "")} · ${row.width || 0}x${row.height || 0} · ${row.byteGrowth || 0}x bytes</span>
                <small>${escapeHtml(row.sourceRelativePath || "")}</small>
                <small>${escapeHtml(row.reviewerUse || "reviewer evidence only")}</small>
                <small>next: ${escapeHtml(row.nextGate || "review gate")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${highResTranscriptionCandidates ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>machine-assisted transcription candidate index</strong>
          <span>${highResTranscriptionCandidates.candidatePages || 0} candidates · ${highResTranscriptionCandidates.batchCount || 1} batches · accepted ${highResTranscriptionCandidates.acceptedForP0OverlayPages || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(highResTranscriptionCandidates.candidatePagesList || []).slice(0, 8).map((page) => `
            <article>
              ${page.highResPreviewUrl ? `<img src="${escapeHtml(page.highResPreviewUrl)}" alt="${escapeHtml(page.id)} candidate preview" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(page.documentId || "")} page ${page.pageNumber || ""}</strong>
                <span>${escapeHtml(page.candidateStatus || "")} · accepted:${page.acceptedForP0Overlay === true}</span>
                <small>${escapeHtml(page.educationOnlySummary || "")}</small>
                <small>risk: ${(page.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
                <small>next: ${escapeHtml(page.nextGate || "human review")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${p0CandidateReviewAssistMap ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 candidate review assist map</strong>
          <span>${p0CandidateReviewAssistMap.manualTasksWithCandidate || 0} mapped · missing ${p0CandidateReviewAssistMap.manualTasksMissingCandidate || 0} · accepted ${p0CandidateReviewAssistMap.acceptedForP0OverlayTasks || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0CandidateReviewAssistMap.taskRows || []).slice(0, 8).map((row) => `
            <article>
              ${row.highResPreviewUrl ? `<img src="${escapeHtml(row.highResPreviewUrl)}" alt="${escapeHtml(row.id)} candidate review assist" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(row.taskId || row.id)} · ${escapeHtml(row.documentId || "")} page ${row.pageNumber || ""}</strong>
                <span>${escapeHtml(row.category || "")} · ${escapeHtml(row.matchStatus || "")} · accepted:${row.acceptedForP0Overlay === true}</span>
                <small>${escapeHtml(row.candidateSummary || row.reviewAssistUse || "")}</small>
                <small>risk: ${(row.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
                <small>next: ${escapeHtml(row.nextGate || "human review")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${p0ReviewInputDryRunSample ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 review input dry-run sample</strong>
          <span>${p0ReviewInputDryRunSample.readyForValidationEntries || 0} fixture entries · validation ready ${p0ReviewInputDryRunSample.validationReadyEntries || 0} · written ${p0ReviewInputDryRunSample.writtenEntries || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0ReviewInputDryRunSample.sampleRows || []).map((row) => `
            <article>
              ${row.highResPreviewUrl ? `<img src="${escapeHtml(row.highResPreviewUrl)}" alt="${escapeHtml(row.id)} dry-run sample" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(row.taskId || row.id)} · ${escapeHtml(row.documentId || "")} page ${row.pageNumber || ""}</strong>
                <span>${escapeHtml(row.inputStatus || "")} · ${escapeHtml(row.matchStatus || "")} · candidate ${escapeHtml(row.candidateId || "")}</span>
                <small>${escapeHtml(row.humanSummary || "")}</small>
                <small>${escapeHtml(row.fixtureOnlyReason || "fixture-only; do not write real overlay")}</small>
                <small>risk: ${(row.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
              </div>
            </article>
          `).join("")}
    ...
    ${p0HumanReviewNoteTemplate ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 human review note template</strong>
          <span>${p0HumanReviewNoteTemplate.totalP0Tasks || 0} blank cards · manual ${p0HumanReviewNoteTemplate.manualReviewCards || 0} · replacement ${p0HumanReviewNoteTemplate.sourceReplacementReviewCards || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0HumanReviewNoteTemplate.noteCards || []).slice(0, 8).map((card) => `
            <article>
              ${card.highResPreviewUrl ? `<img src="${escapeHtml(card.highResPreviewUrl)}" alt="${escapeHtml(card.id)} human review note" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(card.taskId || card.id)} · ${escapeHtml(card.documentId || "")} page ${card.pageNumber || ""}</strong>
                <span>${escapeHtml(card.category || "")} · ${escapeHtml(card.noteStatus || "")} · required ${card.requiredFieldCount || 0}</span>
                <small>candidate ${escapeHtml(card.candidateId || "source replacement")} · ${escapeHtml(card.matchStatus || "")}</small>
                <small>risk: ${(card.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
                <small>next: ${escapeHtml(card.nextGate || "human review")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${p0HumanFillPack01 ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 human fill pack 01</strong>
          <span>${p0HumanFillPack01.totalPackCards || 0} blank fill cards · ready ${p0HumanFillPack01.readyForValidationCards || 0} · accepted ${p0HumanFillPack01.acceptedForOverlayCards || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0HumanFillPack01.packCards || []).map((card) => `
            <article>
              ${card.highResPreviewUrl ? `<img src="${escapeHtml(card.highResPreviewUrl)}" alt="${escapeHtml(card.id)} human fill pack" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(card.taskId || card.id)} · ${escapeHtml(card.documentId || "")} page ${card.pageNumber || ""}</strong>
                <span>${escapeHtml(card.fillStatus || "")} · required ${card.requiredFieldCount || 0} · candidate ${escapeHtml(card.candidateId || "")}</span>
                <small>${escapeHtml(card.sourceRelativePath || "")}</small>
                <small>risk: ${(card.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
                <small>lint: ${escapeHtml(card.qualityLintRules?.[0] || "human verification required")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${p0HumanFillPack01InputCopy ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>P0 fill pack 01 input copy</strong>
          <span>${p0HumanFillPack01InputCopy.totalEntries || 0} blank input entries · ready ${p0HumanFillPack01InputCopy.validationReadyEntries || 0} · blocked ${p0HumanFillPack01InputCopy.validationBlockedEntries || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(p0HumanFillPack01InputCopy.inputEntries || []).map((entry) => `
            <article>
              ${entry.highResPreviewUrl ? `<img src="${escapeHtml(entry.highResPreviewUrl)}" alt="${escapeHtml(entry.id)} input copy" loading="lazy">` : ""}
              <div>
                <strong>${escapeHtml(entry.taskId || entry.id)} · ${escapeHtml(entry.documentId || "")} page ${entry.pageNumber || ""}</strong>
                <span>${escapeHtml(entry.inputStatus || "")} · candidate ${escapeHtml(entry.candidateId || "")} · missing ${(entry.missingFields || []).length}</span>
                <small>risk: ${(entry.riskTermFlags || []).slice(0, 5).map(escapeHtml).join(" · ")}</small>
                <small>missing: ${(entry.missingFields || []).slice(0, 6).map(escapeHtml).join(" · ")}</small>
                <small>next: ${escapeHtml(entry.nextGate || "validate after fill")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ${sourceReplacementDecisions ? `
      <div class="knowledge-local-workbench">
        <div class="knowledge-section-head">
          <strong>source replacement decision worksheet</strong>
          <span>${sourceReplacementDecisions.notStartedDecisions || 0}/${sourceReplacementDecisions.replacementTargets || 0} not started · direct ${sourceReplacementDecisions.targetsWithDirectReplacementCandidates || 0}</span>
        </div>
        <div class="knowledge-workbench-list">
          ${(sourceReplacementDecisions.decisionRows || []).slice(0, 3).map((row) => `
            <article>
              <div>
                <strong>${escapeHtml(row.sourceRelativePath || row.id)}</strong>
                <span>${escapeHtml(row.decisionStatus || "not_started")} · candidates ${row.candidateCount || 0} · direct ${row.directReplacementCandidateCount || 0}</span>
                <small>${escapeHtml(row.recommendedAction || "reviewer decision required")}</small>
                <small>${(row.topCandidates || []).slice(0, 2).map((candidate) => `${escapeHtml(candidate.confidence || "")}: ${escapeHtml(candidate.relativePath || "")}`).join(" · ")}</small>
                <small>next: ${escapeHtml(row.nextGate || "source replacement decision")}</small>
              </div>
            </article>
          `).join("")}
        </div>
    ...
    ` : ""}
    <div class="knowledge-source-list">
      ${selectedIntake.map((item) => `
        <article>
          <strong>${escapeHtml(item.nodeId)} · ${escapeHtml(item.topic || item.title || "")}</strong>
          <span>${escapeHtml(item.module || "")} / local private course rewrite intake</span>
          <small>${(item.localCourseEvidence || []).slice(0, 3).map((evidence) => escapeHtml(evidence.sourceRelativePath || evidence.name || evidence.documentId)).join(" · ")}</small>
        </article>
      `).join("") || "<p>该模块暂无 rewrite intake 预览。</p>"}
    </div>
    <p class="muted-note">${escapeHtml(coverage.boundary || "Local private course material is reviewer-only and must be rewritten as original education content.")}</p>
  `;
}

function renderKnowledgeBrowserCurriculum() {
  if (!nodes.knowledgeBrowserCurriculum) return;
  const kb = knowledgeBrowserState();
  const paths = kb.curriculum?.paths || [];
  const selectedPath = kb.selectedPath?.path || null;
  nodes.knowledgeBrowserCurriculum.innerHTML = `
    <div class="knowledge-path-row">
      ${paths.slice(0, 12).map((path) => `
        <button type="button" class="${selectedPath?.id === path.id ? "is-active" : ""}" data-knowledge-path="${escapeHtml(path.id)}">
          <strong>${escapeHtml(path.module || path.id)}</strong>
          <span>${path.lessonCount || 0} lessons / ${path.unitCount || 0} units</span>
        </button>
      `).join("") || "<p>等待课程路径。</p>"}
    </div>
    ${selectedPath ? `
      <article class="knowledge-path-detail">
        <strong>${escapeHtml(selectedPath.module || selectedPath.id)}</strong>
        <span>预计 ${selectedPath.estimatedMinutes || 0} 分钟 / ${selectedPath.units?.length || 0} 个 unit / productionReady:${selectedPath.productionReady}</span>
        <ol>${(selectedPath.units || []).slice(0, 6).map((unit) => `<li>${escapeHtml(unit.title || unit.id)}：${escapeHtml(unit.focus || unit.checkpoint?.prompt || "checkpoint")}</li>`).join("")}</ol>
        <small>${escapeHtml(selectedPath.boundary || "课程路径仍是审查草稿，不是发布批准。")}</small>
      </article>
    ` : "<p>点选路径后查看 unit 和 checkpoint。</p>"}
  `;
}

async function loadKnowledgeBrowser({ force = false } = {}) {
  if (!nodes.knowledgeBrowserStatus) return;
  const kb = knowledgeBrowserState();
  if (kb.overview && !force) {
    renderKnowledgeBrowser();
    return;
  }
  nodes.knowledgeBrowserStatus.textContent = "正在加载知识库索引...";
  try {
  const [overview, knowledgeBaseReadinessGate, knowledgeModuleReviewCockpit, knowledgeReviewerActionQueue, knowledgeFirstReviewerActionHandoff, knowledgeFirstReviewerFieldMap, knowledgeFirstReviewerCompletionGate, knowledgeFirstReviewerExecutionChecklist, knowledgeFirstReviewerWorkbench, knowledgeFirstReviewerCardStatusMatrix, knowledgeFirstReviewerPostInputRouteMap, knowledgeFirstReviewerInputQueue, knowledgeReleaseBlockerAudit, knowledgeCoursePathReadinessAudit, knowledgeModuleReviewSprintPlan, curriculum, localCourseCoverage, localCourseAbsorptionReadiness, localCourseModuleAbsorptionSelfAudit, localCourseModuleReviewDossier, localCourseReviewGateDashboard, localCourseAbsorptionQueue, localCourseAbsorptionP0Workbench, localCourseAbsorptionP0ReviewOverlay, localCourseP0ReviewOperatorIndex, localCourseP0WriteAuthorizationPreview, localCourseP0ReviewInputNegativeCases, localCourseHighRiskSelfReviewOverlay, localCourseHighRiskPublicGroundingMatrix, localCourseHighRiskRealReviewerOverlayStarter, localCourseHighRiskRealReviewerOverlayInputValidation, localCourseHighRiskReviewCockpit, localCourseSourceReplacementDecisions, localCourseSourceQuality, localCourseSourceSyncAudit, localCourseDocumentAbsorptionMap, localCourseFolderAbsorptionLedger, publicSourceGap, wikipediaGroundingAudit, publicSourceAbsorptionMap, publicSourceCoverageLedger, knowledgeNodeSourceTriangulationAudit, knowledgeNodePublicSourceFitCandidatePack, knowledgeNodePublicSourceFitReviewInputStarter, knowledgeNodePublicSourceFitReviewInputValidation, knowledgeNodePublicSourceFitReviewExecutionQueue, knowledgeNodePublicSourceFitReviewBatchPackets, knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate, knowledgeNodePublicSourceFitReviewPacketMergePreview, knowledgeNodePublicSourceFitReviewPacketMergeApplyReport, knowledgeNodePublicSourceFitReviewPacket001Handoff, knowledgeNodePublicSourceFitReviewPacketHandoffIndex, knowledgeNodePublicSourceFitRealReviewerLaunchDashboard, knowledgeNodePublicSourceFitPacket001ReviewerWorkbench, knowledgeNodePublicSourceFitReviewerWorkbenchIndex, knowledgeNodePublicSourceFitReviewerRowBrowser, knowledgeNodePublicSourceFitReviewProgressMatrix, lowExtractionVisualReview, lowExtractionHighResReview, localCourseHighResTranscriptionCandidates, localCourseP0CandidateReviewAssistMap, localCourseP0ReviewInputDryRunSample, localCourseP0HumanReviewNoteTemplate, localCourseP0HumanFillPack01, localCourseP0HumanFillPack01InputCopy, localCourseP0HumanReviewBundle, localCourseP0HumanReviewBundleInputCopy, localCourseP0HumanReviewBundlePositiveFixture, localCourseP0HumanReviewRealReviewerHandoff, localCourseP0RealReviewerInputStarter, localCourseP0RealReviewerTaskBoard, localCourseP0RealReviewerEvidencePacket, localCourseP0RealReviewerSourceFitWorksheet, localCourseP0RealReviewerSourceFitInputGuide, localCourseP0RealReviewerSourceFitInputValidation, localCourseP0RealReviewerSourceFitHandoff, lowExtractionTranscriptionOverlay, lowExtractionTranscriptIntake, lowExtractionManualTranscriptionPack, lowExtractionSourceReplacementPack, localCourseRewriteIntake, localCourseRewriteBatch, localCourseRewriteBatches, localCourseRewriteReview, localCourseRefinementPacket] = await Promise.all([
      api("/api/knowledge-browser/overview"),
      api("/api/knowledge-browser/knowledge-base-readiness-gate").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-module-review-cockpit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-reviewer-action-queue").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-action-handoff").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-field-map").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-completion-gate").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-execution-checklist").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-workbench").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-card-status-matrix").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-first-reviewer-post-input-route-map").catch((error) => ({ error: error.message })),
      api(`/api/knowledge-browser/knowledge-first-reviewer-input-queue?${encodeURI(kb.inputQueueQuery || "limit=80")}`).catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-release-blocker-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-course-path-readiness-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-module-review-sprint-plan").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/curriculum"),
      api("/api/knowledge-browser/local-course-coverage").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-absorption-readiness").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-module-absorption-self-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-module-review-dossier").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-review-gate-dashboard").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-absorption-queue").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-absorption-p0-workbench").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-absorption-p0-review-overlay").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-review-operator-index").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-write-authorization-preview").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-review-input-negative-cases").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-risk-self-review-overlay").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-risk-public-grounding-matrix").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-risk-real-reviewer-overlay-starter").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-risk-real-reviewer-overlay-input-validation").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-risk-review-cockpit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-source-replacement-decisions").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-source-quality").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-source-sync-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-document-absorption-map").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-folder-absorption-ledger").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/public-source-gap").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/wikipedia-grounding-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/public-source-absorption-map").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/public-source-coverage-ledger").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-source-triangulation-audit").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-candidate-pack").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-input-starter").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-input-validation").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-execution-queue").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-batch-packets").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-packet-input-copy-template").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-packet-merge-preview").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-packet-merge-apply-report").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-packet-001-handoff").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-packet-handoff-index").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-real-reviewer-launch-dashboard").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-packet-001-reviewer-workbench").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-reviewer-workbench-index").catch((error) => ({ error: error.message })),
      api(`/api/knowledge-browser/knowledge-node-public-source-fit-reviewer-row-browser?${encodeURI(kb.reviewerRowQuery || "limit=80")}`).catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/knowledge-node-public-source-fit-review-progress-matrix").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-visual-review").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-high-res-review").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-high-res-transcription-candidates").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-candidate-review-assist-map").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-review-input-dry-run-sample").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-review-note-template").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-fill-pack-01").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-fill-pack-01-input-copy").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-review-bundle").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-review-bundle-input-copy").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-review-bundle-positive-fixture").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-human-review-real-reviewer-handoff").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-input-starter").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-task-board").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-evidence-packet").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-source-fit-worksheet").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-source-fit-input-guide").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-source-fit-input-validation").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-p0-real-reviewer-source-fit-handoff").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-transcription-overlay").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-transcript-intake").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-manual-transcription-pack").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/low-extraction-source-replacement-pack").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-rewrite-intake?limit=120").catch((error) => ({ error: error.message, rewriteIntake: [] })),
      api("/api/knowledge-browser/local-course-rewrite-batch-01?limit=6").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-rewrite-batches").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-rewrite-review").catch((error) => ({ error: error.message })),
      api("/api/knowledge-browser/local-course-refinement-packet?limit=12").catch((error) => ({ error: error.message })),
    ]);
    const masterKnowledgeDatabase = await api("/api/knowledge-browser/master-knowledge-database").catch((error) => ({ error: error.message }));
    state.knowledgeBrowser.overview = overview;
    state.knowledgeBrowser.masterKnowledgeDatabase = masterKnowledgeDatabase.error ? overview.masterKnowledgeDatabase || null : masterKnowledgeDatabase;
    state.knowledgeBrowser.knowledgeBaseReadinessGate = knowledgeBaseReadinessGate.error ? null : knowledgeBaseReadinessGate;
    state.knowledgeBrowser.knowledgeModuleReviewCockpit = knowledgeModuleReviewCockpit.error ? null : knowledgeModuleReviewCockpit;
    state.knowledgeBrowser.knowledgeReviewerActionQueue = knowledgeReviewerActionQueue.error ? null : knowledgeReviewerActionQueue;
    state.knowledgeBrowser.knowledgeFirstReviewerActionHandoff = knowledgeFirstReviewerActionHandoff.error ? null : knowledgeFirstReviewerActionHandoff;
    state.knowledgeBrowser.knowledgeFirstReviewerFieldMap = knowledgeFirstReviewerFieldMap.error ? null : knowledgeFirstReviewerFieldMap;
    state.knowledgeBrowser.knowledgeFirstReviewerCompletionGate = knowledgeFirstReviewerCompletionGate.error ? null : knowledgeFirstReviewerCompletionGate;
    state.knowledgeBrowser.knowledgeFirstReviewerExecutionChecklist = knowledgeFirstReviewerExecutionChecklist.error ? null : knowledgeFirstReviewerExecutionChecklist;
    state.knowledgeBrowser.knowledgeFirstReviewerWorkbench = knowledgeFirstReviewerWorkbench.error ? null : knowledgeFirstReviewerWorkbench;
    state.knowledgeBrowser.knowledgeFirstReviewerCardStatusMatrix = knowledgeFirstReviewerCardStatusMatrix.error ? null : knowledgeFirstReviewerCardStatusMatrix;
    state.knowledgeBrowser.knowledgeFirstReviewerPostInputRouteMap = knowledgeFirstReviewerPostInputRouteMap.error ? null : knowledgeFirstReviewerPostInputRouteMap;
    state.knowledgeBrowser.knowledgeFirstReviewerInputQueue = knowledgeFirstReviewerInputQueue.error ? null : knowledgeFirstReviewerInputQueue;
    state.knowledgeBrowser.knowledgeReleaseBlockerAudit = knowledgeReleaseBlockerAudit.error ? null : knowledgeReleaseBlockerAudit;
    state.knowledgeBrowser.knowledgeCoursePathReadinessAudit = knowledgeCoursePathReadinessAudit.error ? null : knowledgeCoursePathReadinessAudit;
    state.knowledgeBrowser.knowledgeModuleReviewSprintPlan = knowledgeModuleReviewSprintPlan.error ? null : knowledgeModuleReviewSprintPlan;
    state.knowledgeBrowser.modules = overview.modules || [];
    state.knowledgeBrowser.curriculum = curriculum;
    state.knowledgeBrowser.localCourseCoverage = localCourseCoverage.error ? null : localCourseCoverage;
    state.knowledgeBrowser.localCourseAbsorptionReadiness = localCourseAbsorptionReadiness.error ? null : localCourseAbsorptionReadiness;
    state.knowledgeBrowser.localCourseModuleAbsorptionSelfAudit = localCourseModuleAbsorptionSelfAudit.error ? null : localCourseModuleAbsorptionSelfAudit;
    state.knowledgeBrowser.localCourseModuleReviewDossier = localCourseModuleReviewDossier.error ? null : localCourseModuleReviewDossier;
    state.knowledgeBrowser.localCourseReviewGateDashboard = localCourseReviewGateDashboard.error ? null : localCourseReviewGateDashboard;
    state.knowledgeBrowser.localCourseAbsorptionQueue = localCourseAbsorptionQueue.error ? null : localCourseAbsorptionQueue;
    state.knowledgeBrowser.localCourseAbsorptionP0Workbench = localCourseAbsorptionP0Workbench.error ? null : localCourseAbsorptionP0Workbench;
    state.knowledgeBrowser.localCourseAbsorptionP0ReviewOverlay = localCourseAbsorptionP0ReviewOverlay.error ? null : localCourseAbsorptionP0ReviewOverlay;
    state.knowledgeBrowser.localCourseP0ReviewOperatorIndex = localCourseP0ReviewOperatorIndex.error ? null : localCourseP0ReviewOperatorIndex;
    state.knowledgeBrowser.localCourseP0WriteAuthorizationPreview = localCourseP0WriteAuthorizationPreview.error ? null : localCourseP0WriteAuthorizationPreview;
    state.knowledgeBrowser.localCourseP0ReviewInputNegativeCases = localCourseP0ReviewInputNegativeCases.error ? null : localCourseP0ReviewInputNegativeCases;
    state.knowledgeBrowser.localCourseHighRiskSelfReviewOverlay = localCourseHighRiskSelfReviewOverlay.error ? null : localCourseHighRiskSelfReviewOverlay;
    state.knowledgeBrowser.localCourseHighRiskPublicGroundingMatrix = localCourseHighRiskPublicGroundingMatrix.error ? null : localCourseHighRiskPublicGroundingMatrix;
    state.knowledgeBrowser.localCourseHighRiskRealReviewerOverlayStarter = localCourseHighRiskRealReviewerOverlayStarter.error ? null : localCourseHighRiskRealReviewerOverlayStarter;
    state.knowledgeBrowser.localCourseHighRiskRealReviewerOverlayInputValidation = localCourseHighRiskRealReviewerOverlayInputValidation.error ? null : localCourseHighRiskRealReviewerOverlayInputValidation;
    state.knowledgeBrowser.localCourseHighRiskReviewCockpit = localCourseHighRiskReviewCockpit.error ? null : localCourseHighRiskReviewCockpit;
    state.knowledgeBrowser.localCourseSourceReplacementDecisions = localCourseSourceReplacementDecisions.error ? null : localCourseSourceReplacementDecisions;
    state.knowledgeBrowser.localCourseSourceQuality = localCourseSourceQuality.error ? null : localCourseSourceQuality;
    state.knowledgeBrowser.localCourseSourceSyncAudit = localCourseSourceSyncAudit.error ? null : localCourseSourceSyncAudit;
    state.knowledgeBrowser.localCourseDocumentAbsorptionMap = localCourseDocumentAbsorptionMap.error ? null : localCourseDocumentAbsorptionMap;
    state.knowledgeBrowser.localCourseFolderAbsorptionLedger = localCourseFolderAbsorptionLedger.error ? null : localCourseFolderAbsorptionLedger;
    state.knowledgeBrowser.publicSourceGap = publicSourceGap.error ? null : publicSourceGap;
    state.knowledgeBrowser.wikipediaGroundingAudit = wikipediaGroundingAudit.error ? null : wikipediaGroundingAudit;
    state.knowledgeBrowser.publicSourceAbsorptionMap = publicSourceAbsorptionMap.error ? null : publicSourceAbsorptionMap;
    state.knowledgeBrowser.publicSourceCoverageLedger = publicSourceCoverageLedger.error ? null : publicSourceCoverageLedger;
    state.knowledgeBrowser.knowledgeNodeSourceTriangulationAudit = knowledgeNodeSourceTriangulationAudit.error ? null : knowledgeNodeSourceTriangulationAudit;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitCandidatePack = knowledgeNodePublicSourceFitCandidatePack.error ? null : knowledgeNodePublicSourceFitCandidatePack;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewInputStarter = knowledgeNodePublicSourceFitReviewInputStarter.error ? null : knowledgeNodePublicSourceFitReviewInputStarter;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewInputValidation = knowledgeNodePublicSourceFitReviewInputValidation.error ? null : knowledgeNodePublicSourceFitReviewInputValidation;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewExecutionQueue = knowledgeNodePublicSourceFitReviewExecutionQueue.error ? null : knowledgeNodePublicSourceFitReviewExecutionQueue;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewBatchPackets = knowledgeNodePublicSourceFitReviewBatchPackets.error ? null : knowledgeNodePublicSourceFitReviewBatchPackets;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate = knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.error ? null : knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewPacketMergePreview = knowledgeNodePublicSourceFitReviewPacketMergePreview.error ? null : knowledgeNodePublicSourceFitReviewPacketMergePreview;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewPacketMergeApplyReport = knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.error ? null : knowledgeNodePublicSourceFitReviewPacketMergeApplyReport;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewPacket001Handoff = knowledgeNodePublicSourceFitReviewPacket001Handoff.error ? null : knowledgeNodePublicSourceFitReviewPacket001Handoff;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewPacketHandoffIndex = knowledgeNodePublicSourceFitReviewPacketHandoffIndex.error ? null : knowledgeNodePublicSourceFitReviewPacketHandoffIndex;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitRealReviewerLaunchDashboard = knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.error ? null : knowledgeNodePublicSourceFitRealReviewerLaunchDashboard;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitPacket001ReviewerWorkbench = knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.error ? null : knowledgeNodePublicSourceFitPacket001ReviewerWorkbench;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewerWorkbenchIndex = knowledgeNodePublicSourceFitReviewerWorkbenchIndex.error ? null : knowledgeNodePublicSourceFitReviewerWorkbenchIndex;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewerRowBrowser = knowledgeNodePublicSourceFitReviewerRowBrowser.error ? null : knowledgeNodePublicSourceFitReviewerRowBrowser;
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewProgressMatrix = knowledgeNodePublicSourceFitReviewProgressMatrix.error ? null : knowledgeNodePublicSourceFitReviewProgressMatrix;
    state.knowledgeBrowser.lowExtractionVisualReview = lowExtractionVisualReview.error ? null : lowExtractionVisualReview;
    state.knowledgeBrowser.lowExtractionHighResReview = lowExtractionHighResReview.error ? null : lowExtractionHighResReview;
    state.knowledgeBrowser.localCourseHighResTranscriptionCandidates = localCourseHighResTranscriptionCandidates.error ? null : localCourseHighResTranscriptionCandidates;
    state.knowledgeBrowser.localCourseP0CandidateReviewAssistMap = localCourseP0CandidateReviewAssistMap.error ? null : localCourseP0CandidateReviewAssistMap;
    state.knowledgeBrowser.localCourseP0ReviewInputDryRunSample = localCourseP0ReviewInputDryRunSample.error ? null : localCourseP0ReviewInputDryRunSample;
    state.knowledgeBrowser.localCourseP0HumanReviewNoteTemplate = localCourseP0HumanReviewNoteTemplate.error ? null : localCourseP0HumanReviewNoteTemplate;
    state.knowledgeBrowser.localCourseP0HumanFillPack01 = localCourseP0HumanFillPack01.error ? null : localCourseP0HumanFillPack01;
    state.knowledgeBrowser.localCourseP0HumanFillPack01InputCopy = localCourseP0HumanFillPack01InputCopy.error ? null : localCourseP0HumanFillPack01InputCopy;
    state.knowledgeBrowser.localCourseP0HumanReviewBundle = localCourseP0HumanReviewBundle.error ? null : localCourseP0HumanReviewBundle;
    state.knowledgeBrowser.localCourseP0HumanReviewBundleInputCopy = localCourseP0HumanReviewBundleInputCopy.error ? null : localCourseP0HumanReviewBundleInputCopy;
    state.knowledgeBrowser.localCourseP0HumanReviewBundlePositiveFixture = localCourseP0HumanReviewBundlePositiveFixture.error ? null : localCourseP0HumanReviewBundlePositiveFixture;
    state.knowledgeBrowser.localCourseP0HumanReviewRealReviewerHandoff = localCourseP0HumanReviewRealReviewerHandoff.error ? null : localCourseP0HumanReviewRealReviewerHandoff;
    state.knowledgeBrowser.localCourseP0RealReviewerInputStarter = localCourseP0RealReviewerInputStarter.error ? null : localCourseP0RealReviewerInputStarter;
    state.knowledgeBrowser.localCourseP0RealReviewerTaskBoard = localCourseP0RealReviewerTaskBoard.error ? null : localCourseP0RealReviewerTaskBoard;
    state.knowledgeBrowser.localCourseP0RealReviewerEvidencePacket = localCourseP0RealReviewerEvidencePacket.error ? null : localCourseP0RealReviewerEvidencePacket;
    state.knowledgeBrowser.localCourseP0RealReviewerSourceFitWorksheet = localCourseP0RealReviewerSourceFitWorksheet.error ? null : localCourseP0RealReviewerSourceFitWorksheet;
    state.knowledgeBrowser.localCourseP0RealReviewerSourceFitInputGuide = localCourseP0RealReviewerSourceFitInputGuide.error ? null : localCourseP0RealReviewerSourceFitInputGuide;
    state.knowledgeBrowser.localCourseP0RealReviewerSourceFitInputValidation = localCourseP0RealReviewerSourceFitInputValidation.error ? null : localCourseP0RealReviewerSourceFitInputValidation;
    state.knowledgeBrowser.localCourseP0RealReviewerSourceFitHandoff = localCourseP0RealReviewerSourceFitHandoff.error ? null : localCourseP0RealReviewerSourceFitHandoff;
    state.knowledgeBrowser.lowExtractionTranscriptionOverlay = lowExtractionTranscriptionOverlay.error ? null : lowExtractionTranscriptionOverlay;
    state.knowledgeBrowser.lowExtractionTranscriptIntake = lowExtractionTranscriptIntake.error ? null : lowExtractionTranscriptIntake;
    state.knowledgeBrowser.lowExtractionManualTranscriptionPack = lowExtractionManualTranscriptionPack.error ? null : lowExtractionManualTranscriptionPack;
    state.knowledgeBrowser.lowExtractionSourceReplacementPack = lowExtractionSourceReplacementPack.error ? null : lowExtractionSourceReplacementPack;
    state.knowledgeBrowser.localCourseRewriteIntake = localCourseRewriteIntake.rewriteIntake || [];
    state.knowledgeBrowser.localCourseRewriteBatch = localCourseRewriteBatch.error ? null : localCourseRewriteBatch;
    state.knowledgeBrowser.localCourseRewriteBatches = localCourseRewriteBatches.error ? null : localCourseRewriteBatches;
    state.knowledgeBrowser.localCourseRewriteReview = localCourseRewriteReview.error ? null : localCourseRewriteReview;
    state.knowledgeBrowser.localCourseRefinementPacket = localCourseRefinementPacket.error ? null : localCourseRefinementPacket;
    state.knowledgeBrowser.localCourseError = knowledgeBaseReadinessGate.error || knowledgeModuleReviewCockpit.error || knowledgeReviewerActionQueue.error || knowledgeFirstReviewerActionHandoff.error || knowledgeFirstReviewerFieldMap.error || knowledgeFirstReviewerCompletionGate.error || knowledgeFirstReviewerExecutionChecklist.error || knowledgeFirstReviewerWorkbench.error || knowledgeFirstReviewerCardStatusMatrix.error || knowledgeFirstReviewerPostInputRouteMap.error || knowledgeFirstReviewerInputQueue.error || knowledgeReleaseBlockerAudit.error || knowledgeCoursePathReadinessAudit.error || knowledgeModuleReviewSprintPlan.error || localCourseCoverage.error || localCourseAbsorptionReadiness.error || localCourseModuleAbsorptionSelfAudit.error || localCourseModuleReviewDossier.error || localCourseReviewGateDashboard.error || localCourseAbsorptionQueue.error || localCourseAbsorptionP0Workbench.error || localCourseAbsorptionP0ReviewOverlay.error || localCourseP0ReviewOperatorIndex.error || localCourseP0WriteAuthorizationPreview.error || localCourseP0ReviewInputNegativeCases.error || localCourseHighRiskSelfReviewOverlay.error || localCourseHighRiskPublicGroundingMatrix.error || localCourseHighRiskRealReviewerOverlayStarter.error || localCourseHighRiskRealReviewerOverlayInputValidation.error || localCourseHighRiskReviewCockpit.error || localCourseSourceReplacementDecisions.error || localCourseSourceQuality.error || localCourseSourceSyncAudit.error || localCourseDocumentAbsorptionMap.error || localCourseFolderAbsorptionLedger.error || publicSourceGap.error || wikipediaGroundingAudit.error || publicSourceAbsorptionMap.error || publicSourceCoverageLedger.error || knowledgeNodeSourceTriangulationAudit.error || knowledgeNodePublicSourceFitCandidatePack.error || knowledgeNodePublicSourceFitReviewInputStarter.error || knowledgeNodePublicSourceFitReviewInputValidation.error || knowledgeNodePublicSourceFitReviewExecutionQueue.error || knowledgeNodePublicSourceFitReviewBatchPackets.error || knowledgeNodePublicSourceFitReviewPacketInputCopyTemplate.error || knowledgeNodePublicSourceFitReviewPacketMergePreview.error || knowledgeNodePublicSourceFitReviewPacketMergeApplyReport.error || knowledgeNodePublicSourceFitReviewPacket001Handoff.error || knowledgeNodePublicSourceFitReviewPacketHandoffIndex.error || knowledgeNodePublicSourceFitRealReviewerLaunchDashboard.error || knowledgeNodePublicSourceFitPacket001ReviewerWorkbench.error || knowledgeNodePublicSourceFitReviewerWorkbenchIndex.error || knowledgeNodePublicSourceFitReviewerRowBrowser.error || knowledgeNodePublicSourceFitReviewProgressMatrix.error || lowExtractionVisualReview.error || lowExtractionHighResReview.error || localCourseHighResTranscriptionCandidates.error || localCourseP0CandidateReviewAssistMap.error || localCourseP0ReviewInputDryRunSample.error || localCourseP0HumanReviewNoteTemplate.error || localCourseP0HumanFillPack01.error || localCourseP0HumanFillPack01InputCopy.error || localCourseP0HumanReviewBundle.error || localCourseP0HumanReviewBundleInputCopy.error || localCourseP0HumanReviewBundlePositiveFixture.error || localCourseP0HumanReviewRealReviewerHandoff.error || localCourseP0RealReviewerInputStarter.error || localCourseP0RealReviewerTaskBoard.error || localCourseP0RealReviewerEvidencePacket.error || localCourseP0RealReviewerSourceFitWorksheet.error || localCourseP0RealReviewerSourceFitInputGuide.error || localCourseP0RealReviewerSourceFitInputValidation.error || localCourseP0RealReviewerSourceFitHandoff.error || lowExtractionTranscriptionOverlay.error || lowExtractionTranscriptIntake.error || lowExtractionManualTranscriptionPack.error || lowExtractionSourceReplacementPack.error || localCourseRewriteIntake.error || localCourseRewriteBatch.error || localCourseRewriteBatches.error || localCourseRewriteReview.error || localCourseRefinementPacket.error || "";
    state.knowledgeBrowser.selectedModuleId = state.knowledgeBrowser.selectedModuleId || overview.modules?.[0]?.id || null;
    if (state.knowledgeBrowser.selectedModuleId) {
      await loadKnowledgeModule(state.knowledgeBrowser.selectedModuleId);
      return;
    }
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `知识库加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeModule(moduleId) {
  if (!moduleId) return;
  state.knowledgeBrowser.selectedModuleId = moduleId;
  nodes.knowledgeBrowserStatus.textContent = `正在加载模块 ${moduleId}...`;
  try {
    const result = await api(`/api/knowledge-browser/nodes?module=${encodeURIComponent(moduleId)}&limit=20`);
    state.knowledgeBrowser.nodes = result.nodes || [];
    state.knowledgeBrowser.selectedNodeId = state.knowledgeBrowser.nodes[0]?.id || null;
    state.knowledgeBrowser.selectedNodeDetail = null;
    state.knowledgeBrowser.selectedNodeEvidence = null;
    state.knowledgeBrowser.evidenceLoading = false;
    state.knowledgeBrowser.evidenceError = "";
    renderKnowledgeBrowser();
    if (state.knowledgeBrowser.selectedNodeId) {
      await loadKnowledgeNode(state.knowledgeBrowser.selectedNodeId);
      return;
    }
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `模块加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeNode(nodeId) {
  if (!nodeId) return;
  state.knowledgeBrowser.selectedNodeId = nodeId;
  nodes.knowledgeBrowserStatus.textContent = `正在加载节点 ${nodeId}...`;
  try {
    const detail = await api(`/api/knowledge-browser/nodes/${encodeURIComponent(nodeId)}`);
    if (state.knowledgeBrowser.selectedNodeId !== nodeId) return;
    state.knowledgeBrowser.selectedNodeDetail = detail;
    state.knowledgeBrowser.selectedNodeEvidence = null;
    state.knowledgeBrowser.evidenceLoading = false;
    state.knowledgeBrowser.evidenceError = "";
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `节点加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeEvidence(nodeId = state.knowledgeBrowser.selectedNodeId) {
  if (!nodeId || state.knowledgeBrowser.evidenceLoading) return;
  state.knowledgeBrowser.evidenceLoading = true;
  state.knowledgeBrowser.evidenceError = "";
  renderKnowledgeBrowserEvidence();
  try {
    const evidence = await api(`/api/knowledge-browser/nodes/${encodeURIComponent(nodeId)}/evidence`);
    if (state.knowledgeBrowser.selectedNodeId !== nodeId) return;
    state.knowledgeBrowser.selectedNodeEvidence = evidence;
  } catch (error) {
    if (state.knowledgeBrowser.selectedNodeId === nodeId) {
      state.knowledgeBrowser.evidenceError = `附加语料片段加载失败：${error.message}`;
    }
  } finally {
    if (state.knowledgeBrowser.selectedNodeId === nodeId) {
      state.knowledgeBrowser.evidenceLoading = false;
...
async function loadKnowledgePath(pathId) {
  if (!pathId) return;
  nodes.knowledgeBrowserStatus.textContent = `正在加载课程路径 ${pathId}...`;
  try {
    state.knowledgeBrowser.selectedPath = await api(`/api/knowledge-browser/curriculum/${encodeURIComponent(pathId)}`);
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `课程路径加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeSourceFitPacket(packetId) {
  if (!packetId) return;
  state.knowledgeBrowser.selectedSourceFitPacketId = packetId;
  nodes.knowledgeBrowserStatus.textContent = `正在加载 source-fit packet ${packetId}...`;
  try {
    const packet = await api(`/api/knowledge-browser/knowledge-node-public-source-fit-review-batch-packets?packetId=${encodeURIComponent(packetId)}`);
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewBatchPackets = packet;
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `source-fit packet 加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeReviewerRowBrowser(query = "limit=80") {
  const normalizedQuery = query || "limit=80";
  state.knowledgeBrowser.reviewerRowQuery = normalizedQuery;
  nodes.knowledgeBrowserStatus.textContent = "正在加载 source-fit row browser...";
  try {
    const result = await api(`/api/knowledge-browser/knowledge-node-public-source-fit-reviewer-row-browser?${encodeURI(normalizedQuery)}`);
    state.knowledgeBrowser.knowledgeNodePublicSourceFitReviewerRowBrowser = result;
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `source-fit row browser 加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeFirstReviewerInputQueue(query = "limit=80") {
  const normalizedQuery = query || "limit=80";
  state.knowledgeBrowser.inputQueueQuery = normalizedQuery;
  nodes.knowledgeBrowserStatus.textContent = "正在加载 first reviewer input queue...";
  try {
    const result = await api(`/api/knowledge-browser/knowledge-first-reviewer-input-queue?${encodeURI(normalizedQuery)}`);
    state.knowledgeBrowser.knowledgeFirstReviewerInputQueue = result;
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `first reviewer input queue 加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeFirstReviewerInputDetail(itemRank) {
  if (!itemRank) return;
  nodes.knowledgeBrowserStatus.textContent = `正在加载 first reviewer input #${itemRank}...`;
  try {
    state.knowledgeBrowser.selectedFirstReviewerInputDetail = await api(`/api/knowledge-browser/knowledge-first-reviewer-input-queue-detail?itemRank=${encodeURIComponent(itemRank)}`);
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `first reviewer input detail 加载失败：${escapeHtml(error.message)}`;
  }
}

async function loadKnowledgeReviewerRowDetail(reviewId) {
  if (!reviewId) return;
  nodes.knowledgeBrowserStatus.textContent = `正在加载 source-fit row ${reviewId}...`;
  try {
    state.knowledgeBrowser.selectedReviewerRowDetail = await api(`/api/knowledge-browser/knowledge-node-public-source-fit-reviewer-row-detail?reviewId=${encodeURIComponent(reviewId)}`);
    renderKnowledgeBrowser();
  } catch (error) {
    nodes.knowledgeBrowserStatus.textContent = `source-fit row detail 加载失败：${escapeHtml(error.message)}`;
  }
}
...
function renderTrainer() {
  ...
  renderTodayPracticePlan(lesson);
  ...
  renderScenarioSourceCard(lesson, "trainer");
}

function sourceStatusLabel(value = "") {
  const text = String(value || "").toLowerCase();
  if (/licensed|authorized|授权/.test(text)) return "已授权";
  if (/public|preview|stooq|gdelt|sec|公开/.test(text)) return "公开预览";
  if (/demo|mock|internal|manual|teaching|演示|教学/.test(text)) return "演示";
  return "待复核";
}

function sourceCardRows(lesson = {}) {
  const source = lesson.source || {};
  const transparency = lesson.sourceTransparency || {};
  const market = source.marketData || {};
  const news = source.news || {};
  const marketProvider = market.provider || lesson.marketDataProvider || source.provider || "demo";
  const marketMode = market.mode || lesson.sourceMode || "teaching-demo";
  const marketLicense = market.license || lesson.marketDataLicense || transparency.licenseStatus || "internal-demo-only";
  const newsProvider = news.provider || lesson.newsProvider || "demo";
  const newsMode = news.mode || "teaching-demo";
  const newsLicense = news.license || lesson.newsLicense || "internal-demo-only";
  const aiProvider = state.data?.aiCoach?.provider || state.data?.providerStatus?.provider || "local demo AI";
  const aiMode = state.data?.aiCoach?.mode || state.data?.providerStatus?.mode || "mock provider";
  return [
    {
      label: "行情K线",
      status: sourceStatusLabel(`${marketProvider} ${marketMode} ${marketLicense} ${transparency.learnerLabel || ""}`),
      body: `${marketProvider} / ${marketMode} / ${marketLicense}`,
      note: "用于读图训练；正式历史回顾需要授权行情、时间戳和延迟/实时状态。",
    },
    {
      label: "新闻/情绪",
      status: sourceStatusLabel(`${newsProvider} ${newsMode} ${newsLicense} ${lesson.news || ""} ${lesson.sentiment || ""}`),
      body: `${newsProvider} / ${newsMode} / ${newsLicense}`,
      note: "只做当时背景和偏见检查，不作为行动理由。",
    },
    {
      label: "AI批改",
      status: /local|demo|mock|fallback/i.test(`${aiProvider} ${aiMode}`) ? "本地演示" : "外部模型",
      body: `${aiProvider} / ${aiMode}`,
      note: "只评价学习过程；不荐股、不出实盘信号、不承诺收益。",
    },
  ];
}

function sourceCardHtml(lesson = {}, variant = "trainer") {
  const title = variant === "replay" ? "本次回放的数据边界" : "本题数据来源";
  const subtitle = variant === "replay"
    ? "回放时仍然只看当时可见信息，不能用事后数据倒推。"
    : "先确认这题用的是什么数据，再开始判断。";
  return `
    <section class="source-trust-card" aria-label="${escapeHtml(title)}">
      <div>
        <p class="eyebrow">来源透明</p>
        <h4>${escapeHtml(title)}</h4>
        <span>${escapeHtml(subtitle)}</span>
      </div>
      <div class="source-trust-grid">
        ${sourceCardRows(lesson).map((item) => `
          <article>
      ...
      <small>当前产品仍是教育原型：demo/公开预览/待授权数据必须清楚标注，不能包装成真实交易信号。</small>
    </section>
  `;
}

function renderScenarioSourceCard(lesson = currentScenario(), variant = "trainer") {
  const anchor = variant === "replay" ? document.querySelector("#replayTrainingBridge") : document.querySelector("#contextTimeline");
  if (!anchor) return;
  const id = variant === "replay" ? "replaySourceTrustCard" : "scenarioSourceTrustCard";
  let panel = document.querySelector(`#${id}`);
  if (!panel) {
    panel = document.createElement("section");
    panel.id = id;
    panel.className = "source-trust-card-shell";
    anchor.insertAdjacentElement(variant === "replay" ? "afterend" : "beforebegin", panel);
  }
  panel.innerHTML = sourceCardHtml(lesson, variant);
}
...
function renderTrainingFocusRail() {
  ...
  rail.innerHTML = `
    ...
    <div class="training-quick-actions" aria-label="快速开始训练">
      <button type="button" data-quick-start-answer>先做题</button>
      <button type="button" data-scroll-target="#teachingIntroPanel">先看教学</button>
      <button type="button" data-scroll-target="#chartReadingGuide">先看图</button>
    </div>
...
function buildTodayPracticePlan(currentLesson = currentScenario()) {
  const trend = buildMistakeTrendPlan(state.data.profile || {}, state.data.attempts || [], state.lastCompletedTraining);
  const recommended = state.data.learningPath?.recommendedScenario;
  const scenario = recommended || currentLesson;
  const isCurrent = scenario?.id === currentLesson?.id;
  const lessonForPlan = scenario || currentLesson;
  const framework = Array.isArray(lessonForPlan?.teachingFramework) ? lessonForPlan.teachingFramework : [];
  const checklist = Array.isArray(lessonForPlan?.observationChecklist) ? lessonForPlan.observationChecklist : [];
  const title = trend?.active ? trend.focus : "今日先完成一题完整训练";
  const reason = trend?.active
    ? trend.why
    : "先建立第一条学习记录，系统才能生成错因画像和下一步专项。";
  const drill = trend?.active
    ? trend.drill
    : "按教学导入、作答、回放、AI复盘、反馈走完整闭环。";
  return {
    title,
    reason,
    drill,
    scenario,
    isCurrent,
    relay: buildMistakeRelayPlan(),
    microLesson: {
      concept: framework[0] || lessonForPlan?.moduleGoal || "先读结构，再写失效条件，最后处理消息和情绪背景。",
      counterExample: lessonForPlan?.badAnswerExample || lessonForPlan?.commonMistake || "感觉会继续走，先冲进去再说；没有结构、没有失效条件，也没有说明消息和情绪是不是干扰。",
      template: (checklist.length ? checklist.slice(0, 3).join(" → ") : "我看到什么结构 → 哪里说明我错了 → 我现在不做什么"),
    },
    boundary: "这里只安排学习训练，不荐股、不出实盘信号、不评价策略收益。",
  };
}

function renderTodayPracticePlan(currentLesson = currentScenario()) {
  const anchor = document.querySelector("#trainingFocusRail");
  if (!anchor) return;
  let panel = document.querySelector("#todayPracticePlan");
  if (!panel) {
    panel = document.createElement("section");
    panel.id = "todayPracticePlan";
    panel.className = "today-practice-plan";
    anchor.insertAdjacentElement("afterend", panel);
  }
  const plan = buildTodayPracticePlan(currentLesson);
  const scenario = plan.scenario || currentLesson;
  panel.innerHTML = `
    <div>
    ...
    <article>
      <strong>推荐练习</strong>
      <span>${escapeHtml(scenario?.title || currentLesson.title)} / ${escapeHtml(scenario?.symbol || currentLesson.symbol || "")} ${escapeHtml(scenario?.timeframe || currentLesson.timeframe || "")}</span>
      <small>${escapeHtml(plan.drill)}</small>
    </article>
    <div class="today-micro-lesson" aria-label="60秒微课">
      <div>
        <p class="eyebrow">60 秒微课</p>
        <strong>先学一个概念，再开始练。</strong>
      </div>
      <article>
        <b>概念</b>
        <span>${escapeHtml(plan.microLesson.concept)}</span>
      </article>
      <article>
        <b>反例</b>
        <span>${escapeHtml(plan.microLesson.counterExample)}</span>
      </article>
      <article>
        <b>作答模板</b>
        <span>${escapeHtml(plan.microLesson.template)}</span>
      </article>
    </div>
    <div class="mistake-relay-map ${plan.relay.shouldReplayFirst ? "is-paused" : ""}" aria-label="错因接力图">
      <div>
        <p class="eyebrow">错因接力</p>
        <strong>${escapeHtml(plan.relay.title)}</strong>
        <span>${escapeHtml(plan.relay.summary)}</span>
      </div>
      ${plan.relay.steps.map((item, index) => `
        <article>
          <b>${index + 1}</b>
          <strong>${escapeHtml(item.label)}</strong>
    ...
    <div class="today-practice-actions">
      <button type="button" data-quick-start-answer>直接开始作答</button>
      ${plan.isCurrent ? `<button type="button" data-scroll-target="#teachingIntroPanel">从教学导入开始</button>` : `<button type="button" data-today-practice-scenario="${escapeHtml(scenario.id)}">切到推荐题</button>`}
      <button type="button" data-scroll-target="#decisionScaffold">看作答脚手架</button>
    </div>
    <small>${escapeHtml(plan.boundary)}</small>
  `;
}

function buildMistakeRelayPlan() {
  const lastTraining = state.lastCompletedTraining || null;
  const diagnosis = state.lastTrainingDiagnosis?.primary || null;
  const cadence = learningCadenceGate();
  if (!lastTraining && !diagnosis) {
    return {
      title: "先完成第一题，系统才会开始追踪错因。",
      summary: "第一题之后，这里会显示“上一题错因如何影响下一题草稿”。",
      steps: [
        { label: "先做一题", text: "用微课模板写完整训练答案。" },
        { label: "AI批改", text: "系统只找过程问题，不看收益。" },
        { label: "下一题接力", text: "下一次草稿会带上上次最大错因。" },
      ],
    };
  }
  return {
    title: cadence.shouldReplayFirst ? "先别急着做新题，回放同题重写一遍。" : "系统正在追着你的错因训练。",
    summary: cadence.shouldReplayFirst
      ? cadence.reason
      : "下一次填入学习示例时，会把上一题批改写进草稿开头。",
    steps: [
      { label: "上次错因", text: lastTraining?.biggestIssue || diagnosis?.problem || "上一题暴露出过程问题。" },
      { label: cadence.shouldReplayFirst ? "先重写" : "本题草稿", text: cadence.shouldReplayFirst ? "先回放刚才那题，用本次只改一件事重写答案。" : (lastTraining?.nextPractice || diagnosis?.check || "这次只改一个学习动作。") },
      { label: "回放验证", text: "检查是否还在犯同一类错，再决定要不要做新题。" },
    ],
    shouldReplayFirst: cadence.shouldReplayFirst,
  };
}

function learningCadenceGate() {
  const diagnosisKey = state.lastTrainingDiagnosis?.primary?.key || "";
  const lastText = [
    state.lastCompletedTraining?.biggestIssue,
    state.lastCompletedTraining?.nextPractice,
    state.lastTrainingDiagnosis?.primary?.label,
    state.lastTrainingDiagnosis?.primary?.problem,
  ].filter(Boolean).join(" ");
  const profile = state.data?.profile || {};
  const attempts = (state.data?.attempts || []).filter((item) => item.type === "training");
  const keyHints = {
    hindsight: /偷看|未来|倒推|事后|回放|hindsight/i,
    invalidation: /失效|认错|风险|止损|invalidation|risk/i,
    sentiment: /情绪|消息|新闻|热度|背景|sentiment|context/i,
    thin_reasoning: /理由|证据|空泛|太短|thin|reason/i,
    structure: /结构|突破|区间|前高|跌回|structure/i,
  };
  const activeKey = Object.keys(keyHints).find((key) => (
    diagnosisKey === key || keyHints[key].test(lastText)
  ));
  if (!activeKey) return { shouldReplayFirst: false, reason: "当前先按推荐路径继续训练。" };
  const profileHit = Object.entries(profile).some(([tag, count]) => Number(count) >= 2 && keyHints[activeKey].test(tag));
  const recentHit = attempts.slice(0, 3).filter((attempt) => (attempt.tags || []).some((tag) => keyHints[activeKey].test(tag))).length >= 2;
  const shouldReplayFirst = profileHit || recentHit;
  return {
    shouldReplayFirst,
    reason: shouldReplayFirst
      ? "同类错因已经反复出现，先回放同题重写，比继续刷新题更有学习价值。"
      : "当前先按推荐路径继续训练。",
  };
}
...
function renderTeachingIntro(lesson) {
  ...
  const primaryLesson = framework[0] || "先判断价格是在推进、停顿还是回到区间，再写哪里说明自己错了。";
  const quickSteps = (lessonSteps.length ? lessonSteps : [
    { label: "看结构", text: "先标区间、前高前低和当前价格位置。" },
    { label: "找失效", text: "写出哪一段走势说明原判断不成立。" },
    { label: "控冲动", text: "新闻和情绪只当背景，不当行动理由。" },
  ]).slice(0, 3);
  const answerTemplate = (checklist.length ? checklist.slice(0, 3) : [
    "我看到什么结构？",
    "哪里说明我可能错了？",
    "我现在不做什么？",
  ]);
  ...
  nodes.teachingIntroPanel.innerHTML = `
    ...
    <div class="professional-reading-map" aria-label="专业读图顺序">
      <div class="professional-reading-head">
        ...
        <span>不是只看 ${escapeHtml(timeframe)}：先拆周期，再拆事件，再写边界。</span>
      </div>
      <div class="professional-reading-grid">
        <article>
          <b>D1 / H4</b>
          <span>只判断大背景和主要结构，不直接推出行动结论。</span>
        </article>
        <article>
          <b>H1 / ${escapeHtml(timeframe)}</b>
          <span>定位当前题的结构、失效条件、等待条件和不做条件。</span>
        </article>
        <article>
          <b>新闻 / 情绪</b>
          <span>只记录当时可见背景、事件风险和偏见来源，不当买卖理由。</span>
        </article>
        <article>
          <b>数据边界</b>
          <span>当前为演示教学片段；正式历史回顾必须接授权行情、新闻和情绪源。</span>
        </article>
      </div>
    </div>
    <div class="lesson-snapshot" aria-label="本题学习卡">
      <div class="lesson-snapshot-main">
        <span class="lesson-kicker">先学这一句</span>
        <strong>${escapeHtml(primaryLesson)}</strong>
      </div>
      <div class="lesson-snapshot-steps">
        ${quickSteps.map((item, index) => `
          <span>
            <b>${index + 1}. ${escapeHtml(item.label || item.title || `步骤 ${index + 1}`)}</b>
            ${escapeHtml(item.text || item.prompt || item.description || "按课堂检查表写出可复盘证据。")}
          </span>
        `).join("")}
      </div>
      <div class="lesson-answer-template">
        <b>作答模板</b>
        <span>${answerTemplate.map(escapeHtml).join(" → ")}</span>
      </div>
    </div>
...
function renderDecisionScaffold(lesson) {
  ...
  const checklist = Array.isArray(lesson.observationChecklist) ? lesson.observationChecklist : [];
  const mistakes = buildPreAnswerMistakes(lesson);
  const steps = [
    {
      label: "观察",
      title: "先看当时可见K线",
  ...
  panel.innerHTML = `
    ...
    <div class="pre-answer-warning" aria-label="提交前常见错误预警">
      <div>
        <strong>提交前先避开这 3 个错</strong>
        <span>这一步是课堂纠错，不评价策略能不能赚钱。</span>
      </div>
...
function buildPreAnswerMistakes(lesson = {}) {
  const rawMistake = String(lesson.commonMistake || "").trim();
  const items = [];
  if (rawMistake) items.push(rawMistake);
  items.push("只写“会涨/会跌/感觉强”，但没有写当时看到的结构。");
  items.push("没有写失效条件：哪里说明自己错了、什么时候停止维护原判断。");
  const contextText = [lesson.news, lesson.sentiment, lesson.teachingGoal, lesson.moduleGoal, lesson.tag].filter(Boolean).join(" ");
  if (/新闻|消息|情绪|热度|财报|事件/.test(contextText)) {
    items.push("把新闻或情绪热度当成行动理由，而不是当作背景和偏见检查。");
  } else {
    items.push("回放时用后面的走势倒推当时判断，看起来合理但不可复盘。");
  }
...
function trainingPlanExample(lesson = currentScenario()) {
  ...
  const timeframe = lesson?.timeframe || "当前周期";
  const plan = buildTodayPracticePlan(lesson);
  const concept = plan.microLesson?.concept || "先读结构，再写失效条件，最后处理消息和情绪背景。";
  const checklist = Array.isArray(lesson?.observationChecklist) ? lesson.observationChecklist : [];
  const structurePrompt = checklist[0] || "我看到什么结构？";
  const invalidationPrompt = checklist[1] || "哪里说明我可能错了？";
  const contextPrompt = checklist[2] || "消息/情绪只是背景，还是被我当成理由了？";
  const lastTraining = state.lastCompletedTraining || null;
  const lastDiagnosis = state.lastTrainingDiagnosis?.primary || null;
  const adaptiveLines = lastTraining
    ? [
      `【上次批改提醒】${lastTraining.biggestIssue || lastDiagnosis?.problem || "上一题提示：先把结构、失效条件和不做条件写清楚。"}`,
      `【本次只改一件事】${lastTraining.nextPractice || lastDiagnosis?.check || "这次先把当时可见证据写完整，再进入回放。"}`
    ]
    : [
      "【本次只改一件事】先把微课模板写完整：结构、判断、失效、背景/不做。"
    ];
  return [
    `【60秒微课概念】${concept}`,
    ...adaptiveLines,
    `【结构】${structurePrompt} 我看到 ${symbol} ${timeframe} 正在前高/区间附近，先确认价格有没有重新跌回区间。`,
    `【判断】我的课堂判断是：先按结构写证据，不把单根K线、新闻热度或情绪当成行动理由。`,
    `【失效】${invalidationPrompt} 如果价格重新跌回区间，或者我找不到清楚的失效位，就承认这次判断不成立。`,
    `【背景/不做】${contextPrompt} 我现在不做真实交易动作，只记录这是教育训练答案，下一步去同题回放检查有没有偷看未来。`,
  ].join("\n");
}
...
function renderCandles(target, candles, options = {}) {
  ...
  const background = `
    <rect x="0" y="0" width="${width}" height="${height}" rx="0" fill="#fbfcf8" />
    <rect x="${padding}" y="${padding}" width="${width - padding * 2}" height="${height - padding * 2}" rx="10" fill="#ffffff" stroke="#e1e7dd" />
  `;
  const grid = Array.from({ length: 5 }, (_, index) => {
    const y = padding + index * ((height - padding * 2) / 4);
    const value = max - index * (range / 4);
    return `
      <line x1="${padding}" x2="${width - padding}" y1="${y}" y2="${y}" stroke="#e5e9e1" />
      <text x="${width - padding + 6}" y="${y + 4}" fill="#7c8881" font-size="11" font-weight="700">${value.toFixed(1)}</text>
    `;
  }).join("");
  const verticalGrid = Array.from({ length: Math.min(6, candles.length) }, (_, index) => {
    const x = padding + index * ((width - padding * 2) / Math.max(1, Math.min(6, candles.length) - 1));
    return `<line x1="${x}" x2="${x}" y1="${padding}" y2="${height - padding}" stroke="#eef2eb" />`;
  }).join("");
  const volatilityMax = Math.max(1, ...candles.map(([open, high, low, close]) => Math.max(Math.abs(close - open), high - low)));
  const volumeBars = candles.map(([open, high, low, close], index) => {
    const x = padding + index * step + step / 2;
    const barHeight = Math.max(4, ((Math.max(Math.abs(close - open), high - low) / volatilityMax) * 34));
    const color = close >= open ? "rgba(32, 136, 91, 0.28)" : "rgba(183, 71, 63, 0.24)";
    return `<rect x="${x - bodyWidth / 2}" y="${height - padding - barHeight}" width="${bodyWidth}" height="${barHeight}" rx="2" fill="${color}" />`;
  }).join("");
  ...
  target.innerHTML = `${background}${grid}${verticalGrid}${volumeBars}${annotations}${bars}${callouts}${futureMask}`;
}
...
function renderContextTimeline(lesson) {
  ...
  const source = lesson.source || {};
  const market = source.marketData || {};
  const newsSource = source.news || {};
  const marketLabel = `${market.provider || "demo-market"} / ${market.license || "internal-demo-only"}`;
  const newsLabel = `${newsSource.provider || "demo-news"} / ${newsSource.license || "internal-demo-only"}`;
  nodes.contextTimeline.innerHTML = `
    <div class="historical-context-head">
      <div>
        <strong>历史情境包</strong>
        <span>这题先复原“当时能知道什么”，再训练结构和错因。</span>
      </div>
      <span class="tag warn">教育回顾</span>
    </div>
    <div class="historical-context-strip" aria-label="历史情境包摘要">
      <span><b>标的/周期</b>${escapeHtml(lesson.symbol || "DEMO")} / ${escapeHtml(timeframe)}</span>
      <span><b>行情来源</b>${escapeHtml(marketLabel)}</span>
      <span><b>新闻情绪来源</b>${escapeHtml(newsLabel)}</span>
      <span><b>训练目标</b>${escapeHtml(lesson.teachingGoal || lesson.tag || "结构、失效和情绪边界")}</span>
    </div>
    ...
    <div class="historical-context-task">
      <b>本题交付物</b>
      <span>写出结构、失效条件、消息/情绪边界和不做条件；AI 只批改学习过程，不输出买卖建议。</span>
    </div>
...
function buildSharpDiagnosis(feedback = {}, lastTraining = {}) {
  ...
  const categories = [
    {
      ...
      drill: "回放专项：遮住后半段K线，只写当时可见证据和未知信息。",
      template: "当时我只知道__，还不知道__，所以我只能__。",
      next: "去回放页，把同一题按时间顺序重写一次。",
    },
    {
      key: "thin_reasoning",
      label: "理由空泛",
      ...
      drill: "表达专项：把一句结论拆成“观察、判断、认错、不做”四句。",
      template: "我看到__，所以暂时判断__；如果__，我承认错；现在不做__。",
      next: "回到训练页，用作答模板重写当前题。",
    },
    {
      key: "invalidation",
      label: "没有失效条件",
      ...
      drill: "认错专项：先写失效位，再写课堂判断。",
      template: "如果价格__，说明我的判断不成立；在此之前我只__。",
      next: "下一题只看失效条件是否写清楚，不追求答得快。",
    },
    {
      key: "sentiment",
      label: "把情绪当理由",
      ...
      drill: "情绪边界专项：把新闻/情绪改写成“可能影响我判断的背景”。",
      template: "消息/情绪说明__，但不能替代结构；我的判断仍以__为准。",
      next: "去回放页核对当时可见信息，不用事后新闻补理由。",
    },
    {
      key: "structure",
      label: "结构判断不匹配",
      ...
      drill: "读图专项：先标前高、区间、跌回位置，再写课堂判断。",
      template: "当前价格在__附近；如果__，结构就降级；所以我先__。",
      next: "下一题先完成读图标注，再选择答案。",
    },
  ];
  ...
  if (!hits.length) {
    if (feedback.correct === false) hits.push(categories.find((item) => item.key === "structure"));
      ...
      drill: "稳定性专项：换一题继续用同一张检查表，确认不是偶然写对。",
      template: "结构__；失效__；背景__；我现在不做__。",
      next: "再练一题，检查是否还能保持同样的表达顺序。",
    });
  }
  const unique = [];
  hits.forEach((item) => {
  ...
  return `
    <div class="sharp-diagnosis-head">
      <div>
        ...
        <h4>最大问题：${escapeHtml(primary.label || "过程待复盘")}</h4>
        <span>${escapeHtml(primary.problem || "先把这次判断拆成可复盘证据。")}</span>
      </div>
      <span class="tag danger">先改过程</span>
    </div>
    <div class="correction-path-card" aria-label="纠错练习路径">
      <div>
        <p class="eyebrow">纠错练习</p>
        <strong>${escapeHtml(primary.drill || "用同一张检查表重写当前题。")}</strong>
      </div>
      <span><b>重写句式：</b>${escapeHtml(primary.template || "我看到__，如果__说明我错，所以现在只__。")}</span>
      <span><b>下一步：</b>${escapeHtml(primary.next || primary.check || "先去回放页按时间顺序复盘。")}</span>
    </div>
    <div class="sharp-diagnosis-grid">
      ${diagnosis.items.map((item) => `
        <article>
          ...
          <small class="correction-mini">${escapeHtml(item.drill || item.next || "用训练模板重写一次。")}</small>
        </article>
      `).join("")}
    </div>
...
async function submitDecision() {
  ...
  try {
    ...
    Promise.allSettled([
      ...
      if (failures.length) {
        console.warn("Post-submit learning panel refresh skipped", failures.map((item) => item.reason?.message || item.reason));
      }
    });
  } catch (error) {
    nodes.feedbackPanel.hidden = false;
...
function renderFeedback(feedback, nextTraining = null, courseProgressUpdates = state.data.courseProgressUpdates || []) {
  ...
  if (nodes.trainingResultActions) {
    ...
    const nextActionHtml = !cadence.shouldReplayFirst && nextTraining?.scenario
      ...
      : "";
    nodes.trainingResultActions.innerHTML = `
      <article class="coach-review-sheet" aria-label="AI教练批改单">
        <span class="coach-review-stamp">过程批改</span>
        <div>
          <p class="eyebrow">AI 教练批改单</p>
          <h4>这次不看对错输赢，只批改判断过程。</h4>
        </div>
        <dl>
          <div><dt>证据</dt><dd>${escapeHtml(lastTraining.title || currentScenario().title)} / ${escapeHtml(lastTraining.symbol || currentScenario().symbol)} / ${escapeHtml(lastTraining.timeframe || currentScenario().timeframe)}</dd></div>
          <div><dt>最大问题</dt><dd>${escapeHtml(lastTraining.biggestIssue || visibleMistakeDiagnosis(feedback))}</dd></div>
      ...
      <div class="attempt-row trial-next-row">
        <div>
          ...
          ${contextReviewHtml}
          ${courseProgressHtml}
          <span>${cadence.shouldReplayFirst ? cadence.reason : (nextTraining?.scenario ? `下一题：${nextTraining.scenario.title} / ${nextTrainingReasonText(nextTraining)}` : "暂无下一题，先去回放和AI复盘。")}</span>
        </div>
        <span class="tag warn">只做教育训练</span>
      </div>
      <div class="trial-flow-actions">
        <button type="button" data-training-result-action="replay">${cadence.shouldReplayFirst ? "先回放同题重写" : "去回放/回测误区"}</button>
...
function renderReplay() {
  ...
  renderScenarioSourceCard(lesson, "replay");
...
function renderReplayBridge(lesson, { step, isLastTraining } = {}) {
  ...
  const progress = Math.max(0, Math.min(100, Math.round((Number(step || 0) / Math.max(1, lesson.candles?.length || 1)) * 100)));
  bridge.innerHTML = `
    <div>
    ...
    <div class="replay-time-rail" aria-label="历史回放进度">
...
function paperTradeSideLabel(side = "") {
  if (side === "long") return "课堂看多假设";
  if (side === "short") return "课堂看空假设";
  return "观望 / 不做";
}
...
function renderEvidenceIntegrity(audit = state.data.evidenceIntegrity) {
  ...
  nodes.evidenceIntegrityPanel.innerHTML = `
    <div class="score-grid">
      <div><span>状态</span><strong>${escapeHtml(displayLearningStatus(summary.status || "unreviewed"))}</strong></div>
    ...
    ${dimensions.map((item) => `
      <div class="attempt-row">
        <div>
          <strong>${escapeHtml(item.label)}</strong>
          ${(item.evidence || []).map((evidence) => `<span>${escapeHtml(displayLearningText(evidence))}</span>`).join("")}
          <span>${escapeHtml(displayLearningText(item.nextAction || "Continue education-only evidence collection."))}</span>
        </div>
        <span class="tag ${String(item.status || "").includes("needs") || String(item.status || "").includes("too_small") ? "danger" : "warn"}">${escapeHtml(displayLearningStatus(item.status || "unreviewed"))}</span>
      </div>
    `).join("")}
    <ol class="clean-list">${(audit.nextLearningActions || []).map((item) => `<li>${escapeHtml(displayLearningText(item))}</li>`).join("")}</ol>
    <p class="muted-note">${escapeHtml(displayLearningText(audit.constraints?.[1] || "Education audit only; no stock recommendation, live signal, or real-money trading instruction."))}</p>
  `;
}
...
function renderBacktestClassroom(classroom = state.data.backtestClassroom) {
  ...
  const literacyRows = (literacyBrief?.rows || []).slice(0, 4).map((item) => `
    <div class="mini-row">
      <span>${escapeHtml(displayLearningText(item.section))} / ${escapeHtml(displayLearningText(item.item))} / ${escapeHtml(displayLearningStatus(item.status))}</span>
      <span>${escapeHtml(displayLearningText(item.next || ""))}</span>
    </div>
  `).join("");
  ...
  nodes.backtestClassroomPanel.innerHTML = `
    ...
    <div class="attempt-row">
      <div>
        <strong>${escapeHtml(displayLearningStatus(classroom.sampleQuality || "practice_sample_only"))}</strong>
        ${(classroom.interpretation || []).map((item) => `<span>${escapeHtml(displayLearningText(item))}</span>`).join("")}
        <span>${escapeHtml(displayLearningText(classroom.constraints?.[2] || "Metrics are learning diagnostics, not future performance proof."))}</span>
      </div>
      <span class="tag warn">只做教育训练</span>
    </div>
    <div class="attempt-row">
      <div>
        <strong>回测可信度：${escapeHtml(displayLearningStatus(reliabilityAudit.grade || "unreviewed"))}</strong>
        ${(reliabilityAudit.interpretation || []).map((item) => `<span>${escapeHtml(displayLearningText(item))}</span>`).join("")}
        ${(reliabilityAudit.riskFlags || []).slice(0, 4).map((item) => `<span>风险提醒：${escapeHtml(displayLearningText(item))}</span>`).join("")}
        <span>${escapeHtml(displayLearningText(reliabilityAudit.constraints?.[1] || "Reliability is education evidence quality only, not a signal or strategy score."))}</span>
      </div>
    ...
    ${literacyBrief ? `
      <div class="attempt-row">
        <div>
          ...
          <span>样本 ${literacyBrief.summary?.sampleSize || 0} / 可信度 ${escapeHtml(displayLearningStatus(literacyBrief.summary?.reliabilityGrade || "未复核"))} / 风险提醒 ${literacyBrief.summary?.riskFlags || 0} / 场景分组 ${literacyBrief.summary?.setupGroups || 0}</span>
          ${(literacyBrief.learnerBrief || []).slice(0, 3).map((item) => `<span>${escapeHtml(displayLearningText(item))}</span>`).join("")}
          <div class="mini-list">${literacyRows}</div>
          <span>${escapeHtml(displayLearningText(literacyBrief.constraints?.[2] || "Metrics are education diagnostics, not strategy proof."))}</span>
        </div>
    ...
    <div class="attempt-row">
      <div>
        ...
        <span>样本质量：${escapeHtml(displayLearningStatus(sampleModel.currentQuality || classroom.sampleQuality || "仅练习样本"))}; 对比同类结构至少需要 ${sampleModel.minimumForSetupComparison ?? 20}+ 条记录。</span>
        <span>${escapeHtml(displayLearningText(contextModel.note || "News and sentiment are context boundaries, not trade permission."))}</span>
        <span>${escapeHtml(displayLearningText(riskModel.note || "Risk metrics are classroom discipline checks, not real-money readiness."))}</span>
      </div>
    ...
    ${(reliabilityAudit.nextLearningActions || []).length ? `<ol class="clean-list">${reliabilityAudit.nextLearningActions.map((item) => `<li>${escapeHtml(displayLearningText(item))}</li>`).join("")}</ol>` : ""}
    ${setupDiagnosticsHtml}
    <ol class="clean-list">${(classroom.nextActions || []).map((item) => `<li>${escapeHtml(displayLearningText(item))}</li>`).join("")}</ol>
  `;
  ...
  nodes.backtestMisconceptionPanel.innerHTML = `
    <div class="attempt-row">
      <div>
        ...
        <span>${escapeHtml(displayLearningText(drill.requiredPrinciple || "Backtest metrics are education diagnostics only."))}</span>
      </div>
  ...
  nodes.contextClassroomPanel.innerHTML = `
    ...
    <div class="attempt-row">
      <div>
        ...
        ${(classroom.interpretation || []).map((item) => `<span>${escapeHtml(displayLearningText(item))}</span>`).join("")}
        <span>${escapeHtml(displayLearningText(classroom.constraints?.[1] || "No stock recommendation, live signal, or market prediction."))}</span>
      </div>
      <span class="tag warn">不是信号</span>
    </div>
    <div class="attempt-row">
      <div>
        ...
        <span>${escapeHtml(displayLearningStatus(riskSummary.operatingStatus || "needs_context_evidence"))} / 错误理解 ${riskSummary.wrongMisconceptionAttempts ?? 0} 次</span>
        ${riskSummary.dominantRisk ? `<span>主要风险：${escapeHtml(displayLearningText(riskSummary.dominantRisk.label))} - ${escapeHtml(displayLearningText(riskSummary.dominantRisk.educationResponse))}</span>` : `<span>${escapeHtml(displayLearningText("No dominant context-risk pattern yet; keep collecting education evidence."))}</span>`}
        ${(riskSummary.coachActions || []).slice(0, 3).map((item) => `<span>${escapeHtml(displayLearningText(item))}</span>`).join("")}
        <span>${escapeHtml(displayLearningText(riskSummary.constraints?.[1] || "Not sentiment scoring, market prediction, signal, or recommendation."))}</span>
      </div>
      <span class="tag danger">不是预测</span>
    </div>
    ${contextRiskItems.length ? `
      <div class="section-kicker">已观察到的环境风险</div>
      ${contextRiskItems.map((item) => `
        <div class="attempt-row">
          <div>
            <strong>${escapeHtml(item.label)}</strong>
            <span>${escapeHtml(displayLearningText(`${item.count} observed item(s)`))}</span>
            <span>${escapeHtml(displayLearningText(item.educationResponse))}</span>
          </div>
          <span class="tag warn">教练提示</span>
        </div>
      `).join("")}
    ` : ""}
...
function renderLearningPath(path = state.data.learningPath) {
  ...
  const lastTraining = state.lastCompletedTraining;
  const trend = buildMistakeTrendPlan(state.data.profile || {}, state.data.attempts || [], lastTraining);
  if (!path) {
    nodes.learningPathPanel.innerHTML = lastTraining
      ? `
        ${mistakeTrendPlanHtml(trend)}
        <div class="attempt-row trial-next-row">
          <div>
  ...
  const primaryCoursePackage = learnerCoursePathItems()[0] || {
    title: "价格行为入门路线",
    canAccess: true,
    progress: {
      percent: lastTraining ? 20 : 0,
      completedItems: lastTraining ? 1 : 0,
      totalItems: 7,
      completedKnowledgePointIds: [],
      completedScenarioIds: lastTraining ? [lastTraining.scenarioId] : [],
      completedBacktestDrillIds: [],
      completedContextDrillIds: [],
      completedSourceTransparencyDrillIds: [],
    },
    knowledgePoints: path.recommendedKnowledgePoint ? [path.recommendedKnowledgePoint] : [],
    scenarios: path.recommendedScenario ? [path.recommendedScenario] : [],
    backtestDrills: [{ id: "backtest_misconception", title: "样本太少时，不读胜率和收益" }],
    contextDrills: [{ id: "context_boundary", title: "新闻和情绪只做背景边界" }],
    sourceTransparencyDrills: [{ id: "source_label", title: "确认 demo、公开预览或授权标签" }],
  };
  nodes.learningPathPanel.innerHTML = `
    ${mistakeTrendPlanHtml(trend)}
    ${courseRoadmapHtml(primaryCoursePackage, { path, lastTraining })}
    <div class="attempt-row trial-next-row">
      <div>
...
function courseAccessLabel(item = {}) {
  if (item.canAccess) return item.enrolled ? "正在学习" : "可开始";
  return "先预览";
}

function courseAssignmentText(item = {}) {
  if (item.coursePackageAssignment) {
    return `已安排：${formatTime(item.coursePackageAssignment.createdAt)}${item.coursePackageAssignment.dueAt ? ` / 截止 ${item.coursePackageAssignment.dueAt}` : ""}`;
  }
  if (item.enrolled) return "已加入学习路径";
  return "可作为下一段课程预览";
}

function courseProgressText(item = {}) {
  const progress = item.progress || {};
  return `课程进度 ${progress.percent || 0}%：已完成 ${progress.completedItems || 0}/${progress.totalItems || 0} 个学习节点`;
}

function courseCompletionText(item = {}) {
  return item.completionReport
    ? `结课复盘已生成：${formatTime(item.completionReport.createdAt)} / 纪律分 ${item.completionReport.practiceSummary.averageRiskDiscipline ?? "--"}`
    : "完成全部学习节点后，才生成结课复盘。";
}

function courseScopeText(item = {}) {
  const knowledgeTotal = (item.knowledgePoints || []).length;
  const scenarioTotal = (item.scenarios || []).length;
  const lockedKnowledge = item.lockedCounts?.knowledgePoints || 0;
  const lockedScenarios = item.lockedCounts?.scenarios || 0;
  return `本段包含 ${knowledgeTotal} 个概念、${scenarioTotal} 道训练题${lockedKnowledge || lockedScenarios ? `；另有 ${lockedKnowledge + lockedScenarios} 个节点待解锁` : ""}`;
}

function courseRoadmapNodes(item = {}, path = state.data.learningPath, lastTraining = state.lastCompletedTraining) {
  const progress = item.progress || {};
  const nextKnowledge = (item.knowledgePoints || []).find((kp) => !(progress.completedKnowledgePointIds || []).includes(kp.id));
  const nextScenario = (item.scenarios || []).find((scenario) => !(progress.completedScenarioIds || []).includes(scenario.id));
  const nextBacktestDrill = (item.backtestDrills || []).find((drill) => !(progress.completedBacktestDrillIds || []).includes(drill.id));
  const nextContextDrill = (item.contextDrills || []).find((drill) => !(progress.completedContextDrillIds || []).includes(drill.id));
  const nextSourceDrill = (item.sourceTransparencyDrills || []).find((drill) => !(progress.completedSourceTransparencyDrillIds || []).includes(drill.id));
  const pct = Number(progress.percent || 0);
  return [
    {
      step: "1",
      title: "先学概念",
      body: nextKnowledge ? nextKnowledge.title : path?.recommendedKnowledgePoint?.title || "结构、失效和消息边界",
      status: nextKnowledge ? "当前" : "已完成",
    },
    {
      step: "2",
      title: "再做训练",
      body: nextScenario ? nextScenario.title : path?.recommendedScenario?.title || "完成一题课堂判断",
      status: nextScenario ? "当前" : "已完成",
    },
    {
      step: "3",
      title: "同题回放",
      body: lastTraining ? "回放刚才那题，写当时知道和不知道什么。" : "完成第一题后解锁同题回放。",
      status: lastTraining ? "当前" : "待完成",
    },
    {
      step: "4",
      title: "回测误区",
      body: nextBacktestDrill ? nextBacktestDrill.title : "样本太少时不能读胜率或收益。",
      status: nextBacktestDrill ? "待完成" : "已覆盖",
    },
    {
      step: "5",
      title: "新闻情绪",
      body: nextContextDrill ? nextContextDrill.title : "消息和情绪只做背景，不替代结构。",
      status: nextContextDrill ? "待完成" : "已覆盖",
    },
    {
      step: "6",
      title: "来源透明",
      body: nextSourceDrill ? nextSourceDrill.title : "确认 demo、公开预览或授权数据标签。",
      status: nextSourceDrill ? "待完成" : "已覆盖",
    },
    {
      step: "7",
      title: "结课复盘",
      body: item.completionReport ? "已生成结课复盘。" : `当前 ${pct}%：先补齐前面节点。`,
      status: item.completionReport ? "已完成" : "未完成",
    },
  ];
}

function courseRoadmapHtml(item = {}, options = {}) {
  const nodes = courseRoadmapNodes(item, options.path, options.lastTraining);
  return `
    <section class="course-roadmap" aria-label="课程路线图">
      <div class="course-roadmap-head">
        <div>
          <p class="eyebrow">课程路线图</p>
          <h4>${escapeHtml(item.title || "当前学习路径")}</h4>
          <span>${courseProgressText(item)}</span>
        </div>
        <span class="tag warn">教育训练</span>
      </div>
      <div class="course-roadmap-grid">
        ${nodes.map((node) => `
          <article class="${node.status === "当前" ? "is-current" : ""}">
            <b>${escapeHtml(node.step)}</b>
      ...
      <small>这条路线只安排学习任务，不评价策略收益，不输出实盘信号。</small>
    </section>
  `;
}

function buildMistakeTrendPlan(profile = {}, attempts = [], lastTraining = null) {
  const profileEntries = Object.entries(profile || {})
    .map(([tag, count]) => ({ tag, count: Number(count) || 0 }))
    .filter((item) => item.count > 0)
    .sort((a, b) => b.count - a.count)
    .slice(0, 3);
  const trainingAttempts = (attempts || []).filter((item) => item.type === "training").slice(0, 6);
  const recentTags = trainingAttempts.flatMap((item) => item.tags || []);
  const recentCounts = recentTags.reduce((acc, tag) => {
    acc[tag] = (acc[tag] || 0) + 1;
    return acc;
  }, {});
  const top = profileEntries[0] || Object.entries(recentCounts)
    .map(([tag, count]) => ({ tag, count }))
    .sort((a, b) => b.count - a.count)[0] || null;
  const fallbackText = lastTraining?.biggestIssue || "";
  const plan = mistakeTrendPrescription(top?.tag || fallbackText);
  const repeated = top ? (recentCounts[top.tag] || 0) : 0;
  return {
    active: Boolean(top || fallbackText),
    tag: top?.tag || "当前题错因",
    label: top ? displayProfileTag(top.tag) : "当前题错因",
    count: top?.count || 1,
    repeated,
    recentAttemptCount: trainingAttempts.length,
    ...plan,
  };
}

function mistakeTrendPrescription(tag = "") {
  const text = String(tag || "");
  if (/偷看|未来|倒推|hindsight|replay|回放/i.test(text)) {
    return {
      focus: "反偷看未来专项",
      why: "你需要先固定“当时可见信息”，再看后续走势。",
      drill: "连续做 2 次回放遮挡练习，每次先写当时不知道什么。",
      template: "当时我只知道__，还不知道__，所以我只能__。",
    };
  }
  if (/context|背景|sentiment|情绪|新闻|消息|热度|财报/i.test(text)) {
    return {
      focus: "消息情绪边界专项",
      why: "你容易把背景写成行动理由，需要把它放回偏见检查栏。",
      drill: "下一题只训练一句话：消息说明背景，但不能替代结构和失效条件。",
      template: "消息/情绪说明__，但我的判断仍以__为准。",
    };
  }
  if (/risk|invalidation|失效|风险|认错|止损/i.test(text)) {
    return {
      focus: "失效条件专项",
      why: "你需要先写哪里说明自己错了，再写课堂判断。",
      drill: "下一题先写失效位，不写清楚就不进入选择。",
      template: "如果价格__，说明判断不成立；在此之前我只__。",
    };
  }
  if (/thin|reason|理由|证据|空泛|太短/i.test(text)) {
    return {
      focus: "表达证据专项",
      why: "你的答案需要从一句结论拆成可复盘证据链。",
      drill: "把答案拆成四句：看到什么、怎么判断、哪里认错、不做什么。",
      template: "我看到__，所以暂时判断__；如果__，我承认错；现在不做__。",
    };
  }
  return {
    focus: "结构读图专项",
    why: "先把前高、区间、跌回和等待条件标清楚，再写判断。",
    drill: "下一题先完成读图标注，再选择课堂答案。",
    template: "当前价格在__附近；如果__，结构就降级；所以我先__。",
  };
}

function mistakeTrendPlanHtml(trend) {
  if (!trend?.active) return "";
  const repeatedText = trend.recentAttemptCount
    ? `最近 ${trend.recentAttemptCount} 次训练里出现 ${trend.repeated || 1} 次相关错因。`
    : "完成更多题后，这里会变成更稳定的跨题画像。";
  return `
    <section class="mistake-trend-card" aria-label="跨题错因趋势">
      <div>
        <p class="eyebrow">跨题学习路径</p>
        <h4>${escapeHtml(trend.focus)}</h4>
        <span>${escapeHtml(repeatedText)} 累计画像：${escapeHtml(trend.label)} x${trend.count}。</span>
      </div>
      <article>
        <strong>为什么先练这个</strong>
        <span>${escapeHtml(trend.why)}</span>
      </article>
      <article>
        <strong>下一步专项</strong>
        <span>${escapeHtml(trend.drill)}</span>
      </article>
      <article>
        <strong>重写句式</strong>
        <span>${escapeHtml(trend.template)}</span>
      </article>
      <small>这里只规划学习路径，不评价策略收益，不输出实盘信号。</small>
    </section>
  `;
}
...
function renderLearnerCoursePath() {
  ...
  nodes.learnerCoursePathList.innerHTML = items.length
    ? items.map((item) => {
      ...
      return `
        ${courseRoadmapHtml(item, { path: state.data.learningPath, lastTraining: state.lastCompletedTraining })}
        <div class="attempt-row">
          <div>
            <strong>${escapeHtml(item.title)}</strong>
            <span>${courseProgressText(item)}</span>
            <span>${courseAssignmentText(item)}</span>
            <span>${nextKnowledge ? `下一段概念：${escapeHtml(nextKnowledge.title)}` : "可见概念已学完。"}</span>
            <span>${nextScenario ? `下一道训练：${escapeHtml(nextScenario.title)}` : "当前可见训练题已完成。"}</span>
            <span>${nextBacktestDrill ? `下一步误区练习：${escapeHtml(nextBacktestDrill.title)}` : "回测指标误区已练完。"}</span>
            <span>${nextContextDrill ? `下一步背景练习：${escapeHtml(nextContextDrill.title)}` : "新闻/情绪背景练习已完成。"}</span>
            <span>${nextSourceDrill ? `下一步来源练习：${escapeHtml(nextSourceDrill.title)}` : "数据来源标签练习已完成。"}</span>
            <span>${escapeHtml(item.constraints?.[1] || "只做教育训练，不输出交易建议。")}</span>
          </div>
          <div class="billing-actions">
            ${nextKnowledge ? `<button type="button" data-course-progress="knowledge" data-course-package-id="${escapeHtml(item.id)}" data-knowledge-point-id="${escapeHtml(nextKnowledge.id)}">标记概念已学</button>` : ""}
            ${nextScenario ? `<button type="button" data-course-scenario-id="${escapeHtml(nextScenario.id)}">练这道题</button>` : ""}
            ${nextBacktestDrill ? `<button type="button" data-course-backtest-drill="${escapeHtml(nextBacktestDrill.id)}">练回测误区</button>` : ""}
            ${nextContextDrill ? `<button type="button" data-course-context-drill="${escapeHtml(nextContextDrill.id)}">练新闻/情绪边界</button>` : ""}
            ${nextSourceDrill ? `<button type="button" data-course-source-drill="${escapeHtml(nextSourceDrill.id)}">看数据来源</button>` : ""}
            <span class="tag ${item.canAccess ? "warn" : "danger"}">${item.canAccess ? "学习路径" : "仅预览"}</span>
          </div>
        </div>
      `;
    }).join("")
    : "<p>进入学习体验后，这里会显示课程路径和下一步训练。</p>";
}
...
function renderTrialOutcomePromise() {
  ...
  panel.innerHTML = `
    ...
    <div class="trial-training-map" aria-label="训练坐标">
      <article>
        <b>价格结构</b>
        <span>先写趋势、区间、前高前低，不直接猜涨跌。</span>
      </article>
      <article>
        <b>多周期</b>
        <span>D1/H4 看背景，H1/M15 看结构和失效。</span>
      </article>
      <article>
        <b>新闻情绪</b>
        <span>只记录背景和偏见风险，不当作行动理由。</span>
      </article>
      <article>
        <b>AI复盘</b>
        <span>只指出学习过程问题，不给实盘建议。</span>
      </article>
    </div>
    <div class="section-head">
      <div>
...
function renderDashboard() {
  const habit = state.data.habit || {};
  const dailyGoal = habit.dailyGoal || 3;
  const todayDone = habit.todayDone ?? state.data.user.todayDone ?? 0;
  nodes.todayDone.textContent = `${Math.min(todayDone, dailyGoal)} / ${dailyGoal}`;
...
function renderNotifications(summary = state.data.notifications) {
  ...
  nodes.notificationStatus.textContent = `待处理 ${summary.summary?.total || 0} 项：未读 ${summary.summary?.unread || 0}、练习 ${summary.summary?.openAssignments || 0}、下一步 ${summary.summary?.nextLearningProducts || 0}、教练预约 ${summary.summary?.coachSessions || 0}、支持回复 ${summary.summary?.supportReplies || 0}。`;
  nodes.notificationList.innerHTML = summary.notifications?.length
    ...
    `).join("")
    : "<p>当前没有新的教练提醒或分配练习。先完成一题训练，再看回放和 AI 复盘。</p>";
}
...
function renderAchievements(summary = state.data.achievements) {
  ...
  nodes.achievementStatus.textContent = `已完成 ${summary.unlockedCount}/${summary.totalCount}${summary.latestUnlocked ? ` / 最新：${summary.latestUnlocked.title}` : ""}`;
  nodes.achievementList.innerHTML = (summary.achievements || []).map((item) => `
    <div class="attempt-row">
      <div>
        <strong>${item.title}</strong>
        <span>${item.description}</span>
        <span>进度 ${item.progress}/${item.target}${item.unlockedAt ? ` / 完成于 ${formatTime(item.unlockedAt)}` : ""}</span>
      </div>
      <span class="tag ${item.unlocked ? "warn" : ""}">${item.unlocked ? "已完成" : "未完成"}</span>
    </div>
  `).join("");
}
...
function renderCompliance(compliance = state.data.compliance) {
  ...
  if (!compliance) {
    nodes.complianceStatus.textContent = "进入学习体验后自动确认教育风险说明。";
...
function renderSession() {
  ...
  const roleLabel = session?.role === "admin" ? "管理员" : session?.role === "student" ? "学习体验" : "学习入口";
...
async function refreshFriendProviderStatus() {
  ...
  try {
    ...
    nodes.friendProviderStatus.innerHTML = `<p>AI 模式检查失败：${escapeHtml(error.message)}。当前仍按本地 demo / mock provider 体验处理。</p>`;
  }
}
...
async function submitFriendTrialFeedback() {
  ...
  try {
    ...
    const message = [
      ...
      "说明：这是一条学习体验反馈，只评价学习流程，不评价策略收益。",
    ].join("\n");
    const result = await api("/api/support/tickets", {
      method: "POST",
      body: JSON.stringify({
        category: "learning",
        subject: "学习体验反馈：学习流程是否有帮助",
        message,
      }),
    });
    state.data.supportTickets = result.tickets || [result.ticket];
...
function bindEvents() {
  ...
  document.addEventListener("click", (event) => {
    const button = event.target.closest("[data-quick-start-answer]");
    if (!button) return;
    if (state.selected === null) {
      const firstTrainingOption = nodes.options?.querySelector(".option-btn");
      firstTrainingOption?.click();
    }
    if (nodes.planInput && !nodes.planInput.value.trim()) {
      nodes.planInput.value = trainingPlanExample(currentScenario());
      renderTrainingFocusRail();
    }
    document.querySelector("#decisionArea")?.scrollIntoView({ behavior: "smooth", block: "start" });
    setTimeout(() => {
  ...
  document.addEventListener("click", (event) => {
    const button = event.target.closest("[data-today-practice-scenario]");
    if (!button) return;
    selectScenarioById(button.dataset.todayPracticeScenario);
    document.querySelector("#teachingIntroPanel")?.scrollIntoView({ behavior: "smooth", block: "start" });
  });
  document.addEventListener("click", (event) => {
  ...
  nodes.refreshKnowledgeBrowser?.addEventListener("click", () => loadKnowledgeBrowser({ force: true }));
  nodes.knowledgeBrowserModuleList?.addEventListener("click", (event) => {
    const button = event.target.closest("[data-knowledge-module]");
    if (!button) return;
    loadKnowledgeModule(button.dataset.knowledgeModule);
  });
  nodes.knowledgeBrowserNodeList?.addEventListener("click", (event) => {
    const button = event.target.closest("[data-knowledge-node]");
    if (!button) return;
    loadKnowledgeNode(button.dataset.knowledgeNode);
  });
  nodes.knowledgeBrowserEvidence?.addEventListener("click", (event) => {
    const button = event.target.closest("[data-load-knowledge-evidence]");
    if (!button) return;
    loadKnowledgeEvidence(button.dataset.loadKnowledgeEvidence);
  });
  nodes.knowledgeBrowserLocalCourse?.addEventListener("click", (event) => {
    const inputQueueDetailButton = event.target.closest("[data-input-queue-detail]");
    if (inputQueueDetailButton) {
      loadKnowledgeFirstReviewerInputDetail(inputQueueDetailButton.dataset.inputQueueDetail);
      return;
    }
    const inputQueueButton = event.target.closest("[data-input-queue-query]");
    if (inputQueueButton) {
      loadKnowledgeFirstReviewerInputQueue(inputQueueButton.dataset.inputQueueQuery);
      return;
    }
    const rowQueryButton = event.target.closest("[data-reviewer-row-query]");
    if (rowQueryButton) {
      loadKnowledgeReviewerRowBrowser(rowQueryButton.dataset.reviewerRowQuery);
      return;
    }
    const rowDetailButton = event.target.closest("[data-reviewer-row-detail]");
    if (rowDetailButton) {
      loadKnowledgeReviewerRowDetail(rowDetailButton.dataset.reviewerRowDetail);
      return;
    }
    const packetButton = event.target.closest("[data-source-fit-packet]");
    if (!packetButton) return;
    loadKnowledgeSourceFitPacket(packetButton.dataset.sourceFitPacket);
  });
  nodes.knowledgeBrowserLocalCourse?.addEventListener("submit", (event) => {
    const inputQueueForm = event.target.closest("[data-input-queue-form]");
    if (inputQueueForm) {
      event.preventDefault();
      const formData = new FormData(inputQueueForm);
      const params = new URLSearchParams();
      for (const key of ["itemType", "route", "q"]) {
        const value = String(formData.get(key) || "").trim();
        if (value) params.set(key, value);
      }
      const limit = Math.max(1, Math.min(Number.parseInt(String(formData.get("limit") || "80"), 10) || 80, 200));
      params.set("limit", String(limit));
      loadKnowledgeFirstReviewerInputQueue(params.toString());
      return;
    }
    const form = event.target.closest("[data-reviewer-row-form]");
    if (!form) return;
    event.preventDefault();
    const formData = new FormData(form);
    const params = new URLSearchParams();
    for (const key of ["packet", "family", "q"]) {
      const value = String(formData.get(key) || "").trim();
      if (value) params.set(key, value);
    }
    const limit = Math.max(1, Math.min(Number.parseInt(String(formData.get("limit") || "80"), 10) || 80, 200));
    params.set("limit", String(limit));
    loadKnowledgeReviewerRowBrowser(params.toString());
  });
  nodes.knowledgeBrowserCurriculum?.addEventListener("click", (event) => {
    const button = event.target.closest("[data-knowledge-path]");
    if (!button) return;
    loadKnowledgePath(button.dataset.knowledgePath);
  });
