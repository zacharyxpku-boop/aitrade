...
const validationPath = "docs/LOCAL_COURSE_5_MODULE_DISTILLATION_REVIEW_BATCH_001_INPUT_VALIDATION.json";
const validationMdPath = "docs/LOCAL_COURSE_5_MODULE_DISTILLATION_REVIEW_BATCH_001_INPUT_VALIDATION.md";
...
if (report.validationStatus !== "course_5_module_distillation_batch_001_input_blocked_missing_or_invalid_real_input") {
  fail(`unexpected validationStatus for blank template: ${report.validationStatus}`);
}
if (report.inputRows !== 40) fail("validation must cover batch 001 40 rows");
