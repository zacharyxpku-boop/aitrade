...
const batchPath = "docs/LOCAL_COURSE_HIGH_RES_TRANSCRIPTION_CANDIDATE_BATCH_03.json";
...
for (const flag of ["historical_origin_language", "public_grounding_required", "ohlc_definition_language"]) {
