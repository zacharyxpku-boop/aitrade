...
const previewPath = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_MERGE_PREVIEW.json";
...
if (preview.mergePreviewStatus !== "packet_merge_preview_blocked_missing_ready_packet_input") {
...
if (preview.packetId !== "node-public-source-fit-batch-001-packet") fail("merge preview must target packet 001");
...
if (!Array.isArray(preview.commands) || !preview.commands.some((item) => item.includes("check:knowledge-node-public-source-fit-review-packet-merge-preview"))) {
