...
const outputJson = "docs/LOCAL_COURSE_5_WAVE_2_P1_EXECUTION_PACK.json";
const outputMd = "docs/LOCAL_COURSE_5_WAVE_2_P1_EXECUTION_PACK.md";
const outputHtml = "docs/local-course-5-wave-2-p1-execution-pack.html";

const boundary = "Course 5 Wave 2 P1 execution pack is private reviewer-facing education operations material. It isolates the two P1 high-value source blockers and their representative ZIP/PDF visual samples for real reviewer-owned visual or OCR input, future validation, semantic merge preview, public grounding, and deletion-readiness recomputation. It does not perform OCR, generate reviewer conclusions, accept machine drafts as human review, merge content into learner-facing modules, delete files, approve source-folder deletion, approve learner-facing release, copy private source wording, provide stock recommendations, live signals, return promises, broker workflows, automation, real-money guidance, write authorization, or production readiness.";
...
const waveRows = priorityPlan.priorityRows.filter((row) => row.resolutionWave === "wave_2_p1_high_value_blockers");
...
const executionPack = {
  ...
  approvalStatus: "not_approved",
  writeAllowedNow: false,
  executionPackStatus: "course_5_wave_2_p1_execution_pack_ready_blocked_on_real_reviewer_input",
  waveId: "wave_2_p1_high_value_blockers",
  ...
  nextOperationalGates: [
    "Fill reviewer-owned input for the 12 P1 ZIP image samples and re-run ZIP priority validation.",
    "Provide OCR or reviewer-owned visual/text notes for the 3 P1 PDF representative pages and re-run PDF priority validation.",
  ...
  commands: [
    "npm.cmd run build:local-course-5-wave-2-p1-execution-pack",
    "npm.cmd run check:local-course-5-wave-2-p1-execution-pack",
    "npm.cmd run verify",
  ],
  completionRule: "This Wave 2 pack is complete when the 2 P1 high-value blocker source rows and their 15 representative ZIP/PDF sample rows are isolated with reviewer-owned input requirements, validation routes, and release/deletion gates closed.",
  boundary,
};
...
<head>
  ...
  <title>Course 5 Wave 2 P1 Execution Pack</title>
  <style>
...
<body>
  <header>
    <h1>Course 5 Wave 2 P1 Execution Pack</h1>
