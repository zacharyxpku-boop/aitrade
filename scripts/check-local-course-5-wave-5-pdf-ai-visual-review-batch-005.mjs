...
const inputPath = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_5_PDF_AI_VISUAL_REVIEW_BATCH_005_INPUT.json";
const validationPath = "docs/LOCAL_COURSE_5_WAVE_5_PDF_AI_VISUAL_REVIEW_BATCH_005_VALIDATION.json";
...
if (input.inputTemplateStatus !== "course_5_wave_5_pdf_ai_visual_review_batch_005_twelve_rows_ready_for_reviewer_confirmation") fail("unexpected input status");
if (validation.validationStatus !== "course_5_wave_5_pdf_ai_visual_review_batch_005_partially_ready_release_and_deletion_blocked") fail("unexpected validation status");
if (validation.validationMode !== "wave_5_pdf_ai_visual_review_batch_005_gate") fail("unexpected validation mode");
...
const expectedIds = input.rows.slice(48, 60).map((row) => row.reviewRowId);
