...
const selectedPacketId = "node-public-source-fit-batch-002-packet";
const outputJson = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE.json";
const outputMd = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE.md";
const inputCopyJson = "docs/reviewer-inputs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE.json";
const inputCopyMd = "docs/reviewer-inputs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE.md";
const validationJson = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE_VALIDATION.json";
const validationMd = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_002_INPUT_COPY_TEMPLATE_VALIDATION.md";
...
const inputCopy = {
  ...
  validatorCommand: `node scripts/validate-knowledge-node-public-source-fit-review-input.mjs --input ${inputCopyJson} --output-json ${validationJson} --output-md ${validationMd}`,
...
const template = {
  ...
  learnerFacingRelease: false,
  approvalStatus: "not_approved",
  templateStatus: "node_public_source_fit_packet_002_input_copy_template_ready_blank",
  templateMode: "second_blocked_packet_scoped_input_copy_for_real_reviewer",
  ...
  validationOutputPath: validationJson,
  validationMarkdownPath: validationMd,
  ...
  commands: [
    "npm.cmd run build:knowledge-node-public-source-fit-review-packet-002-input-copy-template",
...
fs.writeFileSync(inputCopyMd, [
  "# Knowledge Node Public Source-Fit Review Packet 002 Input Copy Template",
  "",
