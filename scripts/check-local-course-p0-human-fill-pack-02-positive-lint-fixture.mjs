...
const fixturePath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02_POSITIVE_LINT_FIXTURE.json";
const lintPath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02_POSITIVE_LINT_FIXTURE_LINT.json";
const validationPath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02_POSITIVE_LINT_FIXTURE_VALIDATION.json";
const applyPath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02_POSITIVE_LINT_FIXTURE_APPLY_REPORT.json";
...
if (fixture.templateStatus !== "pack_02_positive_lint_fixture") fail(`unexpected fixture status: ${fixture.templateStatus}`);
...
if (lint.packId !== "local_course_p0_human_fill_pack_02") fail(`unexpected lint packId: ${lint.packId}`);
...
for (const flag of ["signal_language", "forecast_language", "support_resistance_language", "study_advice_language", "source_recommendation_language"]) {
  if (!fixtureFlags.has(flag)) fail(`fixture must cover high-risk flag ${flag}`);
}
