...
const reportPath = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_MERGE_APPLY_REPORT.json";
...
if (report.packetId !== "node-public-source-fit-batch-001-packet") fail("report must target packet 001");
