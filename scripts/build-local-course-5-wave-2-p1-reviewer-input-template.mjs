...
const outputJson = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_2_P1_REVIEWER_INPUT_TEMPLATE.json";
const outputMd = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_2_P1_REVIEWER_INPUT_TEMPLATE.md";

const boundary = "Course 5 Wave 2 P1 reviewer input template is private reviewer-facing education operations material. It provides blank reviewer-owned input rows for the two P1 high-value source blockers and their representative ZIP/PDF samples. It does not perform OCR, generate reviewer conclusions, accept machine drafts as human review, merge content into learner-facing modules, delete files, approve source-folder deletion, approve learner-facing release, copy private source wording, provide stock recommendations, live signals, return promises, broker workflows, automation, real-money guidance, write authorization, or production readiness.";
...
assertBoundary("Wave 2 P1 execution pack", pack);
...
const template = {
  ...
  approvalStatus: "not_approved",
  writeAllowedNow: false,
  inputTemplateStatus: "course_5_wave_2_p1_reviewer_input_template_ready_blocked_missing_input",
  ...
  rows,
  completionRule: "This template is complete when all 15 Wave 2 P1 sample rows are present as blank reviewer-owned input rows and all release, write, module-merge, and source-deletion gates remain closed.",
  boundary,
};
...
fs.writeFileSync(outputMd, [
  "# Course 5 Wave 2 P1 Reviewer Input Template",
  "",
