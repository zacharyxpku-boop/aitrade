...
const handoffPath = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_001_HANDOFF.json";
const handoffMdPath = "docs/KNOWLEDGE_NODE_PUBLIC_SOURCE_FIT_REVIEW_PACKET_001_HANDOFF.md";
...
if (handoff.handoffStatus !== "node_public_source_fit_packet_001_handoff_ready_blocked_on_real_input") {
...
if (handoff.packetId !== "node-public-source-fit-batch-001-packet") fail("handoff must target packet 001");
if (!/PACKET_001_INPUT_COPY_TEMPLATE/.test(handoff.inputCopyPath || "")) fail("handoff must expose packet 001 input copy path");
...
const requiredPhaseIds = [
  "inspect_packet_input_copy_template",
  "validate_packet_input_copy",
  "rebuild_merge_preview",
  "run_merge_apply_dry_run",
...
for (const phrase of [
  "check:knowledge-node-public-source-fit-review-packet-001-handoff",
  "check:knowledge-node-public-source-fit-review-packet-input-copy-template",
