...
if (pack.packId !== "local_course_p0_human_fill_pack_01") fail(`unexpected packId: ${pack.packId}`);
...
for (const flag of ["source_provenance_language", "historical_origin_language", "public_grounding_required", "ohlc_definition_language"]) {
