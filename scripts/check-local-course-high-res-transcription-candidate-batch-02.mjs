...
const batchPath = "docs/LOCAL_COURSE_HIGH_RES_TRANSCRIPTION_CANDIDATE_BATCH_02.json";
...
for (const flag of ["specific_price_levels", "signal_language", "risk_control_language", "stop_loss_language"]) {
