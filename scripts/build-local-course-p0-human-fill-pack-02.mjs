...
const outputJsonPath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02.json";
const outputMdPath = "docs/LOCAL_COURSE_P0_HUMAN_FILL_PACK_02.md";

const targetTaskIds = [
  "absorb_manual_transcription_13",
  "absorb_manual_transcription_14",
  "absorb_manual_transcription_15",
  "absorb_manual_transcription_16",
];
...
const packCards = targetTaskIds.map((taskId) => {
  ...
  return {
    ...
    qualityLintRules: [
      ...
      "riskRewriteNotes must address every riskTermFlag before validation, especially signal, forecast, support/resistance, homework, and source-recommendation language.",
      "publicReferenceNotes must name public grounding needed for candlestick terminology, pattern taxonomy, support/resistance claims, or source recommendations.",
...
const pack = {
  ...
  learnerFacingRelease: false,
  approvalStatus: "not_approved",
  packId: "local_course_p0_human_fill_pack_02",
  packStatus: "blank_human_fill_pack_ready",
  sourceNoteTemplate: noteTemplatePath,
  selectionRationale: "Second human-fill pack uses corpus_1580 pages 5-8 because they contain candlestick anatomy, pattern taxonomy, signal-like wording, and homework/source notes that need strict human review before any education-only rewrite.",
...
fs.writeFileSync(outputMdPath, [
  "# Local Course P0 Human Fill Pack 02",
  "",
  "Blank human-fill execution packet for the second candidate-assisted P0 manual transcription cards.",
  "",
