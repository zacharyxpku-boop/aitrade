...
const inputPath = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_5_PDF_AI_VISUAL_REVIEW_BATCH_001_INPUT.json";
const validationPath = "docs/LOCAL_COURSE_5_WAVE_5_PDF_AI_VISUAL_REVIEW_BATCH_001_VALIDATION.json";
...
if (input.inputTemplateStatus !== "course_5_wave_5_pdf_ai_visual_review_batch_001_twelve_rows_ready_for_reviewer_confirmation") fail("unexpected input status");
if (validation.validationStatus !== "course_5_wave_5_pdf_ai_visual_review_batch_001_partially_ready_release_and_deletion_blocked") fail("unexpected validation status");
if (validation.validationMode !== "wave_5_pdf_ai_visual_review_batch_001_gate") fail("unexpected validation mode");
...
const expectedIds = input.rows.slice(0, 12).map((row) => row.reviewRowId);
