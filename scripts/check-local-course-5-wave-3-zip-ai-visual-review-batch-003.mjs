...
const inputPath = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_3_ZIP_AI_VISUAL_REVIEW_BATCH_003_INPUT.json";
const inputMdPath = "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_3_ZIP_AI_VISUAL_REVIEW_BATCH_003_INPUT.md";
const validationPath = "docs/LOCAL_COURSE_5_WAVE_3_ZIP_AI_VISUAL_REVIEW_BATCH_003_VALIDATION.json";
...
if (input.inputTemplateStatus !== "course_5_wave_3_zip_ai_visual_review_batch_003_twelve_rows_ready_for_reviewer_confirmation") fail("unexpected batch input status");
if (validation.validationStatus !== "course_5_wave_3_zip_ai_visual_review_batch_003_partially_ready_release_and_deletion_blocked") fail("unexpected validation status");
if (validation.validationMode !== "wave_3_zip_ai_visual_review_batch_003_gate") fail("unexpected validation mode");
