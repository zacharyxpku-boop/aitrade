...
const outputJsonPath = "docs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_COVERAGE_AUDIT.json";
const outputMdPath = "docs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_COVERAGE_AUDIT.md";
const reviewedAt = "2026-06-25T00:00:00.000+08:00";

const batchSpecs = [
  { id: "batch_001", path: "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_001_INPUT.json", validationPath: "docs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_001_VALIDATION.json" },
  { id: "batch_002", path: "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_002_INPUT.json", validationPath: "docs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_002_VALIDATION.json" },
  { id: "batch_003", path: "docs/reviewer-inputs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_003_INPUT.json", validationPath: "docs/LOCAL_COURSE_5_WAVE_4_PDF_AI_VISUAL_REVIEW_BATCH_003_VALIDATION.json" },
];
...
if (template.rows.length !== 27) fail(`expected 27 template rows, got ${template.rows.length}`);
if (coveredRows.length !== 27) fail(`expected 27 covered rows, got ${coveredRows.length}`);
...
const artifact = {
  ...
  auditStatus: "course_5_wave_4_pdf_ai_visual_review_all_samples_covered_release_and_deletion_blocked",
  ...
  nextOperationalGates: [
    "Use this audit as the Wave 4 PDF visual review closure proof.",
    "Keep OCR, public grounding, and originality review required before module merge.",
    "Continue Wave 5 PDF review coverage before recomputing Course 5 deletion readiness.",
  ],
  completionRule: "Wave 4 PDF AI visual review coverage is complete when every row in the Wave 4 PDF reviewer input template is covered exactly once by Batch 001 through Batch 003 while all release, module merge, and source-folder removal gates remain closed.",
  boundary: "Private education-operations audit for Course 5 Wave 4 PDF page sample coverage. It summarizes model-assisted visual review coverage and keeps learner release, module merge, write authorization, and source-folder removal blocked pending OCR, reviewer confirmation, public grounding, originality review, and explicit approval.",
};
...
fs.writeFileSync(outputMdPath, `# Course 5 Wave 4 PDF AI Visual Review Coverage Audit
